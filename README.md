...
[![CI](https://github.com/analysis-tools-dev/static-analysis/workflows/CI/badge.svg)](https://github.com/analysis-tools-dev/static-analysis/actions/workflows/ci.yml) ⭐ 14,755 | 🐛 10 | 🌐 Rust | 📅 2026-08-30
[![Links](https://github.com/analysis-tools-dev/static-analysis/actions/workflows/links.yml/badge.svg)](https://github.com/analysis-tools-dev/static-analysis/actions/workflows/links.yml) ⭐ 14,755 | 🐛 10 | 🌐 Rust | 📅 2026-08-30
...
* [cpplint](https://github.com/cpplint/cpplint) ⭐ 1,846 | 🐛 85 | 🌐 Python | 📅 2026-08-14 — Automated C++ checker that follows Google's style guide.
...
* [Roslynator](https://github.com/JosefPihrt/Roslynator) ⭐ 3,477 | 🐛 209 | 🌐 C# | 📅 2026-08-21 — A collection of 190+ analyzers and 190+ refactorings for C#, powered by Roslyn.

* [ArchUnitNET](https://github.com/TNG/ArchUnitNET) ⭐ 1,354 | 🐛 31 | 🌐 C# | 📅 2026-08-31 — A C# architecture test library to specify and assert architecture rules in C# for automated testing.

* [Meziantou.Analyzer](https://github.com/meziantou/Meziantou.Analyzer) ⭐ 1,184 | 🐛 6 | 🌐 C# | 📅 2026-08-31 — A Roslyn analyzer to enforce some good practices in C# in terms of design, usage, security, performance, and style.

* [SonarAnalyzer.CSharp](https://github.com/SonarSource/sonar-dotnet) ⭐ 918 | 🐛 249 | 🌐 C# | 📅 2026-08-29 — These Roslyn analyzers allow you to produce Clean Code that is safe, reliable, and maintainable by helping you find and correct bugs, vulnerabilities, and code smells in your codebase.
...
* [clj-kondo](https://github.com/borkdude/clj-kondo) ⭐ 1,850 | 🐛 123 | 🌐 Clojure | 📅 2026-08-20 — A linter for Clojure code that sparks joy. It informs you about potential errors while you are typing.
...
* [SonarDelphi](https://github.com/integrated-application-development/sonar-delphi) ⭐ 158 | 🐛 40 | 🌐 Java | 📅 2026-08-31 — Delphi static analyzer for the SonarQube code quality platform.
...
* [credo](https://github.com/rrrene/credo) ⭐ 5,213 | 🐛 37 | 🌐 Elixir | 📅 2026-08-26 — A static code analysis tool with a focus on code consistency and teaching.
...
* [FSharpLint](https://github.com/fsprojects/FSharpLint) ⭐ 327 | 🐛 99 | 🌐 F# | 📅 2026-08-10 — Lint tool for F#.
...
* [Reviewdog](https://github.com/haya14busa/reviewdog) ⭐ 9,554 | 🐛 136 | 🌐 Go | 📅 2026-08-28 — A tool for posting review comments from any linter in any code hosting service.
...
* [NullAway](https://github.com/uber/NullAway) ⭐ 4,097 | 🐛 153 | 🌐 Java | 📅 2026-08-30 — Type-based null-pointer checker with low build-time overhead; an [Error Prone](http://errorprone.info/) plugin.

* [Dataflow Framework](https://github.com/typetools/checker-framework) ⭐ 1,149 | 🐛 433 | 🌐 Java | 📅 2026-08-31 — An industrial-strength dataflow framework for Java. The Dataflow Framework is used in the Checker Framework, Google’s Error Prone, Uber’s NullAway, Meta’s Nullsafe, and in other contexts. It is distributed with the Checker Framework.
...
* [JLiSA](https://github.com/lisa-analyzer/jlisa) ⭐ 32 | 🐛 23 | 🌐 Java | 📅 2026-08-25 — An abstract interpretation-based static analyzer for Java build upon the [LiSA](https://github.com/lisa-analyzer/lisa) ⭐ 85 | 🐛 34 | 🌐 Java | 📅 2026-08-25 framekwork.
...
* **jshint** [:information\_source:](https://github.com/analysis-tools-dev/static-analysis/issues/223) ⭐ 14,755 | 🐛 10 | 🌐 Rust | 📅 2026-08-30 :warning: — Detect errors and potential problems in JavaScript code and enforce your team's coding conventions.
...
* [JSLint](https://github.com/douglascrockford/JSLint) ⭐ 3,657 | 🐛 3 | 🌐 JavaScript | 📅 2026-08-02 [:information\_source:](https://github.com/analysis-tools-dev/static-analysis/issues/223) ⭐ 14,755 | 🐛 10 | 🌐 Rust | 📅 2026-08-30 — The JavaScript Code Quality Tool.
...
* [JET](https://github.com/aviatesk/JET.jl) ⭐ 882 | 🐛 86 | 🌐 Julia | 📅 2026-08-31 — Static type inference system to detect bugs and type instabilities.
...
* [luacheck](https://github.com/lunarmodules/luacheck) ⭐ 457 | 🐛 43 | 🌐 Lua | 📅 2026-07-31 — A tool for linting and static analysis of Lua code.
...
* [churn-php](https://github.com/bmitch/churn-php) ⭐ 1,380 | 🐛 4 | 🌐 PHP | 📅 2025-12-31 — Helps discover good candidates for refactoring.

* [composer-dependency-analyser](https://github.com/shipmonk-rnd/composer-dependency-analyser) ⭐ 628 | 🐛 19 | 🌐 PHP | 📅 2026-08-11 — Fast detection of composer dependency issues.
...
* [EasyCodingStandard](https://www.tomasvotruba.com/blog/2017/05/03/combine-power-of-php-code-sniffer-and-php-cs-fixer-in-3-lines) — Combine [PHP\_CodeSniffer](https://github.com/squizlabs/PHP_CodeSniffer) ⭐ 10,780 | 🐛 248 | 🌐 PHP | 📅 2024-04-01 and [PHP-CS-Fixer](https://github.com/FriendsOfPHP/PHP-CS-Fixer) ⭐ 13,547 | 🐛 82 | 🌐 PHP | 📅 2026-08-31.

* [larastan](https://github.com/larastan/larastan) ⭐ 6,501 | 🐛 115 | 🌐 PHP | 📅 2026-08-31 — Adds static analysis to Laravel improving developer productivity and code quality. It is a wrapper around PHPStan.

* [PHP Insights](https://github.com/nunomaduro/phpinsights) ⭐ 5,632 | 🐛 73 | 🌐 PHP | 📅 2026-08-04 — Instant PHP quality checks from your console. Analysis of code quality and coding style as well as overview of code architecture and its complexity.
...
* [deptrac](https://github.com/sensiolabs-de/deptrac) ⭐ 2,999 | 🐛 37 | 🌐 PHP | 📅 2026-08-14 — Enforce rules for dependencies between software layers.
...
* [PHPArkitect](https://github.com/phparkitect/arkitect) ⭐ 927 | 🐛 38 | 🌐 PHP | 📅 2026-08-30 — PHPArkitect helps you to keep your PHP codebase coherent and solid, by permitting to add some architectural constraint check to your workflow. You can express the constraint that you want to enforce, in simple and readable PHP code.
...
* [pyright](https://github.com/Microsoft/pyright) ⭐ 15,610 | 🐛 323 | 🌐 Python | 📅 2026-08-28 — Static type checker for Python, created to address gaps in existing tools like mypy.
...
* [vulture](https://github.com/jendrikseipp/vulture) ⭐ 4,787 | 🐛 71 | 🌐 Python | 📅 2026-04-30 — Find unused classes, functions and variables in Python code.

* [flake8](https://github.com/PyCQA/flake8) ⭐ 3,824 | 🐛 23 | 🌐 Python | 📅 2026-08-17 — A wrapper around `pyflakes`, `pycodestyle` and `mccabe`.
...
* **xenon** :warning: — Monitor code complexity using [`radon`](https://github.com/rubik/radon) ⭐ 2,013 | 🐛 52 | 🌐 Python | 📅 2024-10-20.
...
* [wily](https://github.com/tonybaloney/wily) ⭐ 1,327 | 🐛 45 | 🌐 Python | 📅 2026-08-09 — A command-line tool for archiving, exploring and graphing the complexity of Python source code.
...
* [Regal](https://github.com/styrainc/regal) ⭐ 402 | 🐛 145 | 🌐 Go | 📅 2026-08-25 — Regal is a linter for the policy language Rego. Regal aims to catch bugs and mistakes in policy code, while at the same time helping people learn the language, best practices and idiomatic constructs.

<a id="ruby"></a>

<h2>Ruby</h2>

* [Bullet](https://github.com/flyerhzm/bullet) ⭐ 7,335 | 🐛 7 | 🌐 Ruby | 📅 2026-08-29 — Help to kill N+1 queries and unused eager loading.
...
* [bundler-audit](https://github.com/rubysec/bundler-audit) ⭐ 2,757 | 🐛 48 | 🌐 Ruby | 📅 2026-08-31 — Audit Gemfile.lock for gems with security vulnerabilities reported in [Ruby Advisory Database](https://github.com/rubysec/ruby-advisory-db) ⭐ 1,070 | 🐛 2 | 🌐 Ruby | 📅 2026-08-31.
...
* [Steep](https://github.com/soutaro/steep) ⭐ 1,488 | 🐛 221 | 🌐 Ruby | 📅 2026-08-30 — Gradual Typing for Ruby.
...
* [kani](https://github.com/model-checking/kani) ⭐ 3,365 | 🐛 476 | 🌐 Rust | 📅 2026-08-31 — The Kani Rust Verifier is a bit-precise model checker for Rust.
...
* [cargo-audit](https://rustsec.org) — Audit Cargo.lock for crates with security vulnerabilities reported to the [RustSec Advisory Database](https://github.com/RustSec/advisory-db/) ⭐ 1,169 | 🐛 146 | 📅 2026-08-31.
...
* [rustfmt](https://github.com/rust-lang/rustfmt) ⭐ 6,953 | 🐛 938 | 🌐 Rust | 📅 2026-08-31 — A tool for formatting Rust code according to style guidelines.
...
* [rust-audit](https://github.com/Shnatsel/rust-audit) ⭐ 845 | 🐛 17 | 🌐 Rust | 📅 2026-08-22 — Audit Rust binaries for known bugs or security vulnerabilities. This works by embedding data about the dependency tree (Cargo.lock) in JSON format into a dedicated linker section of the compiled executable.
...
* [pgspot](https://github.com/timescale/pgspot) ⭐ 147 | 🐛 9 | 🌐 Python | 📅 2026-08-31 — Spot vulnerabilities in postgres extension scripts. Finds unsafe search\_path usage and unsafe object creation in PostgreSQL extension scripts or any other PostgreSQL SQL code.

* [scythe](https://github.com/Goldziher/scythe) ⭐ 66 | 🐛 0 | 🌐 Rust | 📅 2026-08-27 — Polyglot SQL compiler and linter that generates type-safe code from SQL with schema-aware linting.
...
* [scapegoat](https://github.com/sksamuel/scapegoat) ⭐ 556 | 🐛 47 | 🌐 Scala | 📅 2026-08-30 — Scala compiler plugin for static code analysis.
...
* [shellharden](https://github.com/anordal/shellharden) ⭐ 4,800 | 🐛 10 | 🌐 Rust | 📅 2026-07-09 — A syntax highlighter and a tool to semi-automate the rewriting of scripts to ShellCheck conformance, mainly focused on quoting.
...
* [SwiftFormat](https://github.com/nicklockwood/SwiftFormat) ⭐ 8,924 | 🐛 290 | 🌐 Swift | 📅 2026-08-31 — A library and command-line formatting tool for reformatting Swift code.
...
* [TypeScript ESLint](https://github.com/typescript-eslint/typescript-eslint) ⭐ 16,374 | 🐛 259 | 🌐 TypeScript | 📅 2026-08-31 — TypeScript language extension for eslint.
...
* [Angular ESLint](https://github.com/angular-eslint/angular-eslint#readme) ⭐ 1,784 | 🐛 30 | 🌐 TypeScript | 📅 2026-08-31 — Linter for Angular projects
...
* [vscode-verilog-hdl-support](https://github.com/mshr-h/vscode-verilog-hdl-support) ⭐ 385 | 🐛 68 | 🌐 TypeScript | 📅 2026-08-31 — Verilog HDL/SystemVerilog/Bluespec SystemVerilog support for VS Code. Provides syntax highlighting and Linting support from Icarus Verilog, Vivado Logical Simulation, Modelsim and Verilator
...
* [wasm-language-tools](https://github.com/g-plane/wasm-language-tools) ⭐ 93 | 🐛 1 | 🌐 Rust | 📅 2026-08-31 — WebAssembly Language Tools aims to provide and improve the editing experience of WebAssembly Text Format. It also provides an out-of-the-box formatter (a.k.a. pretty printer) for WebAssembly Text Format.

## Multiple languages

* [trivy](https://github.com/aquasecurity/trivy) ⭐ 37,715 | 🐛 264 | 🌐 Go | 📅 2026-08-28 — A Simple and Comprehensive Vulnerability Scanner for Containers and other Artifacts, Suitable for CI. Trivy detects vulnerabilities of OS packages (Alpine, RHEL, CentOS, etc.) and application dependencies (Bundler, Composer, npm, yarn, etc.). Checks containers and filesystems.

* [ESLint](https://github.com/eslint/eslint) ⭐ 27,493 | 🐛 141 | 🌐 JavaScript | 📅 2026-08-31 — An extensible linter for JS, following the ECMAScript standard.

* [oxc](https://github.com/web-infra-dev/oxc) ⭐ 22,583 | 🐛 828 | 🌐 Rust | 📅 2026-08-31 — The Oxidation Compiler is creating a suite of high-performance tools for the JavaScript / TypeScript language re-written in Rust.

* [ale](https://github.com/w0rp/ale) ⭐ 14,019 | 🐛 588 | 🌐 Vim Script | 📅 2026-08-21 — Asynchronous Lint Engine for Vim and NeoVim with support for many languages.

* [codeql](https://github.com/github/codeql) ⭐ 10,036 | 🐛 1,467 | 🌐 CodeQL | 📅 2026-08-31 — Deep code analysis - semantic queries and dataflow for several languages with VSCode plugin support.
...
* [sem](https://github.com/Ataraxy-Labs/sem) ⭐ 3,326 | 🐛 9 | 🌐 Rust | 📅 2026-08-29 — Semantic version control CLI that provides entity-level diffs, blame, and impact analysis on top of git. Uses tree-sitter to parse 26 languages and builds a cross-file dependency graph with structural hashing. Commands include sem diff, sem blame, sem graph, and sem impact for blast-radius analysis of code changes.

* [ClassGraph](https://github.com/classgraph/classgraph) ⭐ 3,005 | 🐛 1 | 🌐 Java | 📅 2026-08-31 — A classpath and module path scanner for querying or visualizing class metadata or class relatedness.
...
* [lizard](https://github.com/terryyin/lizard) ⭐ 2,476 | 🐛 24 | 🌐 Python | 📅 2026-08-29 — Lizard is an extensible Cyclomatic Complexity Analyzer for many programming languages  including C/C++ (doesn't require all the header files or Java imports).  It also does copy-paste detection (code clone detection/code duplicate detection) and many other forms of static code analysis. Counts lines of code without comments, CCN (cyclomatic complexity number), token count of functions, parameter count of functions.
...
* [Roslyn Analyzers](https://github.com/dotnet/roslyn-analyzers) ⭐ 1,672 | 🐛 1,058 | 📅 2026-08-31 — Roslyn-based implementation of FxCop analyzers.

* [weave](https://github.com/Ataraxy-Labs/weave) ⭐ 1,264 | 🐛 11 | 🌐 Rust | 📅 2026-08-29 — Entity-level semantic merge driver for git. Resolves false conflicts that line-based merge produces when independent changes touch the same file. Parses functions and classes via tree-sitter, matches by name, and merges at the entity level. Benchmarked at 100% clean merges vs git's 48% on a 31-scenario suite.
...
* [Putout](https://github.com/coderaiser/putout) ⭐ 796 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-30 — Pluggable and configurable code transformer with built-in eslint, babel plugins support for js, jsx typescript, flow, markdown, yaml and json.

* [Skylos](https://github.com/duriantaco/skylos) ⭐ 545 | 🐛 8 | 🌐 Python | 📅 2026-08-26 — Dead code detection, security scanning, secrets detection, and code quality analysis for Python, TypeScript, and Go. Framework-aware analysis with 98% recall. Includes CI/CD GitHub Action, VS Code extension, and MCP server for AI agent integration.
...
* [nestjs-doctor](https://github.com/RoloBits/nestjs-doctor) ⭐ 158 | 🐛 4 | 🌐 TypeScript | 📅 2026-08-31 — Static analysis tool for NestJS applications. Detects anti-patterns across security, performance, correctness, and architecture with 30+ built-in rules. Outputs a 0-100 health score. Includes module graph visualization, endpoint dependency graphs, and database schema analysis. CLI and VS Code extension.
...
* [BlockWatch](https://github.com/mennanov/blockwatch) ⭐ 29 | 🐛 4 | 🌐 Rust | 📅 2026-08-28 — A language-agnostic linter that keeps code, documentation, and configuration in sync and enforces strict formatting and validation rules.
...
* [angr](https://github.com/angr/angr) ⭐ 9,048 | 🐛 705 | 🌐 Python | 📅 2026-08-31 — Binary code analysis tool that also supports symbolic execution.
...
* [Manalyze](https://github.com/JusticeRage/Manalyze) ⭐ 1,144 | 🐛 6 | 🌐 YARA | 📅 2026-08-29 — A static analyzer, which checks portable executables for malicious content.
...
* [cfn-lint](https://github.com/awslabs/cfn-python-lint) ⭐ 2,640 | 🐛 78 | 🌐 Python | 📅 2026-08-31 — AWS Labs CloudFormation linter.
...
* [Grype](https://github.com/anchore/grype) ⭐ 12,809 | 🐛 405 | 🌐 Go | 📅 2026-08-28 — Vulnerability scanner for container images and filesystems. Developed by Anchore, it scans container images, directories, and archives for known vulnerabilities. Supports multiple image formats, SBOM integration, and VEX (Vulnerability Exploitability eXchange) for accurate vulnerability assessment. Works with various vulnerability databases and provides detailed reporting.
...
* [clair](https://github.com/coreos/clair) ⭐ 11,054 | 🐛 59 | 🌐 Go | 📅 2026-08-31 — Vulnerability Static Analysis for Containers.

* [Dockle](https://github.com/goodwithtech/dockle) ⭐ 3,295 | 🐛 53 | 🌐 Go | 📅 2026-08-10 — Container Image Linter for Security helping build the Best-Practice Docker Image. Scans Docker images for security vulnerabilities and CIS Benchmark compliance. Checks for secrets, credential exposure, and security best practices. Provides multiple severity levels (FATAL, WARN, INFO) and supports various output formats for CI/CD integration.

* [krane](https://github.com/appvia/krane) ⭐ 743 | 🐛 33 | 🌐 Ruby | 📅 2026-08-31 — Krane is a simple Kubernetes RBAC static analysis tool.
...
* [oelint-adv](https://github.com/priv-kweihmann/oelint-adv) ⭐ 86 | 🐛 6 | 🌐 Python | 📅 2026-08-31 — Linter for bitbake recipes used in open-embedded and YOCTO
...
* [kube-linter](https://github.com/stackrox/kube-linter) ⭐ 3,503 | 🐛 94 | 🌐 Go | 📅 2026-08-26 — KubeLinter is a static analysis tool that checks Kubernetes YAML files  and Helm charts to ensure the applications represented in them adhere to best practices.

* [kubeconform](https://github.com/yannh/kubeconform) ⭐ 3,169 | 🐛 89 | 🌐 Go | 📅 2026-06-13 — A fast Kubernetes manifests validator with support for custom resources.
...
- [KubeLinter](https://github.com/stackrox/kube-linter) ⭐ 3,503 | 🐛 94 | 🌐 Go | 📅 2026-08-26 — KubeLinter is a static analysis tool that checks Kubernetes YAML files and Helm charts to ensure the applications represented in them adhere to best practices.
...
* [markdownlint](https://github.com/DavidAnson/markdownlint) ⭐ 6,316 | 🐛 83 | 🌐 JavaScript | 📅 2026-08-31 — Node.js -based style checker and lint tool for Markdown/CommonMark files.

* [mdl](https://github.com/mivok/markdownlint) ⭐ 2,076 | 🐛 109 | 🌐 Ruby | 📅 2026-08-09 — A tool to check Markdown files and flag style issues.

* [mdsf](https://github.com/hougesen/mdsf) ⭐ 111 | 🐛 35 | 🌐 Rust | 📅 2026-08-14 — Format markdown code blocks using your favorite code formatters.
...
* [deadnix](https://github.com/astro/deadnix) ⭐ 776 | 🐛 5 | 🌐 Rust | 📅 2026-07-26 — Scan Nix files for dead code (unused variable bindings)
...
* [rpmlint](https://github.com/rpm-software-management/rpmlint) ⭐ 162 | 🐛 92 | 🌐 Python | 📅 2026-08-27 — Tool for checking common errors in rpm packages.
...
* [Gitleaks](https://github.com/zricethezav/gitleaks) ⭐ 29,036 | 🐛 470 | 🌐 Go | 📅 2026-08-26 — A SAST tool for detecting hardcoded secrets like passwords, api keys, and tokens in git repos.
...
* [scorecard](https://github.com/ossf/scorecard) ⭐ 5,662 | 🐛 461 | 🌐 Go | 📅 2026-08-31 — Security Scorecards - Security health metrics for Open Source
...
* [slither](https://github.com/trailofbits/slither) ⭐ 6,356 | 🐛 474 | 🌐 Python | 📅 2026-08-26 — Static analysis framework that runs a suite of vulnerability detectors, prints visual information about contract details, and provides an API to easily write custom analyses.
...
* [go-tools](https://github.com/dominikh/go-tools) ⭐ 6,878 | 🐛 572 | 🌐 Go | 📅 2026-08-24 — A collection of tools and libraries for working with Go code, including linters and static analysis
