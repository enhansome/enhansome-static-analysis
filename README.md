...
[![CI](https://github.com/analysis-tools-dev/static-analysis/workflows/CI/badge.svg)](https://github.com/analysis-tools-dev/static-analysis/actions/workflows/ci.yml) ⭐ 14,789 | 🐛 0 | 🌐 Rust | 📅 2026-09-19
[![Links](https://github.com/analysis-tools-dev/static-analysis/actions/workflows/links.yml/badge.svg)](https://github.com/analysis-tools-dev/static-analysis/actions/workflows/links.yml) ⭐ 14,789 | 🐛 0 | 🌐 Rust | 📅 2026-09-19
...
Also check out the sister project, [awesome-dynamic-analysis](https://github.com/mre/awesome-dynamic-analysis) ⭐ 1,105 | 🐛 2 | 🌐 Rust | 📅 2026-09-19.
...
* [Roslynator](https://github.com/JosefPihrt/Roslynator) ⭐ 3,481 | 🐛 213 | 🌐 C# | 📅 2026-09-13 — A collection of 190+ analyzers and 190+ refactorings for C#, powered by Roslyn.

* [ArchUnitNET](https://github.com/TNG/ArchUnitNET) ⭐ 1,364 | 🐛 35 | 🌐 C# | 📅 2026-09-18 — A C# architecture test library to specify and assert architecture rules in C# for automated testing.

* [Meziantou.Analyzer](https://github.com/meziantou/Meziantou.Analyzer) ⭐ 1,197 | 🐛 2 | 🌐 C# | 📅 2026-09-20 — A Roslyn analyzer to enforce some good practices in C# in terms of design, usage, security, performance, and style.
...
* [Reviewdog](https://github.com/haya14busa/reviewdog) ⭐ 9,602 | 🐛 127 | 🌐 Go | 📅 2026-09-19 — A tool for posting review comments from any linter in any code hosting service.

* [gofumpt](https://github.com/mvdan/gofumpt) ⭐ 4,089 | 🐛 13 | 🌐 Go | 📅 2026-09-07 — Enforce a stricter format than `gofmt`, while being backwards-compatible.  That is, `gofumpt` is happy with a subset of the formats that `gofmt` is happy with.
...
* [go-critic](https://github.com/go-critic/go-critic) ⭐ 2,069 | 🐛 153 | 🌐 Go | 📅 2026-09-20 — Go source code linter that maintains checks which are currently not implemented in other linters.
...
* [unparam](https://github.com/mvdan/unparam) ⭐ 572 | 🐛 7 | 🌐 Go | 📅 2026-08-23 — Find unused function parameters.
...
* [NullAway](https://github.com/uber/NullAway) ⭐ 4,107 | 🐛 162 | 🌐 Java | 📅 2026-09-18 — Type-based null-pointer checker with low build-time overhead; an [Error Prone](http://errorprone.info/) plugin.

* [Dataflow Framework](https://github.com/typetools/checker-framework) ⭐ 1,150 | 🐛 438 | 🌐 Java | 📅 2026-09-20 — An industrial-strength dataflow framework for Java. The Dataflow Framework is used in the Checker Framework, Google’s Error Prone, Uber’s NullAway, Meta’s Nullsafe, and in other contexts. It is distributed with the Checker Framework.

* [RefactorFirst](https://github.com/jimbethancourt/RefactorFirst) ⭐ 548 | 🐛 58 | 🌐 Java | 📅 2026-09-16 — Identifies and prioritizes God Classes and Highly Coupled classes in Java codebases you should refactor first.

* [ck](https://github.com/mauricioaniche/ck) ⭐ 457 | 🐛 33 | 🌐 Java | 📅 2026-04-29 — Calculates Chidamber and Kemerer object-oriented metrics by processing the source Java files.

* [forbidden-apis](https://github.com/policeman-tools/forbidden-apis) ⭐ 372 | 🐛 31 | 🌐 Java | 📅 2026-09-20 — Detects and forbids invocations of specific method/class/field (like reading from a text stream without a charset). Maven/Gradle/Ant compatible.
...
* [JSLint](https://github.com/douglascrockford/JSLint) ⭐ 3,654 | 🐛 3 | 🌐 JavaScript | 📅 2026-09-15 [:information\_source:](https://github.com/analysis-tools-dev/static-analysis/issues/223) ⭐ 14,789 | 🐛 0 | 🌐 Rust | 📅 2026-09-19 — The JavaScript Code Quality Tool.
...
* **jshint** [:information\_source:](https://github.com/analysis-tools-dev/static-analysis/issues/223) ⭐ 14,789 | 🐛 0 | 🌐 Rust | 📅 2026-09-19 :warning: — Detect errors and potential problems in JavaScript code and enforce your team's coding conventions.
...
* [PHP-Parser](https://github.com/nikic/PHP-Parser) ⭐ 17,471 | 🐛 69 | 🌐 PHP | 📅 2026-09-14 — A PHP parser written in PHP.

* [EasyCodingStandard](https://www.tomasvotruba.com/blog/2017/05/03/combine-power-of-php-code-sniffer-and-php-cs-fixer-in-3-lines) — Combine [PHP\_CodeSniffer](https://github.com/squizlabs/PHP_CodeSniffer) ⭐ 10,777 | 🐛 248 | 🌐 PHP | 📅 2024-04-01 and [PHP-CS-Fixer](https://github.com/FriendsOfPHP/PHP-CS-Fixer) ⭐ 13,554 | 🐛 88 | 🌐 PHP | 📅 2026-09-19.

* [larastan](https://github.com/larastan/larastan) ⭐ 6,512 | 🐛 94 | 🌐 PHP | 📅 2026-09-19 — Adds static analysis to Laravel improving developer productivity and code quality. It is a wrapper around PHPStan.
...
* [deptrac](https://github.com/sensiolabs-de/deptrac) ⭐ 3,016 | 🐛 35 | 🌐 PHP | 📅 2026-09-20 — Enforce rules for dependencies between software layers.
...
* [PHPArkitect](https://github.com/phparkitect/arkitect) ⭐ 932 | 🐛 39 | 🌐 PHP | 📅 2026-09-19 — PHPArkitect helps you to keep your PHP codebase coherent and solid, by permitting to add some architectural constraint check to your workflow. You can express the constraint that you want to enforce, in simple and readable PHP code.
...
* [pyright](https://github.com/Microsoft/pyright) ⭐ 15,651 | 🐛 344 | 🌐 Python | 📅 2026-09-18 — Static type checker for Python, created to address gaps in existing tools like mypy.
...
* [refurb](https://github.com/dosisod/refurb) ⭐ 2,533 | 🐛 33 | 🌐 Python | 📅 2026-04-03 — A tool for refurbishing and modernizing Python codebases. Refurb is heavily inspired by clippy, the built-in linter for Rust.

* [prospector](https://github.com/PyCQA/prospector) ⭐ 2,082 | 🐛 32 | 🌐 Python | 📅 2026-09-14 — A wrapper around `pylint`, `pep8`, `mccabe` and others.

* [pip-audit](https://github.com/pypa/pip-audit) ⭐ 1,365 | 🐛 64 | 🌐 Python | 📅 2026-09-16 — Tool for scanning Python packages for known vulnerabilities. Developed by the Python Packaging Authority (PyPA) and supported by Trail of Bits and Google. Scans Python environments and requirements files to identify vulnerable packages and suggests remediation. Supports GitHub Actions, pre-commit hooks, and multiple vulnerability service integrations.
...
* [autoflake](https://github.com/PyCQA/autoflake) ⭐ 953 | 🐛 44 | 🌐 Python | 📅 2026-08-23 — Autoflake removes unused imports and unused variables from Python code.
...
* **xenon** :warning: — Monitor code complexity using [`radon`](https://github.com/rubik/radon) ⭐ 2,028 | 🐛 52 | 🌐 Python | 📅 2024-10-20.
...
* [Regal](https://github.com/styrainc/regal) ⭐ 407 | 🐛 139 | 🌐 Go | 📅 2026-09-11 — Regal is a linter for the policy language Rego. Regal aims to catch bugs and mistakes in policy code, while at the same time helping people learn the language, best practices and idiomatic constructs.
...
* [kani](https://github.com/model-checking/kani) ⭐ 3,436 | 🐛 493 | 🌐 Rust | 📅 2026-09-18 — The Kani Rust Verifier is a bit-precise model checker for Rust.
...
* [cargo-geiger](https://github.com/geiger-rs/cargo-geiger) ⭐ 1,648 | 🐛 55 | 🌐 Rust | 📅 2026-09-14 — A cargo plugin for analysing the usage of unsafe Rust code Provides statistical output to aid security auditing

* [cargo-audit](https://rustsec.org) — Audit Cargo.lock for crates with security vulnerabilities reported to the [RustSec Advisory Database](https://github.com/RustSec/advisory-db/) ⭐ 1,178 | 🐛 149 | 📅 2026-09-19.
...
* [rust-audit](https://github.com/Shnatsel/rust-audit) ⭐ 857 | 🐛 17 | 🌐 Rust | 📅 2026-09-13 — Audit Rust binaries for known bugs or security vulnerabilities. This works by embedding data about the dependency tree (Cargo.lock) in JSON format into a dedicated linker section of the compiled executable.
...
* [pgspot](https://github.com/timescale/pgspot) ⭐ 148 | 🐛 10 | 🌐 Python | 📅 2026-09-20 — Spot vulnerabilities in postgres extension scripts. Finds unsafe search\_path usage and unsafe object creation in PostgreSQL extension scripts or any other PostgreSQL SQL code.
...
* [SwiftFormat](https://github.com/nicklockwood/SwiftFormat) ⭐ 8,927 | 🐛 294 | 🌐 Swift | 📅 2026-09-16 — A library and command-line formatting tool for reformatting Swift code.
...
* [TypeScript ESLint](https://github.com/typescript-eslint/typescript-eslint) ⭐ 16,392 | 🐛 235 | 🌐 TypeScript | 📅 2026-09-19 — TypeScript language extension for eslint.

* [Angular ESLint](https://github.com/angular-eslint/angular-eslint#readme) ⭐ 1,784 | 🐛 13 | 🌐 TypeScript | 📅 2026-09-19 — Linter for Angular projects
...
* [vscode-verilog-hdl-support](https://github.com/mshr-h/vscode-verilog-hdl-support) ⭐ 387 | 🐛 68 | 🌐 TypeScript | 📅 2026-09-19 — Verilog HDL/SystemVerilog/Bluespec SystemVerilog support for VS Code. Provides syntax highlighting and Linting support from Icarus Verilog, Vivado Logical Simulation, Modelsim and Verilator
...
* [trivy](https://github.com/aquasecurity/trivy) ⭐ 37,990 | 🐛 270 | 🌐 Go | 📅 2026-09-18 — A Simple and Comprehensive Vulnerability Scanner for Containers and other Artifacts, Suitable for CI. Trivy detects vulnerabilities of OS packages (Alpine, RHEL, CentOS, etc.) and application dependencies (Bundler, Composer, npm, yarn, etc.). Checks containers and filesystems.

* [ESLint](https://github.com/eslint/eslint) ⭐ 27,515 | 🐛 129 | 🌐 JavaScript | 📅 2026-09-18 — An extensible linter for JS, following the ECMAScript standard.

* [oxc](https://github.com/web-infra-dev/oxc) ⭐ 22,811 | 🐛 931 | 🌐 Rust | 📅 2026-09-20 — The Oxidation Compiler is creating a suite of high-performance tools for the JavaScript / TypeScript language re-written in Rust.
...
* [codeql](https://github.com/github/codeql) ⭐ 10,108 | 🐛 1,468 | 🌐 CodeQL | 📅 2026-09-18 — Deep code analysis - semantic queries and dataflow for several languages with VSCode plugin support.
...
* [Bearer](https://github.com/bearer/bearer) ⭐ 2,746 | 🐛 19 | 🌐 Go | 📅 2026-09-16 — Open-Source static code analysis tool to discover,  filter and prioritize security risks and vulnerabilities  leading to sensitive data exposures (PII, PHI, PD).  Highly configurable and easily extensible,  built for security and engineering teams.
...
* [lizard](https://github.com/terryyin/lizard) ⭐ 2,514 | 🐛 25 | 🌐 Python | 📅 2026-09-16 — Lizard is an extensible Cyclomatic Complexity Analyzer for many programming languages  including C/C++ (doesn't require all the header files or Java imports).  It also does copy-paste detection (code clone detection/code duplicate detection) and many other forms of static code analysis. Counts lines of code without comments, CCN (cyclomatic complexity number), token count of functions, parameter count of functions.
...
* [weave](https://github.com/Ataraxy-Labs/weave) ⭐ 1,288 | 🐛 4 | 🌐 Rust | 📅 2026-09-19 — Entity-level semantic merge driver for git. Resolves false conflicts that line-based merge produces when independent changes touch the same file. Parses functions and classes via tree-sitter, matches by name, and merges at the entity level. Benchmarked at 100% clean merges vs git's 48% on a 31-scenario suite.

* [emerge](https://github.com/glato/emerge) ⭐ 1,151 | 🐛 19 | 🌐 Python | 📅 2026-08-07 — Emerge is a source code and dependency visualizer that can be used to gather insights about source code structure, metrics, dependencies and complexity of software projects. After scanning the source code of a project it provides you an interactive web interface to explore and analyze your project by using graph structures.

* [DevSkim](https://github.com/microsoft/devskim) ⭐ 1,006 | 🐛 80 | 🌐 C# | 📅 2026-09-15 — Regex-based static analysis tool for Visual Studio, VS Code, and Sublime Text - C/C++, C#, PHP, ASP, Python, Ruby, Java, and others.
...
* [Skylos](https://github.com/duriantaco/skylos) ⭐ 824 | 🐛 7 | 🌐 Python | 📅 2026-09-20 — Dead code detection, security scanning, secrets detection, and code quality analysis for Python, TypeScript, and Go. Framework-aware analysis with 98% recall. Includes CI/CD GitHub Action, VS Code extension, and MCP server for AI agent integration.

* [Putout](https://github.com/coderaiser/putout) ⭐ 795 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-20 — Pluggable and configurable code transformer with built-in eslint, babel plugins support for js, jsx typescript, flow, markdown, yaml and json.
...
* [angr](https://github.com/angr/angr) ⭐ 9,101 | 🐛 723 | 🌐 Python | 📅 2026-09-20 — Binary code analysis tool that also supports symbolic execution.

* [bloaty](https://github.com/google/bloaty) ⭐ 5,547 | 🐛 73 | 🌐 C++ | 📅 2026-09-10 — Ever wondered what's making your binary big? Bloaty McBloatface will show you a size profile of the binary so you can understand what's taking up space inside. Bloaty performs a deep analysis of the binary. Using custom ELF, DWARF, and Mach-O parsers,  Bloaty aims to accurately attribute every byte of the binary to the symbol or compileunit that produced it.  It will even disassemble the binary looking for references to anonymous data. F

* [Twiggy](https://github.com/rustwasm/twiggy) ⚠️ Archived — Analyzes a binary's call graph to profile code size. The goal is to slim down wasm binary size.

* [cwe\_checker](https://github.com/fkie-cad/cwe_checker) ⭐ 1,359 | 🐛 30 | 🌐 Rust | 📅 2026-08-20 — cwe\_checker finds vulnerable patterns in binary executables.
...
* [Nauz File Detector](https://github.com/horsicq/Nauz-File-Detector) ⭐ 581 | 🐛 2 | 🌐 C++ | 📅 2026-09-19 — Static Linker/Compiler/Tool detector for Windows, Linux and MacOS.
...
* [cfn-lint](https://github.com/awslabs/cfn-python-lint) ⭐ 2,641 | 🐛 78 | 🌐 Python | 📅 2026-09-19 — AWS Labs CloudFormation linter.
...
* [Grype](https://github.com/anchore/grype) ⭐ 12,909 | 🐛 401 | 🌐 Go | 📅 2026-09-18 — Vulnerability scanner for container images and filesystems. Developed by Anchore, it scans container images, directories, and archives for known vulnerabilities. Supports multiple image formats, SBOM integration, and VEX (Vulnerability Exploitability eXchange) for accurate vulnerability assessment. Works with various vulnerability databases and provides detailed reporting.

* [Haskell Dockerfile Linter](https://github.com/lukasmartinelli/hadolint) ⭐ 12,419 | 🐛 207 | 🌐 Haskell | 📅 2026-08-24 — A smarter Dockerfile linter that helps you build best practice Docker images.

* [clair](https://github.com/coreos/clair) ⭐ 11,063 | 🐛 54 | 🌐 Go | 📅 2026-09-18 — Vulnerability Static Analysis for Containers.
...
* [kubeconform](https://github.com/yannh/kubeconform) ⭐ 3,190 | 🐛 90 | 🌐 Go | 📅 2026-06-13 — A fast Kubernetes manifests validator with support for custom resources.
...
* [markdownlint](https://github.com/DavidAnson/markdownlint) ⭐ 6,350 | 🐛 82 | 🌐 JavaScript | 📅 2026-09-19 — Node.js -based style checker and lint tool for Markdown/CommonMark files.

* [mdl](https://github.com/mivok/markdownlint) ⭐ 2,077 | 🐛 108 | 🌐 Ruby | 📅 2026-09-19 — A tool to check Markdown files and flag style issues.
...
* [protolint](https://github.com/yoheimuta/protolint) ⭐ 694 | 🐛 59 | 🌐 Go | 📅 2026-09-18 — Pluggable linter and fixer to enforce Protocol Buffer style and conventions.
...
* [Gitleaks](https://github.com/zricethezav/gitleaks) ⭐ 29,399 | 🐛 484 | 🌐 Go | 📅 2026-09-09 — A SAST tool for detecting hardcoded secrets like passwords, api keys, and tokens in git repos.
...
* [codespell](https://github.com/codespell-project/codespell) ⭐ 2,426 | 🐛 273 | 🌐 Python | 📅 2026-09-16 — Check code for common misspellings.
