...
[![CI](https://github.com/analysis-tools-dev/static-analysis/workflows/CI/badge.svg)](https://github.com/analysis-tools-dev/static-analysis/actions/workflows/ci.yml) ⭐ 14,782 | 🐛 10 | 🌐 Rust | 📅 2026-09-13
[![Links](https://github.com/analysis-tools-dev/static-analysis/actions/workflows/links.yml/badge.svg)](https://github.com/analysis-tools-dev/static-analysis/actions/workflows/links.yml) ⭐ 14,782 | 🐛 10 | 🌐 Rust | 📅 2026-09-13
...
* [cpplint](https://github.com/cpplint/cpplint) ⭐ 1,848 | 🐛 84 | 🌐 Python | 📅 2026-09-07 — Automated C++ checker that follows Google's style guide.
...
* [Roslynator](https://github.com/JosefPihrt/Roslynator) ⭐ 3,478 | 🐛 213 | 🌐 C# | 📅 2026-09-13 — A collection of 190+ analyzers and 190+ refactorings for C#, powered by Roslyn.

* [ArchUnitNET](https://github.com/TNG/ArchUnitNET) ⭐ 1,360 | 🐛 35 | 🌐 C# | 📅 2026-09-12 — A C# architecture test library to specify and assert architecture rules in C# for automated testing.

* [Meziantou.Analyzer](https://github.com/meziantou/Meziantou.Analyzer) ⭐ 1,193 | 🐛 1 | 🌐 C# | 📅 2026-09-13 — A Roslyn analyzer to enforce some good practices in C# in terms of design, usage, security, performance, and style.
...
* [clj-kondo](https://github.com/borkdude/clj-kondo) ⭐ 1,854 | 🐛 156 | 🌐 Clojure | 📅 2026-09-10 — A linter for Clojure code that sparks joy. It informs you about potential errors while you are typing.
...
* [D-scanner](https://github.com/dlang-community/D-Scanner) ⭐ 258 | 🐛 131 | 🌐 D | 📅 2026-02-18 — D-Scanner is a tool for analyzing D source code.

<a id="elixir"></a>

<h2>Elixir</h2>

* [credo](https://github.com/rrrene/credo) ⭐ 5,216 | 🐛 39 | 🌐 Elixir | 📅 2026-08-26 — A static code analysis tool with a focus on code consistency and teaching.
...
* [Reviewdog](https://github.com/haya14busa/reviewdog) ⭐ 9,585 | 🐛 135 | 🌐 Go | 📅 2026-09-13 — A tool for posting review comments from any linter in any code hosting service.

* [gofumpt](https://github.com/mvdan/gofumpt) ⭐ 4,078 | 🐛 13 | 🌐 Go | 📅 2026-09-07 — Enforce a stricter format than `gofmt`, while being backwards-compatible.  That is, `gofumpt` is happy with a subset of the formats that `gofmt` is happy with.
...
* [NullAway](https://github.com/uber/NullAway) ⭐ 4,105 | 🐛 161 | 🌐 Java | 📅 2026-09-10 — Type-based null-pointer checker with low build-time overhead; an [Error Prone](http://errorprone.info/) plugin.

* [Dataflow Framework](https://github.com/typetools/checker-framework) ⭐ 1,149 | 🐛 427 | 🌐 Java | 📅 2026-09-12 — An industrial-strength dataflow framework for Java. The Dataflow Framework is used in the Checker Framework, Google’s Error Prone, Uber’s NullAway, Meta’s Nullsafe, and in other contexts. It is distributed with the Checker Framework.
...
* [Violations Lib](https://github.com/tomasbjerre/violations-lib) ⭐ 161 | 🐛 10 | 🌐 Java | 📅 2026-09-13 — Java library for parsing report files from static code analysis. Used by a bunch of Jenkins, Maven and Gradle plugins.
...
* **jshint** [:information\_source:](https://github.com/analysis-tools-dev/static-analysis/issues/223) ⭐ 14,782 | 🐛 10 | 🌐 Rust | 📅 2026-09-13 :warning: — Detect errors and potential problems in JavaScript code and enforce your team's coding conventions.
...
* [JSLint](https://github.com/douglascrockford/JSLint) ⭐ 3,654 | 🐛 3 | 🌐 JavaScript | 📅 2026-09-04 [:information\_source:](https://github.com/analysis-tools-dev/static-analysis/issues/223) ⭐ 14,782 | 🐛 10 | 🌐 Rust | 📅 2026-09-13 — The JavaScript Code Quality Tool.
...
* [JET](https://github.com/aviatesk/JET.jl) ⭐ 882 | 🐛 86 | 🌐 Julia | 📅 2026-09-13 — Static type inference system to detect bugs and type instabilities.
...
* [EasyCodingStandard](https://www.tomasvotruba.com/blog/2017/05/03/combine-power-of-php-code-sniffer-and-php-cs-fixer-in-3-lines) — Combine [PHP\_CodeSniffer](https://github.com/squizlabs/PHP_CodeSniffer) ⭐ 10,777 | 🐛 248 | 🌐 PHP | 📅 2024-04-01 and [PHP-CS-Fixer](https://github.com/FriendsOfPHP/PHP-CS-Fixer) ⭐ 13,550 | 🐛 87 | 🌐 PHP | 📅 2026-09-11.

* [larastan](https://github.com/larastan/larastan) ⭐ 6,501 | 🐛 107 | 🌐 PHP | 📅 2026-09-11 — Adds static analysis to Laravel improving developer productivity and code quality. It is a wrapper around PHPStan.
...
* [PHP Semantic Versioning Checker](https://github.com/tomzx/php-semver-checker) ⭐ 437 | 🐛 39 | 🌐 PHP | 📅 2026-09-13 — Suggests a next version according to semantic versioning.
...
* [pyright](https://github.com/Microsoft/pyright) ⭐ 15,638 | 🐛 333 | 🌐 Python | 📅 2026-09-11 — Static type checker for Python, created to address gaps in existing tools like mypy.
...
* [vulture](https://github.com/jendrikseipp/vulture) ⭐ 4,809 | 🐛 71 | 🌐 Python | 📅 2026-04-30 — Find unused classes, functions and variables in Python code.
...
* **xenon** :warning: — Monitor code complexity using [`radon`](https://github.com/rubik/radon) ⭐ 2,022 | 🐛 52 | 🌐 Python | 📅 2024-10-20.
...
* [lintr](https://github.com/jimhester/lintr) ⭐ 1,295 | 🐛 299 | 🌐 R | 📅 2026-08-26 — Static Code Analysis for R.

* [R Language Server](https://github.com/REditorSupport/languageserver/) ⭐ 674 | 🐛 129 | 🌐 R | 📅 2026-09-13 — Provides code completion, refactoring, folding, diagnostics (with lintr), and more for R.
...
* [Bullet](https://github.com/flyerhzm/bullet) ⭐ 7,339 | 🐛 7 | 🌐 Ruby | 📅 2026-08-29 — Help to kill N+1 queries and unused eager loading.
...
* [bundler-audit](https://github.com/rubysec/bundler-audit) ⭐ 2,757 | 🐛 48 | 🌐 Ruby | 📅 2026-09-12 — Audit Gemfile.lock for gems with security vulnerabilities reported in [Ruby Advisory Database](https://github.com/rubysec/ruby-advisory-db) ⭐ 1,072 | 🐛 4 | 🌐 Ruby | 📅 2026-09-12.
...
* [Steep](https://github.com/soutaro/steep) ⭐ 1,490 | 🐛 222 | 🌐 Ruby | 📅 2026-09-12 — Gradual Typing for Ruby.
...
* [kani](https://github.com/model-checking/kani) ⭐ 3,408 | 🐛 486 | 🌐 Rust | 📅 2026-09-07 — The Kani Rust Verifier is a bit-precise model checker for Rust.
...
* [cargo-expand](https://github.com/dtolnay/cargo-expand) ⭐ 3,128 | 🐛 10 | 🌐 Rust | 📅 2026-09-10 — Cargo subcommand to show result of macro expansion  and #\[derive] expansion applied to the current crate.  This is a wrapper around a more verbose compiler command.
...
* [cargo-geiger](https://github.com/geiger-rs/cargo-geiger) ⭐ 1,646 | 🐛 50 | 🌐 Rust | 📅 2026-09-12 — A cargo plugin for analysing the usage of unsafe Rust code Provides statistical output to aid security auditing

* [cargo-audit](https://rustsec.org) — Audit Cargo.lock for crates with security vulnerabilities reported to the [RustSec Advisory Database](https://github.com/RustSec/advisory-db/) ⭐ 1,176 | 🐛 148 | 📅 2026-09-09.

* [cargo-show-asm](https://github.com/pacak/cargo-show-asm) ⭐ 980 | 🐛 26 | 🌐 Rust | 📅 2026-09-11 — cargo subcommand showing the assembly, LLVM-IR and MIR generated for Rust code
...
* [rustfmt](https://github.com/rust-lang/rustfmt) ⭐ 6,962 | 🐛 942 | 🌐 Rust | 📅 2026-09-10 — A tool for formatting Rust code according to style guidelines.
...
* [rust-audit](https://github.com/Shnatsel/rust-audit) ⭐ 852 | 🐛 19 | 🌐 Rust | 📅 2026-09-02 — Audit Rust binaries for known bugs or security vulnerabilities. This works by embedding data about the dependency tree (Cargo.lock) in JSON format into a dedicated linker section of the compiled executable.
...
* [scapegoat](https://github.com/sksamuel/scapegoat) ⭐ 556 | 🐛 47 | 🌐 Scala | 📅 2026-09-13 — Scala compiler plugin for static code analysis.
...
* [TypeScript ESLint](https://github.com/typescript-eslint/typescript-eslint) ⭐ 16,388 | 🐛 279 | 🌐 TypeScript | 📅 2026-09-11 — TypeScript language extension for eslint.
...
* [Angular ESLint](https://github.com/angular-eslint/angular-eslint#readme) ⭐ 1,782 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-13 — Linter for Angular projects
...
* [vscode-verilog-hdl-support](https://github.com/mshr-h/vscode-verilog-hdl-support) ⭐ 386 | 🐛 68 | 🌐 TypeScript | 📅 2026-09-13 — Verilog HDL/SystemVerilog/Bluespec SystemVerilog support for VS Code. Provides syntax highlighting and Linting support from Icarus Verilog, Vivado Logical Simulation, Modelsim and Verilator
...
* [trivy](https://github.com/aquasecurity/trivy) ⭐ 37,889 | 🐛 269 | 🌐 Go | 📅 2026-09-11 — A Simple and Comprehensive Vulnerability Scanner for Containers and other Artifacts, Suitable for CI. Trivy detects vulnerabilities of OS packages (Alpine, RHEL, CentOS, etc.) and application dependencies (Bundler, Composer, npm, yarn, etc.). Checks containers and filesystems.

* [ESLint](https://github.com/eslint/eslint) ⭐ 27,502 | 🐛 125 | 🌐 JavaScript | 📅 2026-09-13 — An extensible linter for JS, following the ECMAScript standard.

* [oxc](https://github.com/web-infra-dev/oxc) ⭐ 22,726 | 🐛 877 | 🌐 Rust | 📅 2026-09-13 — The Oxidation Compiler is creating a suite of high-performance tools for the JavaScript / TypeScript language re-written in Rust.

* [ale](https://github.com/w0rp/ale) ⭐ 14,014 | 🐛 588 | 🌐 Vim Script | 📅 2026-08-21 — Asynchronous Lint Engine for Vim and NeoVim with support for many languages.

* [codeql](https://github.com/github/codeql) ⭐ 10,083 | 🐛 1,461 | 🌐 CodeQL | 📅 2026-09-12 — Deep code analysis - semantic queries and dataflow for several languages with VSCode plugin support.
...
* [sem](https://github.com/Ataraxy-Labs/sem) ⭐ 3,346 | 🐛 5 | 🌐 Rust | 📅 2026-09-10 — Semantic version control CLI that provides entity-level diffs, blame, and impact analysis on top of git. Uses tree-sitter to parse 26 languages and builds a cross-file dependency graph with structural hashing. Commands include sem diff, sem blame, sem graph, and sem impact for blast-radius analysis of code changes.

* [ClassGraph](https://github.com/classgraph/classgraph) ⭐ 3,010 | 🐛 2 | 🌐 Java | 📅 2026-09-08 — A classpath and module path scanner for querying or visualizing class metadata or class relatedness.
...
* [lizard](https://github.com/terryyin/lizard) ⭐ 2,501 | 🐛 25 | 🌐 Python | 📅 2026-09-09 — Lizard is an extensible Cyclomatic Complexity Analyzer for many programming languages  including C/C++ (doesn't require all the header files or Java imports).  It also does copy-paste detection (code clone detection/code duplicate detection) and many other forms of static code analysis. Counts lines of code without comments, CCN (cyclomatic complexity number), token count of functions, parameter count of functions.
...
* [emerge](https://github.com/glato/emerge) ⭐ 1,148 | 🐛 19 | 🌐 Python | 📅 2026-08-07 — Emerge is a source code and dependency visualizer that can be used to gather insights about source code structure, metrics, dependencies and complexity of software projects. After scanning the source code of a project it provides you an interactive web interface to explore and analyze your project by using graph structures.
...
* [WALA](https://github.com/wala/WALA) ⭐ 869 | 🐛 153 | 🌐 Java | 📅 2026-09-10 — Static analysis capabilities for Java bytecode and related languages and for JavaScript.

* [Putout](https://github.com/coderaiser/putout) ⭐ 795 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-13 — Pluggable and configurable code transformer with built-in eslint, babel plugins support for js, jsx typescript, flow, markdown, yaml and json.

* [Skylos](https://github.com/duriantaco/skylos) ⭐ 788 | 🐛 3 | 🌐 Python | 📅 2026-09-13 — Dead code detection, security scanning, secrets detection, and code quality analysis for Python, TypeScript, and Go. Framework-aware analysis with 98% recall. Includes CI/CD GitHub Action, VS Code extension, and MCP server for AI agent integration.
...
* [Rev-dep](https://github.com/jayu/rev-dep) ⭐ 258 | 🐛 1 | 🌐 Go | 📅 2026-08-07 — Dependency analysis and optimization toolkit for modern JavaScript and TypeScript projects. Trace imports, identify circular dependencies, find unused code, clean node modules.
...
* [angr](https://github.com/angr/angr) ⭐ 9,088 | 🐛 737 | 🌐 Python | 📅 2026-09-13 — Binary code analysis tool that also supports symbolic execution.

* [bloaty](https://github.com/google/bloaty) ⭐ 5,541 | 🐛 72 | 🌐 C++ | 📅 2026-09-10 — Ever wondered what's making your binary big? Bloaty McBloatface will show you a size profile of the binary so you can understand what's taking up space inside. Bloaty performs a deep analysis of the binary. Using custom ELF, DWARF, and Mach-O parsers,  Bloaty aims to accurately attribute every byte of the binary to the symbol or compileunit that produced it.  It will even disassemble the binary looking for references to anonymous data. F
...
* [checkmake](https://github.com/mrtazz/checkmake) ⭐ 1,213 | 🐛 43 | 🌐 Go | 📅 2026-09-09 — Linter / Analyzer for Makefiles.
...
* [cfn-lint](https://github.com/awslabs/cfn-python-lint) ⭐ 2,637 | 🐛 83 | 🌐 Python | 📅 2026-09-12 — AWS Labs CloudFormation linter.
...
* [Grype](https://github.com/anchore/grype) ⭐ 12,876 | 🐛 410 | 🌐 Go | 📅 2026-09-11 — Vulnerability scanner for container images and filesystems. Developed by Anchore, it scans container images, directories, and archives for known vulnerabilities. Supports multiple image formats, SBOM integration, and VEX (Vulnerability Exploitability eXchange) for accurate vulnerability assessment. Works with various vulnerability databases and provides detailed reporting.
...
* [markdownlint](https://github.com/DavidAnson/markdownlint) ⭐ 6,341 | 🐛 79 | 🌐 JavaScript | 📅 2026-09-12 — Node.js -based style checker and lint tool for Markdown/CommonMark files.
...
* [lockfile-lint](https://github.com/lirantal/lockfile-lint) ⭐ 868 | 🐛 7 | 🌐 JavaScript | 📅 2026-08-13 — Lint an npm or yarn lockfile to analyze and detect security issues
...
* [Gitleaks](https://github.com/zricethezav/gitleaks) ⭐ 29,286 | 🐛 474 | 🌐 Go | 📅 2026-09-09 — A SAST tool for detecting hardcoded secrets like passwords, api keys, and tokens in git repos.
...
* [scorecard](https://github.com/ossf/scorecard) ⭐ 5,687 | 🐛 454 | 🌐 Go | 📅 2026-09-10 — Security Scorecards - Security health metrics for Open Source
...
* [proselint](https://github.com/amperser/proselint) ⭐ 4,576 | 🐛 236 | 🌐 JavaScript | 📅 2026-09-04 — A linter for English prose with a focus on writing style instead of grammar.

* [codespell](https://github.com/codespell-project/codespell) ⭐ 2,424 | 🐛 276 | 🌐 Python | 📅 2026-09-08 — Check code for common misspellings.
...
* [go-tools](https://github.com/dominikh/go-tools) ⭐ 6,892 | 🐛 575 | 🌐 Go | 📅 2026-08-24 — A collection of tools and libraries for working with Go code, including linters and static analysis
