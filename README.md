...
[![CI](https://github.com/analysis-tools-dev/static-analysis/workflows/CI/badge.svg)](https://github.com/analysis-tools-dev/static-analysis/actions/workflows/ci.yml) ⭐ 14,783 | 🐛 0 | 🌐 Rust | 📅 2026-09-18
[![Links](https://github.com/analysis-tools-dev/static-analysis/actions/workflows/links.yml/badge.svg)](https://github.com/analysis-tools-dev/static-analysis/actions/workflows/links.yml) ⭐ 14,783 | 🐛 0 | 🌐 Rust | 📅 2026-09-18
...
* [ArchUnitNET](https://github.com/TNG/ArchUnitNET) ⭐ 1,363 | 🐛 35 | 🌐 C# | 📅 2026-09-18 — A C# architecture test library to specify and assert architecture rules in C# for automated testing.
...
* [SonarAnalyzer.CSharp](https://github.com/SonarSource/sonar-dotnet) ⭐ 918 | 🐛 250 | 🌐 C# | 📅 2026-09-18 — These Roslyn analyzers allow you to produce Clean Code that is safe, reliable, and maintainable by helping you find and correct bugs, vulnerabilities, and code smells in your codebase.
...
* [clj-kondo](https://github.com/borkdude/clj-kondo) ⭐ 1,854 | 🐛 157 | 🌐 Clojure | 📅 2026-09-17 — A linter for Clojure code that sparks joy. It informs you about potential errors while you are typing.
...
* [SonarDelphi](https://github.com/integrated-application-development/sonar-delphi) ⭐ 159 | 🐛 41 | 🌐 Java | 📅 2026-09-16 — Delphi static analyzer for the SonarQube code quality platform.
...
* [credo](https://github.com/rrrene/credo) ⭐ 5,222 | 🐛 41 | 🌐 Elixir | 📅 2026-08-26 — A static code analysis tool with a focus on code consistency and teaching.
...
* [Reviewdog](https://github.com/haya14busa/reviewdog) ⭐ 9,597 | 🐛 133 | 🌐 Go | 📅 2026-09-18 — A tool for posting review comments from any linter in any code hosting service.

* [gofumpt](https://github.com/mvdan/gofumpt) ⭐ 4,087 | 🐛 13 | 🌐 Go | 📅 2026-09-07 — Enforce a stricter format than `gofmt`, while being backwards-compatible.  That is, `gofumpt` is happy with a subset of the formats that `gofmt` is happy with.
...
* [gocyclo](https://github.com/fzipp/gocyclo) ⭐ 1,609 | 🐛 11 | 🌐 Go | 📅 2025-12-27 — Calculate cyclomatic complexities of functions in Go source code.
...
* [unconvert](https://github.com/mdempsky/unconvert) ⭐ 388 | 🐛 9 | 🌐 Go | 📅 2026-08-16 — Detect redundant type conversions.
...
* [google-java-format](https://github.com/google/google-java-format) ⭐ 6,194 | 🐛 180 | 🌐 Java | 📅 2026-09-17 — Reformats Java source code to comply with Google Java Style

* [NullAway](https://github.com/uber/NullAway) ⭐ 4,105 | 🐛 160 | 🌐 Java | 📅 2026-09-18 — Type-based null-pointer checker with low build-time overhead; an [Error Prone](http://errorprone.info/) plugin.

* [Dataflow Framework](https://github.com/typetools/checker-framework) ⭐ 1,149 | 🐛 429 | 🌐 Java | 📅 2026-09-18 — An industrial-strength dataflow framework for Java. The Dataflow Framework is used in the Checker Framework, Google’s Error Prone, Uber’s NullAway, Meta’s Nullsafe, and in other contexts. It is distributed with the Checker Framework.
...
* [forbidden-apis](https://github.com/policeman-tools/forbidden-apis) ⭐ 372 | 🐛 30 | 🌐 Java | 📅 2026-09-18 — Detects and forbids invocations of specific method/class/field (like reading from a text stream without a charset). Maven/Gradle/Ant compatible.
...
* [xo](https://github.com/xojs/xo) ⭐ 7,991 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-18 — Opinionated but configurable ESLint wrapper with lots of goodies included. Enforces strict and readable code.

* [JSLint](https://github.com/douglascrockford/JSLint) ⭐ 3,654 | 🐛 3 | 🌐 JavaScript | 📅 2026-09-15 [:information\_source:](https://github.com/analysis-tools-dev/static-analysis/issues/223) ⭐ 14,783 | 🐛 0 | 🌐 Rust | 📅 2026-09-18 — The JavaScript Code Quality Tool.
...
* **jshint** [:information\_source:](https://github.com/analysis-tools-dev/static-analysis/issues/223) ⭐ 14,783 | 🐛 0 | 🌐 Rust | 📅 2026-09-18 :warning: — Detect errors and potential problems in JavaScript code and enforce your team's coding conventions.
...
* [JET](https://github.com/aviatesk/JET.jl) ⭐ 882 | 🐛 88 | 🌐 Julia | 📅 2026-09-18 — Static type inference system to detect bugs and type instabilities.
...
* [luacheck](https://github.com/lunarmodules/luacheck) ⭐ 459 | 🐛 43 | 🌐 Lua | 📅 2026-07-31 — A tool for linting and static analysis of Lua code.
...
* [PHP-Parser](https://github.com/nikic/PHP-Parser) ⭐ 17,472 | 🐛 69 | 🌐 PHP | 📅 2026-09-14 — A PHP parser written in PHP.

* [EasyCodingStandard](https://www.tomasvotruba.com/blog/2017/05/03/combine-power-of-php-code-sniffer-and-php-cs-fixer-in-3-lines) — Combine [PHP\_CodeSniffer](https://github.com/squizlabs/PHP_CodeSniffer) ⭐ 10,777 | 🐛 248 | 🌐 PHP | 📅 2024-04-01 and [PHP-CS-Fixer](https://github.com/FriendsOfPHP/PHP-CS-Fixer) ⭐ 13,552 | 🐛 86 | 🌐 PHP | 📅 2026-09-18.

* [larastan](https://github.com/larastan/larastan) ⭐ 6,511 | 🐛 91 | 🌐 PHP | 📅 2026-09-17 — Adds static analysis to Laravel improving developer productivity and code quality. It is a wrapper around PHPStan.

* [PHP Insights](https://github.com/nunomaduro/phpinsights) ⭐ 5,635 | 🐛 71 | 🌐 PHP | 📅 2026-09-15 — Instant PHP quality checks from your console. Analysis of code quality and coding style as well as overview of code architecture and its complexity.
...
* [pyright](https://github.com/Microsoft/pyright) ⭐ 15,648 | 🐛 339 | 🌐 Python | 📅 2026-09-18 — Static type checker for Python, created to address gaps in existing tools like mypy.
...
* [vulture](https://github.com/jendrikseipp/vulture) ⭐ 4,813 | 🐛 71 | 🌐 Python | 📅 2026-09-16 — Find unused classes, functions and variables in Python code.
...
* **xenon** :warning: — Monitor code complexity using [`radon`](https://github.com/rubik/radon) ⭐ 2,027 | 🐛 52 | 🌐 Python | 📅 2024-10-20.
...
* [Standard Ruby](https://github.com/testdouble/standard) ⭐ 2,924 | 🐛 45 | 🌐 Ruby | 📅 2026-09-14 — Ruby Style Guide, with linter & automatic code fixer

* [bundler-audit](https://github.com/rubysec/bundler-audit) ⭐ 2,758 | 🐛 49 | 🌐 Ruby | 📅 2026-09-18 — Audit Gemfile.lock for gems with security vulnerabilities reported in [Ruby Advisory Database](https://github.com/rubysec/ruby-advisory-db) ⭐ 1,072 | 🐛 2 | 🌐 Ruby | 📅 2026-09-16.
...
* [Steep](https://github.com/soutaro/steep) ⭐ 1,490 | 🐛 223 | 🌐 Ruby | 📅 2026-09-17 — Gradual Typing for Ruby.
...
* [kani](https://github.com/model-checking/kani) ⭐ 3,427 | 🐛 492 | 🌐 Rust | 📅 2026-09-17 — The Kani Rust Verifier is a bit-precise model checker for Rust.
...
* [cargo-audit](https://rustsec.org) — Audit Cargo.lock for crates with security vulnerabilities reported to the [RustSec Advisory Database](https://github.com/RustSec/advisory-db/) ⭐ 1,178 | 🐛 146 | 📅 2026-09-18.
...
* [rustfmt](https://github.com/rust-lang/rustfmt) ⭐ 6,965 | 🐛 939 | 🌐 Rust | 📅 2026-09-17 — A tool for formatting Rust code according to style guidelines.
...
* [rust-audit](https://github.com/Shnatsel/rust-audit) ⭐ 854 | 🐛 17 | 🌐 Rust | 📅 2026-09-13 — Audit Rust binaries for known bugs or security vulnerabilities. This works by embedding data about the dependency tree (Cargo.lock) in JSON format into a dedicated linker section of the compiled executable.
...
* [pgspot](https://github.com/timescale/pgspot) ⭐ 148 | 🐛 10 | 🌐 Python | 📅 2026-09-18 — Spot vulnerabilities in postgres extension scripts. Finds unsafe search\_path usage and unsafe object creation in PostgreSQL extension scripts or any other PostgreSQL SQL code.

* [scythe](https://github.com/Goldziher/scythe) ⭐ 70 | 🐛 2 | 🌐 Rust | 📅 2026-09-18 — Polyglot SQL compiler and linter that generates type-safe code from SQL with schema-aware linting.
...
* [SwiftFormat](https://github.com/nicklockwood/SwiftFormat) ⭐ 8,933 | 🐛 292 | 🌐 Swift | 📅 2026-09-16 — A library and command-line formatting tool for reformatting Swift code.
...
* [TypeScript ESLint](https://github.com/typescript-eslint/typescript-eslint) ⭐ 16,391 | 🐛 232 | 🌐 TypeScript | 📅 2026-09-17 — TypeScript language extension for eslint.

* [Angular ESLint](https://github.com/angular-eslint/angular-eslint#readme) ⭐ 1,784 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-18 — Linter for Angular projects
...
* [trivy](https://github.com/aquasecurity/trivy) ⭐ 37,970 | 🐛 271 | 🌐 Go | 📅 2026-09-18 — A Simple and Comprehensive Vulnerability Scanner for Containers and other Artifacts, Suitable for CI. Trivy detects vulnerabilities of OS packages (Alpine, RHEL, CentOS, etc.) and application dependencies (Bundler, Composer, npm, yarn, etc.). Checks containers and filesystems.

* [ESLint](https://github.com/eslint/eslint) ⭐ 27,511 | 🐛 132 | 🌐 JavaScript | 📅 2026-09-17 — An extensible linter for JS, following the ECMAScript standard.

* [oxc](https://github.com/web-infra-dev/oxc) ⭐ 22,788 | 🐛 918 | 🌐 Rust | 📅 2026-09-18 — The Oxidation Compiler is creating a suite of high-performance tools for the JavaScript / TypeScript language re-written in Rust.
...
* [codeql](https://github.com/github/codeql) ⭐ 10,104 | 🐛 1,472 | 🌐 CodeQL | 📅 2026-09-18 — Deep code analysis - semantic queries and dataflow for several languages with VSCode plugin support.
...
* [Bearer](https://github.com/bearer/bearer) ⭐ 2,744 | 🐛 18 | 🌐 Go | 📅 2026-09-16 — Open-Source static code analysis tool to discover,  filter and prioritize security risks and vulnerabilities  leading to sensitive data exposures (PII, PHI, PD).  Highly configurable and easily extensible,  built for security and engineering teams.
...
* [Roslyn Analyzers](https://github.com/dotnet/roslyn-analyzers) ⭐ 1,672 | 🐛 1,058 | 📅 2026-09-14 — Roslyn-based implementation of FxCop analyzers.

* [weave](https://github.com/Ataraxy-Labs/weave) ⭐ 1,286 | 🐛 3 | 🌐 Rust | 📅 2026-09-17 — Entity-level semantic merge driver for git. Resolves false conflicts that line-based merge produces when independent changes touch the same file. Parses functions and classes via tree-sitter, matches by name, and merges at the entity level. Benchmarked at 100% clean merges vs git's 48% on a 31-scenario suite.
...
* [angr](https://github.com/angr/angr) ⭐ 9,096 | 🐛 728 | 🌐 Python | 📅 2026-09-17 — Binary code analysis tool that also supports symbolic execution.

* [bloaty](https://github.com/google/bloaty) ⭐ 5,546 | 🐛 72 | 🌐 C++ | 📅 2026-09-10 — Ever wondered what's making your binary big? Bloaty McBloatface will show you a size profile of the binary so you can understand what's taking up space inside. Bloaty performs a deep analysis of the binary. Using custom ELF, DWARF, and Mach-O parsers,  Bloaty aims to accurately attribute every byte of the binary to the symbol or compileunit that produced it.  It will even disassemble the binary looking for references to anonymous data. F

* [Twiggy](https://github.com/rustwasm/twiggy) ⚠️ Archived — Analyzes a binary's call graph to profile code size. The goal is to slim down wasm binary size.

* [cwe\_checker](https://github.com/fkie-cad/cwe_checker) ⭐ 1,357 | 🐛 29 | 🌐 Rust | 📅 2026-08-20 — cwe\_checker finds vulnerable patterns in binary executables.
...
* [BinSkim](https://github.com/Microsoft/binskim) ⭐ 860 | 🐛 152 | 🌐 C# | 📅 2026-09-17 — A binary static analysis tool that provides security and correctness results for Windows portable executables.
...
* [cfn-lint](https://github.com/awslabs/cfn-python-lint) ⭐ 2,638 | 🐛 78 | 🌐 Python | 📅 2026-09-18 — AWS Labs CloudFormation linter.
...
* [Grype](https://github.com/anchore/grype) ⭐ 12,901 | 🐛 401 | 🌐 Go | 📅 2026-09-18 — Vulnerability scanner for container images and filesystems. Developed by Anchore, it scans container images, directories, and archives for known vulnerabilities. Supports multiple image formats, SBOM integration, and VEX (Vulnerability Exploitability eXchange) for accurate vulnerability assessment. Works with various vulnerability databases and provides detailed reporting.

* [Haskell Dockerfile Linter](https://github.com/lukasmartinelli/hadolint) ⭐ 12,414 | 🐛 207 | 🌐 Haskell | 📅 2026-08-24 — A smarter Dockerfile linter that helps you build best practice Docker images.

* [clair](https://github.com/coreos/clair) ⭐ 11,058 | 🐛 52 | 🌐 Go | 📅 2026-09-16 — Vulnerability Static Analysis for Containers.
...
* [kube-linter](https://github.com/stackrox/kube-linter) ⭐ 3,507 | 🐛 85 | 🌐 Go | 📅 2026-09-18 — KubeLinter is a static analysis tool that checks Kubernetes YAML files  and Helm charts to ensure the applications represented in them adhere to best practices.

* [kubeconform](https://github.com/yannh/kubeconform) ⭐ 3,188 | 🐛 90 | 🌐 Go | 📅 2026-06-13 — A fast Kubernetes manifests validator with support for custom resources.
...
- [KubeLinter](https://github.com/stackrox/kube-linter) ⭐ 3,507 | 🐛 85 | 🌐 Go | 📅 2026-09-18 — KubeLinter is a static analysis tool that checks Kubernetes YAML files and Helm charts to ensure the applications represented in them adhere to best practices.
...
* [markdownlint](https://github.com/DavidAnson/markdownlint) ⭐ 6,348 | 🐛 83 | 🌐 JavaScript | 📅 2026-09-18 — Node.js -based style checker and lint tool for Markdown/CommonMark files.
...
* [protolint](https://github.com/yoheimuta/protolint) ⭐ 699 | 🐛 59 | 🌐 Go | 📅 2026-09-18 — Pluggable linter and fixer to enforce Protocol Buffer style and conventions.
...
* [Gitleaks](https://github.com/zricethezav/gitleaks) ⭐ 29,372 | 🐛 482 | 🌐 Go | 📅 2026-09-09 — A SAST tool for detecting hardcoded secrets like passwords, api keys, and tokens in git repos.
...
* [scorecard](https://github.com/ossf/scorecard) ⭐ 5,695 | 🐛 457 | 🌐 Go | 📅 2026-09-18 — Security Scorecards - Security health metrics for Open Source
...
* [codespell](https://github.com/codespell-project/codespell) ⭐ 2,426 | 🐛 272 | 🌐 Python | 📅 2026-09-16 — Check code for common misspellings.
...
* [go-tools](https://github.com/dominikh/go-tools) ⭐ 6,899 | 🐛 578 | 🌐 Go | 📅 2026-08-24 — A collection of tools and libraries for working with Go code, including linters and static analysis
