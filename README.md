...
[![CI](https://github.com/analysis-tools-dev/static-analysis/workflows/CI/badge.svg)](https://github.com/analysis-tools-dev/static-analysis/actions/workflows/ci.yml) ⭐ 14,755 | 🐛 11 | 🌐 Rust | 📅 2026-08-30
[![Links](https://github.com/analysis-tools-dev/static-analysis/actions/workflows/links.yml/badge.svg)](https://github.com/analysis-tools-dev/static-analysis/actions/workflows/links.yml) ⭐ 14,755 | 🐛 11 | 🌐 Rust | 📅 2026-08-30
...
* [cpplint](https://github.com/cpplint/cpplint) ⭐ 1,846 | 🐛 84 | 🌐 Python | 📅 2026-08-31 — Automated C++ checker that follows Google's style guide.
...
* [Meziantou.Analyzer](https://github.com/meziantou/Meziantou.Analyzer) ⭐ 1,185 | 🐛 4 | 🌐 C# | 📅 2026-09-01 — A Roslyn analyzer to enforce some good practices in C# in terms of design, usage, security, performance, and style.

* [SonarAnalyzer.CSharp](https://github.com/SonarSource/sonar-dotnet) ⭐ 917 | 🐛 249 | 🌐 C# | 📅 2026-08-29 — These Roslyn analyzers allow you to produce Clean Code that is safe, reliable, and maintainable by helping you find and correct bugs, vulnerabilities, and code smells in your codebase.
...
* [SonarDelphi](https://github.com/integrated-application-development/sonar-delphi) ⭐ 158 | 🐛 41 | 🌐 Java | 📅 2026-08-31 — Delphi static analyzer for the SonarQube code quality platform.
...
* [FSharpLint](https://github.com/fsprojects/FSharpLint) ⭐ 327 | 🐛 98 | 🌐 F# | 📅 2026-09-01 — Lint tool for F#.
...
* [Reviewdog](https://github.com/haya14busa/reviewdog) ⭐ 9,555 | 🐛 140 | 🌐 Go | 📅 2026-09-01 — A tool for posting review comments from any linter in any code hosting service.
...
* [go-critic](https://github.com/go-critic/go-critic) ⭐ 2,067 | 🐛 153 | 🌐 Go | 📅 2026-06-26 — Go source code linter that maintains checks which are currently not implemented in other linters.
...
* [NullAway](https://github.com/uber/NullAway) ⭐ 4,098 | 🐛 157 | 🌐 Java | 📅 2026-09-01 — Type-based null-pointer checker with low build-time overhead; an [Error Prone](http://errorprone.info/) plugin.

* [Dataflow Framework](https://github.com/typetools/checker-framework) ⭐ 1,149 | 🐛 434 | 🌐 Java | 📅 2026-08-31 — An industrial-strength dataflow framework for Java. The Dataflow Framework is used in the Checker Framework, Google’s Error Prone, Uber’s NullAway, Meta’s Nullsafe, and in other contexts. It is distributed with the Checker Framework.
...
* **jshint** [:information\_source:](https://github.com/analysis-tools-dev/static-analysis/issues/223) ⭐ 14,755 | 🐛 11 | 🌐 Rust | 📅 2026-08-30 :warning: — Detect errors and potential problems in JavaScript code and enforce your team's coding conventions.
...
* [JSLint](https://github.com/douglascrockford/JSLint) ⭐ 3,656 | 🐛 4 | 🌐 JavaScript | 📅 2026-09-01 [:information\_source:](https://github.com/analysis-tools-dev/static-analysis/issues/223) ⭐ 14,755 | 🐛 11 | 🌐 Rust | 📅 2026-08-30 — The JavaScript Code Quality Tool.
...
* [EasyCodingStandard](https://www.tomasvotruba.com/blog/2017/05/03/combine-power-of-php-code-sniffer-and-php-cs-fixer-in-3-lines) — Combine [PHP\_CodeSniffer](https://github.com/squizlabs/PHP_CodeSniffer) ⭐ 10,779 | 🐛 248 | 🌐 PHP | 📅 2024-04-01 and [PHP-CS-Fixer](https://github.com/FriendsOfPHP/PHP-CS-Fixer) ⭐ 13,548 | 🐛 82 | 🌐 PHP | 📅 2026-08-31.

* [larastan](https://github.com/larastan/larastan) ⭐ 6,503 | 🐛 115 | 🌐 PHP | 📅 2026-08-31 — Adds static analysis to Laravel improving developer productivity and code quality. It is a wrapper around PHPStan.
...
* [pyright](https://github.com/Microsoft/pyright) ⭐ 15,614 | 🐛 325 | 🌐 Python | 📅 2026-08-28 — Static type checker for Python, created to address gaps in existing tools like mypy.

* [mypy](http://www.mypy-lang.org) — A static type checker that aims to combine the benefits of duck typing and static typing, frequently used with [MonkeyType](https://github.com/Instagram/MonkeyType) ⭐ 4,999 | 🐛 78 | 🌐 Python | 📅 2026-02-11.
...
* [lintr](https://github.com/jimhester/lintr) ⭐ 1,294 | 🐛 296 | 🌐 R | 📅 2026-08-26 — Static Code Analysis for R.
...
* [Bullet](https://github.com/flyerhzm/bullet) ⭐ 7,334 | 🐛 7 | 🌐 Ruby | 📅 2026-08-29 — Help to kill N+1 queries and unused eager loading.
...
* [Standard Ruby](https://github.com/testdouble/standard) ⭐ 2,920 | 🐛 44 | 🌐 Ruby | 📅 2026-08-31 — Ruby Style Guide, with linter & automatic code fixer

* [bundler-audit](https://github.com/rubysec/bundler-audit) ⭐ 2,756 | 🐛 48 | 🌐 Ruby | 📅 2026-08-31 — Audit Gemfile.lock for gems with security vulnerabilities reported in [Ruby Advisory Database](https://github.com/rubysec/ruby-advisory-db) ⭐ 1,071 | 🐛 3 | 🌐 Ruby | 📅 2026-08-31.
...
* [Steep](https://github.com/soutaro/steep) ⭐ 1,488 | 🐛 222 | 🌐 Ruby | 📅 2026-09-01 — Gradual Typing for Ruby.
...
* [kani](https://github.com/model-checking/kani) ⭐ 3,373 | 🐛 473 | 🌐 Rust | 📅 2026-09-01 — The Kani Rust Verifier is a bit-precise model checker for Rust.
...
* [cargo-geiger](https://github.com/geiger-rs/cargo-geiger) ⭐ 1,644 | 🐛 54 | 🌐 Rust | 📅 2026-09-01 — A cargo plugin for analysing the usage of unsafe Rust code Provides statistical output to aid security auditing

* [cargo-audit](https://rustsec.org) — Audit Cargo.lock for crates with security vulnerabilities reported to the [RustSec Advisory Database](https://github.com/RustSec/advisory-db/) ⭐ 1,169 | 🐛 146 | 📅 2026-09-01.
...
* [rustfmt](https://github.com/rust-lang/rustfmt) ⭐ 6,954 | 🐛 939 | 🌐 Rust | 📅 2026-09-01 — A tool for formatting Rust code according to style guidelines.
...
* [scythe](https://github.com/Goldziher/scythe) ⭐ 66 | 🐛 2 | 🌐 Rust | 📅 2026-08-31 — Polyglot SQL compiler and linter that generates type-safe code from SQL with schema-aware linting.
...
* [shellharden](https://github.com/anordal/shellharden) ⭐ 4,802 | 🐛 10 | 🌐 Rust | 📅 2026-07-09 — A syntax highlighter and a tool to semi-automate the rewriting of scripts to ShellCheck conformance, mainly focused on quoting.
...
* [SwiftFormat](https://github.com/nicklockwood/SwiftFormat) ⭐ 8,923 | 🐛 290 | 🌐 Swift | 📅 2026-08-31 — A library and command-line formatting tool for reformatting Swift code.
...
* [TypeScript ESLint](https://github.com/typescript-eslint/typescript-eslint) ⭐ 16,374 | 🐛 261 | 🌐 TypeScript | 📅 2026-09-01 — TypeScript language extension for eslint.
...
* [Angular ESLint](https://github.com/angular-eslint/angular-eslint#readme) ⭐ 1,784 | 🐛 34 | 🌐 TypeScript | 📅 2026-09-01 — Linter for Angular projects
...
* [wasm-language-tools](https://github.com/g-plane/wasm-language-tools) ⭐ 93 | 🐛 2 | 🌐 Rust | 📅 2026-09-01 — WebAssembly Language Tools aims to provide and improve the editing experience of WebAssembly Text Format. It also provides an out-of-the-box formatter (a.k.a. pretty printer) for WebAssembly Text Format.

## Multiple languages

* [trivy](https://github.com/aquasecurity/trivy) ⭐ 37,729 | 🐛 265 | 🌐 Go | 📅 2026-08-28 — A Simple and Comprehensive Vulnerability Scanner for Containers and other Artifacts, Suitable for CI. Trivy detects vulnerabilities of OS packages (Alpine, RHEL, CentOS, etc.) and application dependencies (Bundler, Composer, npm, yarn, etc.). Checks containers and filesystems.

* [ESLint](https://github.com/eslint/eslint) ⭐ 27,494 | 🐛 135 | 🌐 JavaScript | 📅 2026-09-01 — An extensible linter for JS, following the ECMAScript standard.

* [oxc](https://github.com/web-infra-dev/oxc) ⭐ 22,599 | 🐛 831 | 🌐 Rust | 📅 2026-09-01 — The Oxidation Compiler is creating a suite of high-performance tools for the JavaScript / TypeScript language re-written in Rust.

* [ale](https://github.com/w0rp/ale) ⭐ 14,020 | 🐛 588 | 🌐 Vim Script | 📅 2026-08-21 — Asynchronous Lint Engine for Vim and NeoVim with support for many languages.

* [codeql](https://github.com/github/codeql) ⭐ 10,037 | 🐛 1,469 | 🌐 CodeQL | 📅 2026-09-01 — Deep code analysis - semantic queries and dataflow for several languages with VSCode plugin support.
...
* [sem](https://github.com/Ataraxy-Labs/sem) ⭐ 3,327 | 🐛 6 | 🌐 Rust | 📅 2026-09-01 — Semantic version control CLI that provides entity-level diffs, blame, and impact analysis on top of git. Uses tree-sitter to parse 26 languages and builds a cross-file dependency graph with structural hashing. Commands include sem diff, sem blame, sem graph, and sem impact for blast-radius analysis of code changes.

* [ClassGraph](https://github.com/classgraph/classgraph) ⭐ 3,005 | 🐛 1 | 🌐 Java | 📅 2026-09-01 — A classpath and module path scanner for querying or visualizing class metadata or class relatedness.

* [Bearer](https://github.com/bearer/bearer) ⭐ 2,739 | 🐛 18 | 🌐 Go | 📅 2026-08-31 — Open-Source static code analysis tool to discover,  filter and prioritize security risks and vulnerabilities  leading to sensitive data exposures (PII, PHI, PD).  Highly configurable and easily extensible,  built for security and engineering teams.
...
* [lizard](https://github.com/terryyin/lizard) ⭐ 2,478 | 🐛 24 | 🌐 Python | 📅 2026-08-29 — Lizard is an extensible Cyclomatic Complexity Analyzer for many programming languages  including C/C++ (doesn't require all the header files or Java imports).  It also does copy-paste detection (code clone detection/code duplicate detection) and many other forms of static code analysis. Counts lines of code without comments, CCN (cyclomatic complexity number), token count of functions, parameter count of functions.
...
* [Roslyn Analyzers](https://github.com/dotnet/roslyn-analyzers) ⭐ 1,672 | 🐛 1,058 | 📅 2026-09-01 — Roslyn-based implementation of FxCop analyzers.

* [weave](https://github.com/Ataraxy-Labs/weave) ⭐ 1,265 | 🐛 10 | 🌐 Rust | 📅 2026-09-01 — Entity-level semantic merge driver for git. Resolves false conflicts that line-based merge produces when independent changes touch the same file. Parses functions and classes via tree-sitter, matches by name, and merges at the entity level. Benchmarked at 100% clean merges vs git's 48% on a 31-scenario suite.
...
* [Putout](https://github.com/coderaiser/putout) ⭐ 796 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-31 — Pluggable and configurable code transformer with built-in eslint, babel plugins support for js, jsx typescript, flow, markdown, yaml and json.

* [Skylos](https://github.com/duriantaco/skylos) ⭐ 545 | 🐛 14 | 🌐 Python | 📅 2026-09-01 — Dead code detection, security scanning, secrets detection, and code quality analysis for Python, TypeScript, and Go. Framework-aware analysis with 98% recall. Includes CI/CD GitHub Action, VS Code extension, and MCP server for AI agent integration.
...
* [Rev-dep](https://github.com/jayu/rev-dep) ⭐ 255 | 🐛 3 | 🌐 Go | 📅 2026-08-07 — Dependency analysis and optimization toolkit for modern JavaScript and TypeScript projects. Trace imports, identify circular dependencies, find unused code, clean node modules.

* [nestjs-doctor](https://github.com/RoloBits/nestjs-doctor) ⭐ 158 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-01 — Static analysis tool for NestJS applications. Detects anti-patterns across security, performance, correctness, and architecture with 30+ built-in rules. Outputs a 0-100 health score. Includes module graph visualization, endpoint dependency graphs, and database schema analysis. CLI and VS Code extension.
...
* [angr](https://github.com/angr/angr) ⭐ 9,054 | 🐛 706 | 🌐 Python | 📅 2026-09-01 — Binary code analysis tool that also supports symbolic execution.

* [bloaty](https://github.com/google/bloaty) ⭐ 5,539 | 🐛 70 | 🌐 C++ | 📅 2026-08-28 — Ever wondered what's making your binary big? Bloaty McBloatface will show you a size profile of the binary so you can understand what's taking up space inside. Bloaty performs a deep analysis of the binary. Using custom ELF, DWARF, and Mach-O parsers,  Bloaty aims to accurately attribute every byte of the binary to the symbol or compileunit that produced it.  It will even disassemble the binary looking for references to anonymous data. F
...
* [Manalyze](https://github.com/JusticeRage/Manalyze) ⭐ 1,146 | 🐛 6 | 🌐 YARA | 📅 2026-08-29 — A static analyzer, which checks portable executables for malicious content.
...
* [Nauz File Detector](https://github.com/horsicq/Nauz-File-Detector) ⭐ 582 | 🐛 2 | 🌐 C++ | 📅 2026-08-31 — Static Linker/Compiler/Tool detector for Windows, Linux and MacOS.
...
* [cfn-lint](https://github.com/awslabs/cfn-python-lint) ⭐ 2,640 | 🐛 79 | 🌐 Python | 📅 2026-09-01 — AWS Labs CloudFormation linter.
...
* [Grype](https://github.com/anchore/grype) ⭐ 12,816 | 🐛 404 | 🌐 Go | 📅 2026-08-28 — Vulnerability scanner for container images and filesystems. Developed by Anchore, it scans container images, directories, and archives for known vulnerabilities. Supports multiple image formats, SBOM integration, and VEX (Vulnerability Exploitability eXchange) for accurate vulnerability assessment. Works with various vulnerability databases and provides detailed reporting.
...
* [clair](https://github.com/coreos/clair) ⭐ 11,054 | 🐛 61 | 🌐 Go | 📅 2026-08-31 — Vulnerability Static Analysis for Containers.
...
* [oelint-adv](https://github.com/priv-kweihmann/oelint-adv) ⭐ 86 | 🐛 5 | 🌐 Python | 📅 2026-08-31 — Linter for bitbake recipes used in open-embedded and YOCTO
...
* [kube-linter](https://github.com/stackrox/kube-linter) ⭐ 3,502 | 🐛 94 | 🌐 Go | 📅 2026-08-26 — KubeLinter is a static analysis tool that checks Kubernetes YAML files  and Helm charts to ensure the applications represented in them adhere to best practices.
...
- [KubeLinter](https://github.com/stackrox/kube-linter) ⭐ 3,502 | 🐛 94 | 🌐 Go | 📅 2026-08-26 — KubeLinter is a static analysis tool that checks Kubernetes YAML files and Helm charts to ensure the applications represented in them adhere to best practices.
...
* [markdownlint](https://github.com/DavidAnson/markdownlint) ⭐ 6,316 | 🐛 84 | 🌐 JavaScript | 📅 2026-09-01 — Node.js -based style checker and lint tool for Markdown/CommonMark files.
...
* [statix](https://github.com/nerdypepper/statix) ⭐ 941 | 🐛 46 | 🌐 Rust | 📅 2026-07-26 — Lints and suggestions for the Nix programming language. "statix check" highlights antipatterns in Nix code. "statix fix" can fix several such occurrences.
...
* [Gitleaks](https://github.com/zricethezav/gitleaks) ⭐ 29,052 | 🐛 472 | 🌐 Go | 📅 2026-08-26 — A SAST tool for detecting hardcoded secrets like passwords, api keys, and tokens in git repos.
...
* [slither](https://github.com/trailofbits/slither) ⭐ 6,357 | 🐛 474 | 🌐 Python | 📅 2026-08-26 — Static analysis framework that runs a suite of vulnerability detectors, prints visual information about contract details, and provides an API to easily write custom analyses.
