...
* [ArchUnitNET](https://github.com/TNG/ArchUnitNET) ⭐ 1,350 | 🐛 34 | 🌐 C# | 📅 2026-08-15 — A C# architecture test library to specify and assert architecture rules in C# for automated testing.

* [Meziantou.Analyzer](https://github.com/meziantou/Meziantou.Analyzer) ⭐ 1,174 | 🐛 5 | 🌐 C# | 📅 2026-08-17 — A Roslyn analyzer to enforce some good practices in C# in terms of design, usage, security, performance, and style.

* [SonarAnalyzer.CSharp](https://github.com/SonarSource/sonar-dotnet) ⭐ 918 | 🐛 248 | 🌐 C# | 📅 2026-08-18 — These Roslyn analyzers allow you to produce Clean Code that is safe, reliable, and maintainable by helping you find and correct bugs, vulnerabilities, and code smells in your codebase.
...
* [clj-kondo](https://github.com/borkdude/clj-kondo) ⭐ 1,849 | 🐛 120 | 🌐 Clojure | 📅 2026-08-04 — A linter for Clojure code that sparks joy. It informs you about potential errors while you are typing.
...
* [credo](https://github.com/rrrene/credo) ⭐ 5,209 | 🐛 37 | 🌐 Elixir | 📅 2026-07-26 — A static code analysis tool with a focus on code consistency and teaching.
...
* [Reviewdog](https://github.com/haya14busa/reviewdog) ⭐ 9,532 | 🐛 139 | 🌐 Go | 📅 2026-08-18 — A tool for posting review comments from any linter in any code hosting service.
...
* [google-java-format](https://github.com/google/google-java-format) ⭐ 6,176 | 🐛 175 | 🌐 Java | 📅 2026-08-13 — Reformats Java source code to comply with Google Java Style
...
* [Dataflow Framework](https://github.com/typetools/checker-framework) ⭐ 1,146 | 🐛 436 | 🌐 Java | 📅 2026-08-18 — An industrial-strength dataflow framework for Java. The Dataflow Framework is used in the Checker Framework, Google’s Error Prone, Uber’s NullAway, Meta’s Nullsafe, and in other contexts. It is distributed with the Checker Framework.
...
* [JLiSA](https://github.com/lisa-analyzer/jlisa) ⭐ 32 | 🐛 27 | 🌐 Java | 📅 2026-08-17 — An abstract interpretation-based static analyzer for Java build upon the [LiSA](https://github.com/lisa-analyzer/lisa) ⭐ 83 | 🐛 34 | 🌐 Java | 📅 2026-08-17 framekwork.
...
* [xo](https://github.com/xojs/xo) ⭐ 7,992 | 🐛 3 | 🌐 TypeScript | 📅 2026-07-29 — Opinionated but configurable ESLint wrapper with lots of goodies included. Enforces strict and readable code.
...
* [JET](https://github.com/aviatesk/JET.jl) ⭐ 879 | 🐛 85 | 🌐 Julia | 📅 2026-08-08 — Static type inference system to detect bugs and type instabilities.
...
* [EasyCodingStandard](https://www.tomasvotruba.com/blog/2017/05/03/combine-power-of-php-code-sniffer-and-php-cs-fixer-in-3-lines) — Combine [PHP\_CodeSniffer](https://github.com/squizlabs/PHP_CodeSniffer) ⭐ 10,775 | 🐛 248 | 🌐 PHP | 📅 2024-04-01 and [PHP-CS-Fixer](https://github.com/FriendsOfPHP/PHP-CS-Fixer) ⭐ 13,545 | 🐛 89 | 🌐 PHP | 📅 2026-08-17.

* [larastan](https://github.com/larastan/larastan) ⭐ 6,490 | 🐛 144 | 🌐 PHP | 📅 2026-08-11 — Adds static analysis to Laravel improving developer productivity and code quality. It is a wrapper around PHPStan.
...
* [pyright](https://github.com/Microsoft/pyright) ⭐ 15,589 | 🐛 327 | 🌐 Python | 📅 2026-08-17 — Static type checker for Python, created to address gaps in existing tools like mypy.
...
* [flake8](https://github.com/PyCQA/flake8) ⭐ 3,814 | 🐛 23 | 🌐 Python | 📅 2026-08-17 — A wrapper around `pyflakes`, `pycodestyle` and `mccabe`.
...
* [lintr](https://github.com/jimhester/lintr) ⭐ 1,291 | 🐛 302 | 🌐 R | 📅 2026-08-17 — Static Code Analysis for R.
...
* [Regal](https://github.com/styrainc/regal) ⭐ 398 | 🐛 137 | 🌐 Go | 📅 2026-08-17 — Regal is a linter for the policy language Rego. Regal aims to catch bugs and mistakes in policy code, while at the same time helping people learn the language, best practices and idiomatic constructs.
...
* [bundler-audit](https://github.com/rubysec/bundler-audit) ⭐ 2,758 | 🐛 48 | 🌐 Ruby | 📅 2026-08-15 — Audit Gemfile.lock for gems with security vulnerabilities reported in [Ruby Advisory Database](https://github.com/rubysec/ruby-advisory-db) ⭐ 1,070 | 🐛 10 | 🌐 Ruby | 📅 2026-08-16.
...
* [Steep](https://github.com/soutaro/steep) ⭐ 1,488 | 🐛 230 | 🌐 Ruby | 📅 2026-08-18 — Gradual Typing for Ruby.

* [DatabaseConsistency](https://github.com/djezzzl/database_consistency) ⭐ 1,191 | 🐛 5 | 🌐 Ruby | 📅 2026-08-17 — The tool to avoid various issues due to inconsistencies and inefficiencies between a database schema and application models.
...
* [kani](https://github.com/model-checking/kani) ⭐ 3,327 | 🐛 488 | 🌐 Rust | 📅 2026-08-17 — The Kani Rust Verifier is a bit-precise model checker for Rust.
...
* [cargo-expand](https://github.com/dtolnay/cargo-expand) ⭐ 3,122 | 🐛 10 | 🌐 Rust | 📅 2026-07-18 — Cargo subcommand to show result of macro expansion  and #\[derive] expansion applied to the current crate.  This is a wrapper around a more verbose compiler command.
...
* [cargo-audit](https://rustsec.org) — Audit Cargo.lock for crates with security vulnerabilities reported to the [RustSec Advisory Database](https://github.com/RustSec/advisory-db/) ⭐ 1,152 | 🐛 138 | 📅 2026-08-18.

* [cargo-show-asm](https://github.com/pacak/cargo-show-asm) ⭐ 972 | 🐛 26 | 🌐 Rust | 📅 2026-08-10 — cargo subcommand showing the assembly, LLVM-IR and MIR generated for Rust code
...
* [rustfmt](https://github.com/rust-lang/rustfmt) ⭐ 6,936 | 🐛 921 | 🌐 Rust | 📅 2026-08-17 — A tool for formatting Rust code according to style guidelines.
...
* [SwiftFormat](https://github.com/nicklockwood/SwiftFormat) ⭐ 8,915 | 🐛 299 | 🌐 Swift | 📅 2026-08-17 — A library and command-line formatting tool for reformatting Swift code.
...
* [TypeScript ESLint](https://github.com/typescript-eslint/typescript-eslint) ⭐ 16,356 | 🐛 283 | 🌐 TypeScript | 📅 2026-08-17 — TypeScript language extension for eslint.
...
* [vscode-verilog-hdl-support](https://github.com/mshr-h/vscode-verilog-hdl-support) ⭐ 383 | 🐛 68 | 🌐 TypeScript | 📅 2026-08-17 — Verilog HDL/SystemVerilog/Bluespec SystemVerilog support for VS Code. Provides syntax highlighting and Linting support from Icarus Verilog, Vivado Logical Simulation, Modelsim and Verilator
...
* [trivy](https://github.com/aquasecurity/trivy) ⭐ 37,468 | 🐛 248 | 🌐 Go | 📅 2026-08-17 — A Simple and Comprehensive Vulnerability Scanner for Containers and other Artifacts, Suitable for CI. Trivy detects vulnerabilities of OS packages (Alpine, RHEL, CentOS, etc.) and application dependencies (Bundler, Composer, npm, yarn, etc.). Checks containers and filesystems.

* [ESLint](https://github.com/eslint/eslint) ⭐ 27,455 | 🐛 129 | 🌐 JavaScript | 📅 2026-08-17 — An extensible linter for JS, following the ECMAScript standard.

* [oxc](https://github.com/web-infra-dev/oxc) ⭐ 22,349 | 🐛 761 | 🌐 Rust | 📅 2026-08-18 — The Oxidation Compiler is creating a suite of high-performance tools for the JavaScript / TypeScript language re-written in Rust.

* [ale](https://github.com/w0rp/ale) ⭐ 14,015 | 🐛 596 | 🌐 Vim Script | 📅 2026-08-09 — Asynchronous Lint Engine for Vim and NeoVim with support for many languages.

* [codeql](https://github.com/github/codeql) ⭐ 9,962 | 🐛 1,448 | 🌐 CodeQL | 📅 2026-08-18 — Deep code analysis - semantic queries and dataflow for several languages with VSCode plugin support.
...
* [ApplicationInspector](https://github.com/microsoft/ApplicationInspector) ⭐ 4,397 | 🐛 31 | 🌐 C# | 📅 2026-08-17 — Creates reports of over 400 rule patterns for feature detection (e.g. the use of cryptography or version control in apps).

* [ClassGraph](https://github.com/classgraph/classgraph) ⭐ 3,005 | 🐛 0 | 🌐 Java | 📅 2026-08-18 — A classpath and module path scanner for querying or visualizing class metadata or class relatedness.

* [Bearer](https://github.com/bearer/bearer) ⭐ 2,727 | 🐛 19 | 🌐 Go | 📅 2026-08-17 — Open-Source static code analysis tool to discover,  filter and prioritize security risks and vulnerabilities  leading to sensitive data exposures (PII, PHI, PD).  Highly configurable and easily extensible,  built for security and engineering teams.
...
* [lizard](https://github.com/terryyin/lizard) ⭐ 2,451 | 🐛 25 | 🌐 Python | 📅 2026-08-18 — Lizard is an extensible Cyclomatic Complexity Analyzer for many programming languages  including C/C++ (doesn't require all the header files or Java imports).  It also does copy-paste detection (code clone detection/code duplicate detection) and many other forms of static code analysis. Counts lines of code without comments, CCN (cyclomatic complexity number), token count of functions, parameter count of functions.
...
* [Putout](https://github.com/coderaiser/putout) ⭐ 796 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-17 — Pluggable and configurable code transformer with built-in eslint, babel plugins support for js, jsx typescript, flow, markdown, yaml and json.

* [Skylos](https://github.com/duriantaco/skylos) ⭐ 539 | 🐛 10 | 🌐 Python | 📅 2026-08-16 — Dead code detection, security scanning, secrets detection, and code quality analysis for Python, TypeScript, and Go. Framework-aware analysis with 98% recall. Includes CI/CD GitHub Action, VS Code extension, and MCP server for AI agent integration.
...
* [relint](https://github.com/codingjoe/relint) ⭐ 66 | 🐛 1 | 🌐 Python | 📅 2026-08-17 — A static file linter that allows you to write custom rules using regular expressions (RegEx).
...
* [angr](https://github.com/angr/angr) ⭐ 9,019 | 🐛 728 | 🌐 Python | 📅 2026-08-18 — Binary code analysis tool that also supports symbolic execution.
...
* [cfn-lint](https://github.com/awslabs/cfn-python-lint) ⭐ 2,639 | 🐛 76 | 🌐 Python | 📅 2026-08-18 — AWS Labs CloudFormation linter.

* [AWS CloudFormation Guard](https://github.com/aws-cloudformation/cloudformation-guard) ⭐ 1,385 | 🐛 55 | 🌐 Rust | 📅 2026-08-17 — Check local CloudFormation templates against policy-as-code rules  and generate rules from existing templates.
...
* [Grype](https://github.com/anchore/grype) ⭐ 12,755 | 🐛 404 | 🌐 Go | 📅 2026-08-14 — Vulnerability scanner for container images and filesystems. Developed by Anchore, it scans container images, directories, and archives for known vulnerabilities. Supports multiple image formats, SBOM integration, and VEX (Vulnerability Exploitability eXchange) for accurate vulnerability assessment. Works with various vulnerability databases and provides detailed reporting.

* [Haskell Dockerfile Linter](https://github.com/lukasmartinelli/hadolint) ⭐ 12,360 | 🐛 203 | 🌐 Haskell | 📅 2026-08-17 — A smarter Dockerfile linter that helps you build best practice Docker images.

* [clair](https://github.com/coreos/clair) ⭐ 11,049 | 🐛 59 | 🌐 Go | 📅 2026-08-11 — Vulnerability Static Analysis for Containers.

* [Dockle](https://github.com/goodwithtech/dockle) ⭐ 3,288 | 🐛 53 | 🌐 Go | 📅 2026-08-10 — Container Image Linter for Security helping build the Best-Practice Docker Image. Scans Docker images for security vulnerabilities and CIS Benchmark compliance. Checks for secrets, credential exposure, and security best practices. Provides multiple severity levels (FATAL, WARN, INFO) and supports various output formats for CI/CD integration.
...
* [oelint-adv](https://github.com/priv-kweihmann/oelint-adv) ⭐ 86 | 🐛 5 | 🌐 Python | 📅 2026-08-17 — Linter for bitbake recipes used in open-embedded and YOCTO
...
* [kubeconform](https://github.com/yannh/kubeconform) ⭐ 3,149 | 🐛 88 | 🌐 Go | 📅 2026-06-13 — A fast Kubernetes manifests validator with support for custom resources.
...
* [markdownlint](https://github.com/DavidAnson/markdownlint) ⭐ 6,283 | 🐛 81 | 🌐 JavaScript | 📅 2026-08-18 — Node.js -based style checker and lint tool for Markdown/CommonMark files.
...
* [lockfile-lint](https://github.com/lirantal/lockfile-lint) ⭐ 865 | 🐛 6 | 🌐 JavaScript | 📅 2026-08-13 — Lint an npm or yarn lockfile to analyze and detect security issues
...
* [rpmlint](https://github.com/rpm-software-management/rpmlint) ⭐ 162 | 🐛 92 | 🌐 Python | 📅 2026-08-17 — Tool for checking common errors in rpm packages.
...
* [Gitleaks](https://github.com/zricethezav/gitleaks) ⭐ 28,792 | 🐛 466 | 🌐 Go | 📅 2026-07-29 — A SAST tool for detecting hardcoded secrets like passwords, api keys, and tokens in git repos.
...
* [scorecard](https://github.com/ossf/scorecard) ⭐ 5,642 | 🐛 444 | 🌐 Go | 📅 2026-08-17 — Security Scorecards - Security health metrics for Open Source
...
* [slither](https://github.com/trailofbits/slither) ⭐ 6,346 | 🐛 472 | 🌐 Python | 📅 2026-08-12 — Static analysis framework that runs a suite of vulnerability detectors, prints visual information about contract details, and provides an API to easily write custom analyses.
...
* [proselint](https://github.com/amperser/proselint) ⭐ 4,564 | 🐛 236 | 🌐 JavaScript | 📅 2026-08-14 — A linter for English prose with a focus on writing style instead of grammar.

* [codespell](https://github.com/codespell-project/codespell) ⭐ 2,415 | 🐛 261 | 🌐 Python | 📅 2026-08-18 — Check code for common misspellings.
