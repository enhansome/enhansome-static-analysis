...
[![CI](https://github.com/analysis-tools-dev/static-analysis/workflows/CI/badge.svg)](https://github.com/analysis-tools-dev/static-analysis/actions/workflows/ci.yml) ⭐ 14,775 | 🐛 11 | 🌐 Rust | 📅 2026-09-09
[![Links](https://github.com/analysis-tools-dev/static-analysis/actions/workflows/links.yml/badge.svg)](https://github.com/analysis-tools-dev/static-analysis/actions/workflows/links.yml) ⭐ 14,775 | 🐛 11 | 🌐 Rust | 📅 2026-09-09
...
* [Roslynator](https://github.com/JosefPihrt/Roslynator) ⭐ 3,478 | 🐛 212 | 🌐 C# | 📅 2026-09-02 — A collection of 190+ analyzers and 190+ refactorings for C#, powered by Roslyn.

* [ArchUnitNET](https://github.com/TNG/ArchUnitNET) ⭐ 1,357 | 🐛 34 | 🌐 C# | 📅 2026-09-10 — A C# architecture test library to specify and assert architecture rules in C# for automated testing.

* [Meziantou.Analyzer](https://github.com/meziantou/Meziantou.Analyzer) ⭐ 1,190 | 🐛 2 | 🌐 C# | 📅 2026-09-10 — A Roslyn analyzer to enforce some good practices in C# in terms of design, usage, security, performance, and style.

* [SonarAnalyzer.CSharp](https://github.com/SonarSource/sonar-dotnet) ⭐ 918 | 🐛 250 | 🌐 C# | 📅 2026-09-10 — These Roslyn analyzers allow you to produce Clean Code that is safe, reliable, and maintainable by helping you find and correct bugs, vulnerabilities, and code smells in your codebase.
...
* [clj-kondo](https://github.com/borkdude/clj-kondo) ⭐ 1,852 | 🐛 156 | 🌐 Clojure | 📅 2026-09-10 — A linter for Clojure code that sparks joy. It informs you about potential errors while you are typing.
...
* [SonarDelphi](https://github.com/integrated-application-development/sonar-delphi) ⭐ 158 | 🐛 41 | 🌐 Java | 📅 2026-09-09 — Delphi static analyzer for the SonarQube code quality platform.

* [DelphiLint](https://github.com/integrated-application-development/delphilint) ⭐ 146 | 🐛 20 | 🌐 Pascal | 📅 2026-01-27 — A Delphi IDE package providing on-the-fly code analysis and linting, powered by SonarDelphi.
...
* [D-scanner](https://github.com/dlang-community/D-Scanner) ⭐ 256 | 🐛 131 | 🌐 D | 📅 2026-02-18 — D-Scanner is a tool for analyzing D source code.
...
* [Reviewdog](https://github.com/haya14busa/reviewdog) ⭐ 9,577 | 🐛 142 | 🌐 Go | 📅 2026-09-10 — A tool for posting review comments from any linter in any code hosting service.
...
* [go-critic](https://github.com/go-critic/go-critic) ⭐ 2,068 | 🐛 152 | 🌐 Go | 📅 2026-09-07 — Go source code linter that maintains checks which are currently not implemented in other linters.

* [gocyclo](https://github.com/fzipp/gocyclo) ⭐ 1,608 | 🐛 11 | 🌐 Go | 📅 2025-12-27 — Calculate cyclomatic complexities of functions in Go source code.
...
* [google-java-format](https://github.com/google/google-java-format) ⭐ 6,187 | 🐛 178 | 🌐 Java | 📅 2026-09-10 — Reformats Java source code to comply with Google Java Style

* [NullAway](https://github.com/uber/NullAway) ⭐ 4,104 | 🐛 162 | 🌐 Java | 📅 2026-09-09 — Type-based null-pointer checker with low build-time overhead; an [Error Prone](http://errorprone.info/) plugin.

* [Dataflow Framework](https://github.com/typetools/checker-framework) ⭐ 1,149 | 🐛 452 | 🌐 Java | 📅 2026-09-10 — An industrial-strength dataflow framework for Java. The Dataflow Framework is used in the Checker Framework, Google’s Error Prone, Uber’s NullAway, Meta’s Nullsafe, and in other contexts. It is distributed with the Checker Framework.

* [RefactorFirst](https://github.com/jimbethancourt/RefactorFirst) ⭐ 543 | 🐛 57 | 🌐 Java | 📅 2026-09-10 — Identifies and prioritizes God Classes and Highly Coupled classes in Java codebases you should refactor first.
...
* [JLiSA](https://github.com/lisa-analyzer/jlisa) ⭐ 32 | 🐛 23 | 🌐 Java | 📅 2026-09-09 — An abstract interpretation-based static analyzer for Java build upon the [LiSA](https://github.com/lisa-analyzer/lisa) ⭐ 85 | 🐛 34 | 🌐 Java | 📅 2026-09-09 framekwork.
...
* **jshint** [:information\_source:](https://github.com/analysis-tools-dev/static-analysis/issues/223) ⭐ 14,775 | 🐛 11 | 🌐 Rust | 📅 2026-09-09 :warning: — Detect errors and potential problems in JavaScript code and enforce your team's coding conventions.

* [xo](https://github.com/xojs/xo) ⭐ 7,989 | 🐛 3 | 🌐 TypeScript | 📅 2026-07-29 — Opinionated but configurable ESLint wrapper with lots of goodies included. Enforces strict and readable code.

* [JSLint](https://github.com/douglascrockford/JSLint) ⭐ 3,654 | 🐛 3 | 🌐 JavaScript | 📅 2026-09-04 [:information\_source:](https://github.com/analysis-tools-dev/static-analysis/issues/223) ⭐ 14,775 | 🐛 11 | 🌐 Rust | 📅 2026-09-09 — The JavaScript Code Quality Tool.
...
* [PHP-Parser](https://github.com/nikic/PHP-Parser) ⭐ 17,467 | 🐛 70 | 🌐 PHP | 📅 2026-09-05 — A PHP parser written in PHP.

* [EasyCodingStandard](https://www.tomasvotruba.com/blog/2017/05/03/combine-power-of-php-code-sniffer-and-php-cs-fixer-in-3-lines) — Combine [PHP\_CodeSniffer](https://github.com/squizlabs/PHP_CodeSniffer) ⭐ 10,777 | 🐛 248 | 🌐 PHP | 📅 2024-04-01 and [PHP-CS-Fixer](https://github.com/FriendsOfPHP/PHP-CS-Fixer) ⭐ 13,550 | 🐛 87 | 🌐 PHP | 📅 2026-09-08.

* [larastan](https://github.com/larastan/larastan) ⭐ 6,499 | 🐛 107 | 🌐 PHP | 📅 2026-09-10 — Adds static analysis to Laravel improving developer productivity and code quality. It is a wrapper around PHPStan.
...
* [phpqa - jakzal](https://github.com/jakzal/phpqa) ⭐ 1,322 | 🐛 1 | 🌐 Dockerfile | 📅 2026-09-07 — Many tools for PHP static analysis in one container.
...
* [PHPArkitect](https://github.com/phparkitect/arkitect) ⭐ 928 | 🐛 38 | 🌐 PHP | 📅 2026-09-06 — PHPArkitect helps you to keep your PHP codebase coherent and solid, by permitting to add some architectural constraint check to your workflow. You can express the constraint that you want to enforce, in simple and readable PHP code.
...
* [pyright](https://github.com/Microsoft/pyright) ⭐ 15,631 | 🐛 343 | 🌐 Python | 📅 2026-09-09 — Static type checker for Python, created to address gaps in existing tools like mypy.
...
* [vulture](https://github.com/jendrikseipp/vulture) ⭐ 4,806 | 🐛 71 | 🌐 Python | 📅 2026-04-30 — Find unused classes, functions and variables in Python code.
...
* [prospector](https://github.com/PyCQA/prospector) ⭐ 2,085 | 🐛 32 | 🌐 Python | 📅 2026-09-08 — A wrapper around `pylint`, `pep8`, `mccabe` and others.

* **xenon** :warning: — Monitor code complexity using [`radon`](https://github.com/rubik/radon) ⭐ 2,018 | 🐛 52 | 🌐 Python | 📅 2024-10-20.

* [pip-audit](https://github.com/pypa/pip-audit) ⭐ 1,361 | 🐛 62 | 🌐 Python | 📅 2026-09-09 — Tool for scanning Python packages for known vulnerabilities. Developed by the Python Packaging Authority (PyPA) and supported by Trail of Bits and Google. Scans Python environments and requirements files to identify vulnerable packages and suggests remediation. Supports GitHub Actions, pre-commit hooks, and multiple vulnerability service integrations.
...
* [pyroma](https://github.com/regebro/pyroma) ⭐ 235 | 🐛 1 | 🌐 Python | 📅 2026-06-14 — Rate how well a Python project complies with the best practices of the Python packaging ecosystem, and list issues that could be improved.
...
* [Regal](https://github.com/styrainc/regal) ⭐ 404 | 🐛 144 | 🌐 Go | 📅 2026-09-09 — Regal is a linter for the policy language Rego. Regal aims to catch bugs and mistakes in policy code, while at the same time helping people learn the language, best practices and idiomatic constructs.
...
* [bundler-audit](https://github.com/rubysec/bundler-audit) ⭐ 2,757 | 🐛 48 | 🌐 Ruby | 📅 2026-09-04 — Audit Gemfile.lock for gems with security vulnerabilities reported in [Ruby Advisory Database](https://github.com/rubysec/ruby-advisory-db) ⭐ 1,071 | 🐛 3 | 🌐 Ruby | 📅 2026-09-08.
...
* [Steep](https://github.com/soutaro/steep) ⭐ 1,489 | 🐛 224 | 🌐 Ruby | 📅 2026-09-09 — Gradual Typing for Ruby.
...
* [kani](https://github.com/model-checking/kani) ⭐ 3,400 | 🐛 486 | 🌐 Rust | 📅 2026-09-07 — The Kani Rust Verifier is a bit-precise model checker for Rust.
...
* [cargo-expand](https://github.com/dtolnay/cargo-expand) ⭐ 3,127 | 🐛 10 | 🌐 Rust | 📅 2026-09-10 — Cargo subcommand to show result of macro expansion  and #\[derive] expansion applied to the current crate.  This is a wrapper around a more verbose compiler command.

* [cargo udeps](https://github.com/est31/cargo-udeps) ⭐ 2,132 | 🐛 44 | 🌐 Rust | 📅 2026-04-29 — Find unused dependencies in Cargo.toml. It either prints out a "unused crates" line listing the crates,  or it prints out a line saying that no crates were unused.
...
* [cargo-audit](https://rustsec.org) — Audit Cargo.lock for crates with security vulnerabilities reported to the [RustSec Advisory Database](https://github.com/RustSec/advisory-db/) ⭐ 1,173 | 🐛 144 | 📅 2026-09-09.

* [cargo-show-asm](https://github.com/pacak/cargo-show-asm) ⭐ 978 | 🐛 27 | 🌐 Rust | 📅 2026-09-09 — cargo subcommand showing the assembly, LLVM-IR and MIR generated for Rust code
...
* [rustfmt](https://github.com/rust-lang/rustfmt) ⭐ 6,960 | 🐛 937 | 🌐 Rust | 📅 2026-09-10 — A tool for formatting Rust code according to style guidelines.
...
* [rust-audit](https://github.com/Shnatsel/rust-audit) ⭐ 850 | 🐛 17 | 🌐 Rust | 📅 2026-09-02 — Audit Rust binaries for known bugs or security vulnerabilities. This works by embedding data about the dependency tree (Cargo.lock) in JSON format into a dedicated linker section of the compiled executable.
...
* [scythe](https://github.com/Goldziher/scythe) ⭐ 67 | 🐛 2 | 🌐 Rust | 📅 2026-09-10 — Polyglot SQL compiler and linter that generates type-safe code from SQL with schema-aware linting.
...
* [TypeScript ESLint](https://github.com/typescript-eslint/typescript-eslint) ⭐ 16,389 | 🐛 275 | 🌐 TypeScript | 📅 2026-09-09 — TypeScript language extension for eslint.
...
* [Angular ESLint](https://github.com/angular-eslint/angular-eslint#readme) ⭐ 1,783 | 🐛 15 | 🌐 TypeScript | 📅 2026-09-10 — Linter for Angular projects
...
* [wasm-language-tools](https://github.com/g-plane/wasm-language-tools) ⭐ 94 | 🐛 1 | 🌐 Rust | 📅 2026-09-10 — WebAssembly Language Tools aims to provide and improve the editing experience of WebAssembly Text Format. It also provides an out-of-the-box formatter (a.k.a. pretty printer) for WebAssembly Text Format.

## Multiple languages

* [trivy](https://github.com/aquasecurity/trivy) ⭐ 37,857 | 🐛 270 | 🌐 Go | 📅 2026-09-10 — A Simple and Comprehensive Vulnerability Scanner for Containers and other Artifacts, Suitable for CI. Trivy detects vulnerabilities of OS packages (Alpine, RHEL, CentOS, etc.) and application dependencies (Bundler, Composer, npm, yarn, etc.). Checks containers and filesystems.

* [ESLint](https://github.com/eslint/eslint) ⭐ 27,496 | 🐛 124 | 🌐 JavaScript | 📅 2026-09-10 — An extensible linter for JS, following the ECMAScript standard.

* [oxc](https://github.com/web-infra-dev/oxc) ⭐ 22,701 | 🐛 847 | 🌐 Rust | 📅 2026-09-10 — The Oxidation Compiler is creating a suite of high-performance tools for the JavaScript / TypeScript language re-written in Rust.
...
* [codeql](https://github.com/github/codeql) ⭐ 10,075 | 🐛 1,459 | 🌐 CodeQL | 📅 2026-09-10 — Deep code analysis - semantic queries and dataflow for several languages with VSCode plugin support.
...
* [ApplicationInspector](https://github.com/microsoft/ApplicationInspector) ⭐ 4,395 | 🐛 28 | 🌐 C# | 📅 2026-09-10 — Creates reports of over 400 rule patterns for feature detection (e.g. the use of cryptography or version control in apps).

* [sem](https://github.com/Ataraxy-Labs/sem) ⭐ 3,338 | 🐛 6 | 🌐 Rust | 📅 2026-09-09 — Semantic version control CLI that provides entity-level diffs, blame, and impact analysis on top of git. Uses tree-sitter to parse 26 languages and builds a cross-file dependency graph with structural hashing. Commands include sem diff, sem blame, sem graph, and sem impact for blast-radius analysis of code changes.
...
* [Bearer](https://github.com/bearer/bearer) ⭐ 2,744 | 🐛 22 | 🌐 Go | 📅 2026-09-08 — Open-Source static code analysis tool to discover,  filter and prioritize security risks and vulnerabilities  leading to sensitive data exposures (PII, PHI, PD).  Highly configurable and easily extensible,  built for security and engineering teams.
...
* [lizard](https://github.com/terryyin/lizard) ⭐ 2,497 | 🐛 25 | 🌐 Python | 📅 2026-09-09 — Lizard is an extensible Cyclomatic Complexity Analyzer for many programming languages  including C/C++ (doesn't require all the header files or Java imports).  It also does copy-paste detection (code clone detection/code duplicate detection) and many other forms of static code analysis. Counts lines of code without comments, CCN (cyclomatic complexity number), token count of functions, parameter count of functions.
...
* [DevSkim](https://github.com/microsoft/devskim) ⭐ 1,005 | 🐛 76 | 🌐 C# | 📅 2026-09-10 — Regex-based static analysis tool for Visual Studio, VS Code, and Sublime Text - C/C++, C#, PHP, ASP, Python, Ruby, Java, and others.

* [WALA](https://github.com/wala/WALA) ⭐ 868 | 🐛 151 | 🌐 Java | 📅 2026-09-10 — Static analysis capabilities for Java bytecode and related languages and for JavaScript.
...
* [Rev-dep](https://github.com/jayu/rev-dep) ⭐ 256 | 🐛 2 | 🌐 Go | 📅 2026-08-07 — Dependency analysis and optimization toolkit for modern JavaScript and TypeScript projects. Trace imports, identify circular dependencies, find unused code, clean node modules.
...
* [BlockWatch](https://github.com/mennanov/blockwatch) ⭐ 29 | 🐛 4 | 🌐 Rust | 📅 2026-09-10 — A language-agnostic linter that keeps code, documentation, and configuration in sync and enforces strict formatting and validation rules.
...
* [packj](https://github.com/ossillate-inc/packj) ⭐ 692 | 🐛 13 | 🌐 Python | 📅 2026-09-09 — Packj (pronounced package) is a command line (CLI) tool to vet open-source software packages for "risky" attributes that make them vulnerable to supply chain attacks. This is the tool behind our large-scale security analysis platform Packj.dev that continuously vets packages and provides free reports.
...
* [angr](https://github.com/angr/angr) ⭐ 9,079 | 🐛 733 | 🌐 Python | 📅 2026-09-10 — Binary code analysis tool that also supports symbolic execution.

* [bloaty](https://github.com/google/bloaty) ⭐ 5,541 | 🐛 73 | 🌐 C++ | 📅 2026-09-09 — Ever wondered what's making your binary big? Bloaty McBloatface will show you a size profile of the binary so you can understand what's taking up space inside. Bloaty performs a deep analysis of the binary. Using custom ELF, DWARF, and Mach-O parsers,  Bloaty aims to accurately attribute every byte of the binary to the symbol or compileunit that produced it.  It will even disassemble the binary looking for references to anonymous data. F

* [Twiggy](https://github.com/rustwasm/twiggy) ⚠️ Archived — Analyzes a binary's call graph to profile code size. The goal is to slim down wasm binary size.

* [cwe\_checker](https://github.com/fkie-cad/cwe_checker) ⭐ 1,356 | 🐛 29 | 🌐 Rust | 📅 2026-08-20 — cwe\_checker finds vulnerable patterns in binary executables.
...
* [checkmake](https://github.com/mrtazz/checkmake) ⭐ 1,214 | 🐛 41 | 🌐 Go | 📅 2026-09-09 — Linter / Analyzer for Makefiles.
...
* [cfn-lint](https://github.com/awslabs/cfn-python-lint) ⭐ 2,638 | 🐛 86 | 🌐 Python | 📅 2026-09-10 — AWS Labs CloudFormation linter.

* [AWS CloudFormation Guard](https://github.com/aws-cloudformation/cloudformation-guard) ⭐ 1,387 | 🐛 47 | 🌐 Rust | 📅 2026-09-08 — Check local CloudFormation templates against policy-as-code rules  and generate rules from existing templates.
...
* [Grype](https://github.com/anchore/grype) ⭐ 12,869 | 🐛 404 | 🌐 Go | 📅 2026-09-09 — Vulnerability scanner for container images and filesystems. Developed by Anchore, it scans container images, directories, and archives for known vulnerabilities. Supports multiple image formats, SBOM integration, and VEX (Vulnerability Exploitability eXchange) for accurate vulnerability assessment. Works with various vulnerability databases and provides detailed reporting.

* [Haskell Dockerfile Linter](https://github.com/lukasmartinelli/hadolint) ⭐ 12,397 | 🐛 206 | 🌐 Haskell | 📅 2026-08-24 — A smarter Dockerfile linter that helps you build best practice Docker images.

* [clair](https://github.com/coreos/clair) ⭐ 11,058 | 🐛 52 | 🌐 Go | 📅 2026-09-09 — Vulnerability Static Analysis for Containers.
...
* [krane](https://github.com/appvia/krane) ⭐ 745 | 🐛 36 | 🌐 Ruby | 📅 2026-09-10 — Krane is a simple Kubernetes RBAC static analysis tool.
...
* [kube-linter](https://github.com/stackrox/kube-linter) ⭐ 3,503 | 🐛 95 | 🌐 Go | 📅 2026-09-09 — KubeLinter is a static analysis tool that checks Kubernetes YAML files  and Helm charts to ensure the applications represented in them adhere to best practices.

* [kubeconform](https://github.com/yannh/kubeconform) ⭐ 3,186 | 🐛 89 | 🌐 Go | 📅 2026-06-13 — A fast Kubernetes manifests validator with support for custom resources.
...
- [KubeLinter](https://github.com/stackrox/kube-linter) ⭐ 3,503 | 🐛 95 | 🌐 Go | 📅 2026-09-09 — KubeLinter is a static analysis tool that checks Kubernetes YAML files and Helm charts to ensure the applications represented in them adhere to best practices.
...
* [markdownlint](https://github.com/DavidAnson/markdownlint) ⭐ 6,335 | 🐛 82 | 🌐 JavaScript | 📅 2026-09-10 — Node.js -based style checker and lint tool for Markdown/CommonMark files.
...
* [FlowDroid](https://github.com/secure-software-engineering/FlowDroid) ⭐ 1,264 | 🐛 244 | 🌐 Java | 📅 2026-09-08 — Static taint analysis tool for Android applications.
...
* [deadnix](https://github.com/astro/deadnix) ⭐ 781 | 🐛 7 | 🌐 Rust | 📅 2026-09-05 — Scan Nix files for dead code (unused variable bindings)
...
* [protolint](https://github.com/yoheimuta/protolint) ⭐ 698 | 🐛 63 | 🌐 Go | 📅 2026-08-14 — Pluggable linter and fixer to enforce Protocol Buffer style and conventions.
...
* [Gitleaks](https://github.com/zricethezav/gitleaks) ⭐ 29,206 | 🐛 473 | 🌐 Go | 📅 2026-09-09 — A SAST tool for detecting hardcoded secrets like passwords, api keys, and tokens in git repos.
...
* [slither](https://github.com/trailofbits/slither) ⭐ 6,361 | 🐛 478 | 🌐 Python | 📅 2026-09-09 — Static analysis framework that runs a suite of vulnerability detectors, prints visual information about contract details, and provides an API to easily write custom analyses.
...
* [proselint](https://github.com/amperser/proselint) ⭐ 4,575 | 🐛 236 | 🌐 JavaScript | 📅 2026-09-04 — A linter for English prose with a focus on writing style instead of grammar.

* [codespell](https://github.com/codespell-project/codespell) ⭐ 2,423 | 🐛 275 | 🌐 Python | 📅 2026-09-08 — Check code for common misspellings.
