...
[![Links](https://github.com/analysis-tools-dev/static-analysis/actions/workflows/links.yml/badge.svg)](https://github.com/analysis-tools-dev/static-analysis/actions/workflows/links.yml) ⭐ 14,738 | 🐛 26 | 🌐 Rust | 📅 2026-06-10
...
* [Roslynator](https://github.com/JosefPihrt/Roslynator) ⭐ 3,474 | 🐛 207 | 🌐 C# | 📅 2026-08-16 — A collection of 190+ analyzers and 190+ refactorings for C#, powered by Roslyn.
...
* [dialyxir](https://github.com/jeremyjh/dialyxir) ⭐ 1,795 | 🐛 78 | 🌐 Elixir | 📅 2026-06-12 — Mix tasks to simplify use of Dialyzer in Elixir projects.
...
* [FSharpLint](https://github.com/fsprojects/FSharpLint) ⭐ 328 | 🐛 98 | 🌐 F# | 📅 2026-08-10 — Lint tool for F#.
...
* [Reviewdog](https://github.com/haya14busa/reviewdog) ⭐ 9,527 | 🐛 139 | 🌐 Go | 📅 2026-08-15 — A tool for posting review comments from any linter in any code hosting service.

* [gofumpt](https://github.com/mvdan/gofumpt) ⭐ 4,062 | 🐛 15 | 🌐 Go | 📅 2026-07-27 — Enforce a stricter format than `gofmt`, while being backwards-compatible.  That is, `gofumpt` is happy with a subset of the formats that `gofmt` is happy with.
...
* [wsl](https://github.com/bombsimon/wsl) ⭐ 359 | 🐛 5 | 🌐 Go | 📅 2026-08-17 — Enforces empty lines at the right places.
...
* [google-java-format](https://github.com/google/google-java-format) ⭐ 6,175 | 🐛 175 | 🌐 Java | 📅 2026-08-13 — Reformats Java source code to comply with Google Java Style

* [NullAway](https://github.com/uber/NullAway) ⭐ 4,090 | 🐛 146 | 🌐 Java | 📅 2026-08-16 — Type-based null-pointer checker with low build-time overhead; an [Error Prone](http://errorprone.info/) plugin.

* [Dataflow Framework](https://github.com/typetools/checker-framework) ⭐ 1,146 | 🐛 449 | 🌐 Java | 📅 2026-08-17 — An industrial-strength dataflow framework for Java. The Dataflow Framework is used in the Checker Framework, Google’s Error Prone, Uber’s NullAway, Meta’s Nullsafe, and in other contexts. It is distributed with the Checker Framework.
...
* [jshint](https://jshint.com/about) [:information\_source:](https://github.com/analysis-tools-dev/static-analysis/issues/223) ⭐ 14,738 | 🐛 26 | 🌐 Rust | 📅 2026-06-10 — Detect errors and potential problems in JavaScript code and enforce your team's coding conventions.
...
* [JSLint](https://github.com/douglascrockford/JSLint) ⭐ 3,658 | 🐛 3 | 🌐 JavaScript | 📅 2026-08-02 [:information\_source:](https://github.com/analysis-tools-dev/static-analysis/issues/223) ⭐ 14,738 | 🐛 26 | 🌐 Rust | 📅 2026-06-10 — The JavaScript Code Quality Tool.
...
* [PHP-Parser](https://github.com/nikic/PHP-Parser) ⭐ 17,453 | 🐛 72 | 🌐 PHP | 📅 2026-07-11 — A PHP parser written in PHP.

* [EasyCodingStandard](https://www.tomasvotruba.com/blog/2017/05/03/combine-power-of-php-code-sniffer-and-php-cs-fixer-in-3-lines) — Combine [PHP\_CodeSniffer](https://github.com/squizlabs/PHP_CodeSniffer) ⭐ 10,774 | 🐛 248 | 🌐 PHP | 📅 2024-04-01 and [PHP-CS-Fixer](https://github.com/FriendsOfPHP/PHP-CS-Fixer) ⭐ 13,546 | 🐛 91 | 🌐 PHP | 📅 2026-08-16.
...
* [phpqa - jakzal](https://github.com/jakzal/phpqa) ⭐ 1,319 | 🐛 1 | 🌐 Dockerfile | 📅 2026-08-17 — Many tools for PHP static analysis in one container.
...
* [pyright](https://github.com/Microsoft/pyright) ⭐ 15,588 | 🐛 326 | 🌐 Python | 📅 2026-08-14 — Static type checker for Python, created to address gaps in existing tools like mypy.
...
* [flake8](https://github.com/PyCQA/flake8) ⭐ 3,814 | 🐛 23 | 🌐 Python | 📅 2026-08-16 — A wrapper around `pyflakes`, `pycodestyle` and `mccabe`.
...
* [autoflake](https://github.com/PyCQA/autoflake) ⭐ 953 | 🐛 47 | 🌐 Python | 📅 2026-07-30 — Autoflake removes unused imports and unused variables from Python code.
...
* [lintr](https://github.com/jimhester/lintr) ⭐ 1,291 | 🐛 303 | 🌐 R | 📅 2026-08-17 — Static Code Analysis for R.
...
* [reek](https://github.com/troessner/reek) ⭐ 4,130 | 🐛 55 | 🌐 Ruby | 📅 2026-08-16 — Code smell detector for Ruby.
...
* [bundler-audit](https://github.com/rubysec/bundler-audit) ⭐ 2,758 | 🐛 48 | 🌐 Ruby | 📅 2026-08-15 — Audit Gemfile.lock for gems with security vulnerabilities reported in [Ruby Advisory Database](https://github.com/rubysec/ruby-advisory-db) ⭐ 1,070 | 🐛 8 | 🌐 Ruby | 📅 2026-08-16.
...
* [DatabaseConsistency](https://github.com/djezzzl/database_consistency) ⭐ 1,191 | 🐛 3 | 🌐 Ruby | 📅 2026-08-17 — The tool to avoid various issues due to inconsistencies and inefficiencies between a database schema and application models.
...
* [kani](https://github.com/model-checking/kani) ⭐ 3,321 | 🐛 482 | 🌐 Rust | 📅 2026-08-17 — The Kani Rust Verifier is a bit-precise model checker for Rust.
...
* [cargo-expand](https://github.com/dtolnay/cargo-expand) ⭐ 3,121 | 🐛 10 | 🌐 Rust | 📅 2026-07-18 — Cargo subcommand to show result of macro expansion  and #\[derive] expansion applied to the current crate.  This is a wrapper around a more verbose compiler command.
...
* [cargo-audit](https://rustsec.org) — Audit Cargo.lock for crates with security vulnerabilities reported to the [RustSec Advisory Database](https://github.com/RustSec/advisory-db/) ⭐ 1,152 | 🐛 137 | 📅 2026-08-12.
...
* [rustfmt](https://github.com/rust-lang/rustfmt) ⭐ 6,935 | 🐛 922 | 🌐 Rust | 📅 2026-08-15 — A tool for formatting Rust code according to style guidelines.

* [RustViz](https://github.com/rustviz/rustviz) ⭐ 2,846 | 🐛 39 | 🌐 Rust | 📅 2026-05-10 — RustViz is a tool that generates visualizations  from simple Rust programs to assist users in better  understanding the Rust Lifetime and Borrowing mechanism. It generates SVG files with graphical indicators that integrate  with mdbook to render visualizations of data-flow in Rust programs.
...
* [rust-audit](https://github.com/Shnatsel/rust-audit) ⭐ 841 | 🐛 17 | 🌐 Rust | 📅 2026-07-24 — Audit Rust binaries for known bugs or security vulnerabilities. This works by embedding data about the dependency tree (Cargo.lock) in JSON format into a dedicated linker section of the compiled executable.
...
* [shellharden](https://github.com/anordal/shellharden) ⭐ 4,795 | 🐛 10 | 🌐 Rust | 📅 2026-07-09 — A syntax highlighter and a tool to semi-automate the rewriting of scripts to ShellCheck conformance, mainly focused on quoting.
...
* [SwiftFormat](https://github.com/nicklockwood/SwiftFormat) ⭐ 8,913 | 🐛 298 | 🌐 Swift | 📅 2026-08-15 — A library and command-line formatting tool for reformatting Swift code.
...
* [TypeScript ESLint](https://github.com/typescript-eslint/typescript-eslint) ⭐ 16,357 | 🐛 283 | 🌐 TypeScript | 📅 2026-08-13 — TypeScript language extension for eslint.
...
* [wasm-language-tools](https://github.com/g-plane/wasm-language-tools) ⭐ 92 | 🐛 1 | 🌐 Rust | 📅 2026-08-17 — WebAssembly Language Tools aims to provide and improve the editing experience of WebAssembly Text Format. It also provides an out-of-the-box formatter (a.k.a. pretty printer) for WebAssembly Text Format.

## Multiple languages

* [trivy](https://github.com/aquasecurity/trivy) ⭐ 37,441 | 🐛 239 | 🌐 Go | 📅 2026-08-14 — A Simple and Comprehensive Vulnerability Scanner for Containers and other Artifacts, Suitable for CI. Trivy detects vulnerabilities of OS packages (Alpine, RHEL, CentOS, etc.) and application dependencies (Bundler, Composer, npm, yarn, etc.). Checks containers and filesystems.

* [ESLint](https://github.com/eslint/eslint) ⭐ 27,455 | 🐛 128 | 🌐 JavaScript | 📅 2026-08-17 — An extensible linter for JS, following the ECMAScript standard.

* [oxc](https://github.com/web-infra-dev/oxc) ⭐ 22,344 | 🐛 764 | 🌐 Rust | 📅 2026-08-17 — The Oxidation Compiler is creating a suite of high-performance tools for the JavaScript / TypeScript language re-written in Rust.
...
* [codeql](https://github.com/github/codeql) ⭐ 9,952 | 🐛 1,442 | 🌐 CodeQL | 📅 2026-08-17 — Deep code analysis - semantic queries and dataflow for several languages with VSCode plugin support.

* [ThreatMapper](https://github.com/deepfence/ThreatMapper) ⭐ 5,312 | 🐛 144 | 🌐 TypeScript | 📅 2026-06-01 — Vulnerability Scanner and Risk Evaluation for containers, serverless and hosts at runtime. ThreatMapper generates runtime BOMs from dependencies and operating system packages, matches against multiple threat feeds, scans for unprotected secrets, and scores issues based on severity and risk-of-exploit.
...
* [ClassGraph](https://github.com/classgraph/classgraph) ⭐ 3,005 | 🐛 0 | 🌐 Java | 📅 2026-08-17 — A classpath and module path scanner for querying or visualizing class metadata or class relatedness.

* [Bearer](https://github.com/bearer/bearer) ⭐ 2,726 | 🐛 19 | 🌐 Go | 📅 2026-08-17 — Open-Source static code analysis tool to discover,  filter and prioritize security risks and vulnerabilities  leading to sensitive data exposures (PII, PHI, PD).  Highly configurable and easily extensible,  built for security and engineering teams.
...
* [dotnet-format](https://github.com/dotnet/format) ⭐ 1,945 | 🐛 195 | 📅 2026-08-17 — A code formatter for .NET. Preferences will be read from an `.editorconfig` file, if present, otherwise a default set of preferences will be used. At this time dotnet-format is able to format C# and Visual Basic projects with a subset of supported `.editorconfig` options.

* [Roslyn Analyzers](https://github.com/dotnet/roslyn-analyzers) ⭐ 1,672 | 🐛 1,064 | 📅 2026-08-17 — Roslyn-based implementation of FxCop analyzers.
...
* [DevSkim](https://github.com/microsoft/devskim) ⭐ 1,003 | 🐛 74 | 🌐 C# | 📅 2026-08-16 — Regex-based static analysis tool for Visual Studio, VS Code, and Sublime Text - C/C++, C#, PHP, ASP, Python, Ruby, Java, and others.

* [WALA](https://github.com/wala/WALA) ⭐ 866 | 🐛 153 | 🌐 Java | 📅 2026-08-14 — Static analysis capabilities for Java bytecode and related languages and for JavaScript.

* [Putout](https://github.com/coderaiser/putout) ⭐ 797 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-16 — Pluggable and configurable code transformer with built-in eslint, babel plugins support for js, jsx typescript, flow, markdown, yaml and json.

* [Skylos](https://github.com/duriantaco/skylos) ⭐ 538 | 🐛 4 | 🌐 Python | 📅 2026-08-16 — Dead code detection, security scanning, secrets detection, and code quality analysis for Python, TypeScript, and Go. Framework-aware analysis with 98% recall. Includes CI/CD GitHub Action, VS Code extension, and MCP server for AI agent integration.
...
* [angr](https://github.com/angr/angr) ⭐ 9,015 | 🐛 727 | 🌐 Python | 📅 2026-08-17 — Binary code analysis tool that also supports symbolic execution.
...
* [checkmake](https://github.com/mrtazz/checkmake) ⭐ 1,214 | 🐛 38 | 🌐 Go | 📅 2026-08-05 — Linter / Analyzer for Makefiles.
...
* [cfn-lint](https://github.com/awslabs/cfn-python-lint) ⭐ 2,639 | 🐛 77 | 🌐 Python | 📅 2026-08-15 — AWS Labs CloudFormation linter.
...
* [Grype](https://github.com/anchore/grype) ⭐ 12,750 | 🐛 403 | 🌐 Go | 📅 2026-08-14 — Vulnerability scanner for container images and filesystems. Developed by Anchore, it scans container images, directories, and archives for known vulnerabilities. Supports multiple image formats, SBOM integration, and VEX (Vulnerability Exploitability eXchange) for accurate vulnerability assessment. Works with various vulnerability databases and provides detailed reporting.

* [Haskell Dockerfile Linter](https://github.com/lukasmartinelli/hadolint) ⭐ 12,356 | 🐛 201 | 🌐 Haskell | 📅 2026-08-17 — A smarter Dockerfile linter that helps you build best practice Docker images.

* [clair](https://github.com/coreos/clair) ⭐ 11,048 | 🐛 59 | 🌐 Go | 📅 2026-08-11 — Vulnerability Static Analysis for Containers.
...
* [gherkin-lint](https://github.com/vsiakka/gherkin-lint) ⭐ 201 | 🐛 78 | 🌐 JavaScript | 📅 2024-08-19 — A linter for the Gherkin-Syntax written in Javascript.
...
* [markdownlint](https://github.com/DavidAnson/markdownlint) ⭐ 6,282 | 🐛 81 | 🌐 JavaScript | 📅 2026-08-14 — Node.js -based style checker and lint tool for Markdown/CommonMark files.
...
* [statix](https://github.com/nerdypepper/statix) ⭐ 938 | 🐛 46 | 🌐 Rust | 📅 2026-07-26 — Lints and suggestions for the Nix programming language. "statix check" highlights antipatterns in Nix code. "statix fix" can fix several such occurrences.
...
* [Gitleaks](https://github.com/zricethezav/gitleaks) ⭐ 28,768 | 🐛 465 | 🌐 Go | 📅 2026-07-29 — A SAST tool for detecting hardcoded secrets like passwords, api keys, and tokens in git repos.

* [Grype](https://github.com/anchore/grype) ⭐ 12,750 | 🐛 403 | 🌐 Go | 📅 2026-08-14 — Vulnerability scanner for container images and filesystems. Developed by Anchore, it scans container images, directories, and archives for known vulnerabilities. Supports multiple image formats, SBOM integration, and VEX (Vulnerability Exploitability eXchange) for accurate vulnerability assessment. Works with various vulnerability databases and provides detailed reporting.

* [detect-secrets](https://github.com/Yelp/detect-secrets) ⭐ 4,621 | 🐛 176 | 🌐 Python | 📅 2026-04-02 — An enterprise friendly way of detecting and preventing secrets in code.
...
* [slither](https://github.com/trailofbits/slither) ⭐ 6,346 | 🐛 470 | 🌐 Python | 📅 2026-08-12 — Static analysis framework that runs a suite of vulnerability detectors, prints visual information about contract details, and provides an API to easily write custom analyses.

* [mythril](https://github.com/ConsenSys/mythril) ⭐ 4,261 | 🐛 129 | 🌐 Python | 📅 2026-04-27 — A symbolic execution framework with batteries included, can be used to find and exploit vulnerabilities in smart contracts automatically.
...
* [codespell](https://github.com/codespell-project/codespell) ⭐ 2,414 | 🐛 262 | 🌐 Python | 📅 2026-08-15 — Check code for common misspellings.
