...
[![Links](https://github.com/analysis-tools-dev/static-analysis/actions/workflows/links.yml/badge.svg)](https://github.com/analysis-tools-dev/static-analysis/actions/workflows/links.yml) ⭐ 14,737 | 🐛 26 | 🌐 Rust | 📅 2026-06-10
...
* [cpplint](https://github.com/cpplint/cpplint) ⭐ 1,843 | 🐛 82 | 🌐 Python | 📅 2026-08-14 — Automated C++ checker that follows Google's style guide.
...
* [Roslynator](https://github.com/JosefPihrt/Roslynator) ⭐ 3,474 | 🐛 213 | 🌐 C# | 📅 2026-08-15 — A collection of 190+ analyzers and 190+ refactorings for C#, powered by Roslyn.

* [ArchUnitNET](https://github.com/TNG/ArchUnitNET) ⭐ 1,347 | 🐛 34 | 🌐 C# | 📅 2026-08-15 — A C# architecture test library to specify and assert architecture rules in C# for automated testing.

* [Meziantou.Analyzer](https://github.com/meziantou/Meziantou.Analyzer) ⭐ 1,174 | 🐛 5 | 🌐 C# | 📅 2026-08-16 — A Roslyn analyzer to enforce some good practices in C# in terms of design, usage, security, performance, and style.
...
* [clj-kondo](https://github.com/borkdude/clj-kondo) ⭐ 1,848 | 🐛 120 | 🌐 Clojure | 📅 2026-08-04 — A linter for Clojure code that sparks joy. It informs you about potential errors while you are typing.
...
* [FSharpLint](https://github.com/fsprojects/FSharpLint) ⭐ 327 | 🐛 98 | 🌐 F# | 📅 2026-08-10 — Lint tool for F#.
...
* [Reviewdog](https://github.com/haya14busa/reviewdog) ⭐ 9,525 | 🐛 139 | 🌐 Go | 📅 2026-08-15 — A tool for posting review comments from any linter in any code hosting service.
...
* [errcheck](https://github.com/kisielk/errcheck) ⭐ 2,526 | 🐛 14 | 🌐 Go | 📅 2026-05-12 — Check that error return values are used.
...
* [NullAway](https://github.com/uber/NullAway) ⭐ 4,090 | 🐛 145 | 🌐 Java | 📅 2026-08-16 — Type-based null-pointer checker with low build-time overhead; an [Error Prone](http://errorprone.info/) plugin.

* [Dataflow Framework](https://github.com/typetools/checker-framework) ⭐ 1,146 | 🐛 448 | 🌐 Java | 📅 2026-08-14 — An industrial-strength dataflow framework for Java. The Dataflow Framework is used in the Checker Framework, Google’s Error Prone, Uber’s NullAway, Meta’s Nullsafe, and in other contexts. It is distributed with the Checker Framework.
...
* [JLiSA](https://github.com/lisa-analyzer/jlisa) ⭐ 32 | 🐛 28 | 🌐 Java | 📅 2026-08-14 — An abstract interpretation-based static analyzer for Java build upon the [LiSA](https://github.com/lisa-analyzer/lisa) ⭐ 83 | 🐛 34 | 🌐 Java | 📅 2026-08-14 framekwork.
...
* [jshint](https://jshint.com/about) [:information\_source:](https://github.com/analysis-tools-dev/static-analysis/issues/223) ⭐ 14,737 | 🐛 26 | 🌐 Rust | 📅 2026-06-10 — Detect errors and potential problems in JavaScript code and enforce your team's coding conventions.
...
* [JSLint](https://github.com/douglascrockford/JSLint) ⭐ 3,658 | 🐛 3 | 🌐 JavaScript | 📅 2026-08-02 [:information\_source:](https://github.com/analysis-tools-dev/static-analysis/issues/223) ⭐ 14,737 | 🐛 26 | 🌐 Rust | 📅 2026-06-10 — The JavaScript Code Quality Tool.
...
* [JET](https://github.com/aviatesk/JET.jl) ⭐ 878 | 🐛 85 | 🌐 Julia | 📅 2026-08-08 — Static type inference system to detect bugs and type instabilities.
...
* [composer-dependency-analyser](https://github.com/shipmonk-rnd/composer-dependency-analyser) ⭐ 625 | 🐛 19 | 🌐 PHP | 📅 2026-08-11 — Fast detection of composer dependency issues.
...
* [EasyCodingStandard](https://www.tomasvotruba.com/blog/2017/05/03/combine-power-of-php-code-sniffer-and-php-cs-fixer-in-3-lines) — Combine [PHP\_CodeSniffer](https://github.com/squizlabs/PHP_CodeSniffer) ⭐ 10,775 | 🐛 248 | 🌐 PHP | 📅 2024-04-01 and [PHP-CS-Fixer](https://github.com/FriendsOfPHP/PHP-CS-Fixer) ⭐ 13,548 | 🐛 91 | 🌐 PHP | 📅 2026-08-16.

* [larastan](https://github.com/larastan/larastan) ⭐ 6,486 | 🐛 144 | 🌐 PHP | 📅 2026-08-11 — Adds static analysis to Laravel improving developer productivity and code quality. It is a wrapper around PHPStan.
...
* [phpqa - jakzal](https://github.com/jakzal/phpqa) ⭐ 1,319 | 🐛 1 | 🌐 Dockerfile | 📅 2026-08-15 — Many tools for PHP static analysis in one container.
...
* [PHPArkitect](https://github.com/phparkitect/arkitect) ⭐ 924 | 🐛 38 | 🌐 PHP | 📅 2026-08-15 — PHPArkitect helps you to keep your PHP codebase coherent and solid, by permitting to add some architectural constraint check to your workflow. You can express the constraint that you want to enforce, in simple and readable PHP code.
...
* [pyright](https://github.com/Microsoft/pyright) ⭐ 15,588 | 🐛 323 | 🌐 Python | 📅 2026-08-14 — Static type checker for Python, created to address gaps in existing tools like mypy.
...
* [vulture](https://github.com/jendrikseipp/vulture) ⭐ 4,766 | 🐛 69 | 🌐 Python | 📅 2026-04-30 — Find unused classes, functions and variables in Python code.

* [flake8](https://github.com/PyCQA/flake8) ⭐ 3,815 | 🐛 24 | 🌐 Python | 📅 2026-07-14 — A wrapper around `pyflakes`, `pycodestyle` and `mccabe`.
...
* [Dlint](https://github.com/dlint-py/dlint) ⭐ 177 | 🐛 23 | 🌐 Python | 📅 2026-01-07 — A tool for ensuring Python code is secure.
...
* [reek](https://github.com/troessner/reek) ⭐ 4,130 | 🐛 56 | 🌐 Ruby | 📅 2026-08-16 — Code smell detector for Ruby.
...
* [bundler-audit](https://github.com/rubysec/bundler-audit) ⭐ 2,758 | 🐛 48 | 🌐 Ruby | 📅 2026-08-15 — Audit Gemfile.lock for gems with security vulnerabilities reported in [Ruby Advisory Database](https://github.com/rubysec/ruby-advisory-db) ⭐ 1,070 | 🐛 8 | 🌐 Ruby | 📅 2026-08-15.
...
* [kani](https://github.com/model-checking/kani) ⭐ 3,317 | 🐛 486 | 🌐 Rust | 📅 2026-08-16 — The Kani Rust Verifier is a bit-precise model checker for Rust.
...
* [cargo-audit](https://rustsec.org) — Audit Cargo.lock for crates with security vulnerabilities reported to the [RustSec Advisory Database](https://github.com/RustSec/advisory-db/) ⭐ 1,152 | 🐛 136 | 📅 2026-08-12.
...
* [rustfmt](https://github.com/rust-lang/rustfmt) ⭐ 6,936 | 🐛 920 | 🌐 Rust | 📅 2026-08-15 — A tool for formatting Rust code according to style guidelines.
...
* [SwiftFormat](https://github.com/nicklockwood/SwiftFormat) ⭐ 8,913 | 🐛 296 | 🌐 Swift | 📅 2026-08-15 — A library and command-line formatting tool for reformatting Swift code.
...
* [TypeScript ESLint](https://github.com/typescript-eslint/typescript-eslint) ⭐ 16,357 | 🐛 280 | 🌐 TypeScript | 📅 2026-08-13 — TypeScript language extension for eslint.
...
* [vscode-verilog-hdl-support](https://github.com/mshr-h/vscode-verilog-hdl-support) ⭐ 383 | 🐛 68 | 🌐 TypeScript | 📅 2026-08-15 — Verilog HDL/SystemVerilog/Bluespec SystemVerilog support for VS Code. Provides syntax highlighting and Linting support from Icarus Verilog, Vivado Logical Simulation, Modelsim and Verilator
...
* [trivy](https://github.com/aquasecurity/trivy) ⭐ 37,422 | 🐛 238 | 🌐 Go | 📅 2026-08-14 — A Simple and Comprehensive Vulnerability Scanner for Containers and other Artifacts, Suitable for CI. Trivy detects vulnerabilities of OS packages (Alpine, RHEL, CentOS, etc.) and application dependencies (Bundler, Composer, npm, yarn, etc.). Checks containers and filesystems.

* [ESLint](https://github.com/eslint/eslint) ⭐ 27,456 | 🐛 131 | 🌐 JavaScript | 📅 2026-08-16 — An extensible linter for JS, following the ECMAScript standard.

* [oxc](https://github.com/web-infra-dev/oxc) ⭐ 22,334 | 🐛 762 | 🌐 Rust | 📅 2026-08-16 — The Oxidation Compiler is creating a suite of high-performance tools for the JavaScript / TypeScript language re-written in Rust.

* [ale](https://github.com/w0rp/ale) ⭐ 14,014 | 🐛 596 | 🌐 Vim Script | 📅 2026-08-09 — Asynchronous Lint Engine for Vim and NeoVim with support for many languages.

* [codeql](https://github.com/github/codeql) ⭐ 9,944 | 🐛 1,443 | 🌐 CodeQL | 📅 2026-08-14 — Deep code analysis - semantic queries and dataflow for several languages with VSCode plugin support.

* [ThreatMapper](https://github.com/deepfence/ThreatMapper) ⭐ 5,311 | 🐛 144 | 🌐 TypeScript | 📅 2026-06-01 — Vulnerability Scanner and Risk Evaluation for containers, serverless and hosts at runtime. ThreatMapper generates runtime BOMs from dependencies and operating system packages, matches against multiple threat feeds, scans for unprotected secrets, and scores issues based on severity and risk-of-exploit.

* [ApplicationInspector](https://github.com/microsoft/ApplicationInspector) ⭐ 4,397 | 🐛 31 | 🌐 C# | 📅 2026-08-16 — Creates reports of over 400 rule patterns for feature detection (e.g. the use of cryptography or version control in apps).

* [ClassGraph](https://github.com/classgraph/classgraph) ⭐ 3,005 | 🐛 0 | 🌐 Java | 📅 2026-08-16 — A classpath and module path scanner for querying or visualizing class metadata or class relatedness.

* [Bearer](https://github.com/bearer/bearer) ⭐ 2,725 | 🐛 16 | 🌐 Go | 📅 2026-08-03 — Open-Source static code analysis tool to discover,  filter and prioritize security risks and vulnerabilities  leading to sensitive data exposures (PII, PHI, PD).  Highly configurable and easily extensible,  built for security and engineering teams.

* [Pronto](https://github.com/prontolabs/pronto) ⭐ 2,671 | 🐛 15 | 🌐 Ruby | 📅 2026-05-04 — Quick automated code review of your changes. Supports more than 40 runners for various languages, including Clang, Elixir, JavaScript, PHP, Ruby and more.
...
* [DevSkim](https://github.com/microsoft/devskim) ⭐ 1,003 | 🐛 75 | 🌐 C# | 📅 2026-08-14 — Regex-based static analysis tool for Visual Studio, VS Code, and Sublime Text - C/C++, C#, PHP, ASP, Python, Ruby, Java, and others.
...
* [Putout](https://github.com/coderaiser/putout) ⭐ 797 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-15 — Pluggable and configurable code transformer with built-in eslint, babel plugins support for js, jsx typescript, flow, markdown, yaml and json.

* [Skylos](https://github.com/duriantaco/skylos) ⭐ 537 | 🐛 5 | 🌐 Python | 📅 2026-08-16 — Dead code detection, security scanning, secrets detection, and code quality analysis for Python, TypeScript, and Go. Framework-aware analysis with 98% recall. Includes CI/CD GitHub Action, VS Code extension, and MCP server for AI agent integration.
...
* [BlockWatch](https://github.com/mennanov/blockwatch) ⭐ 29 | 🐛 24 | 🌐 Rust | 📅 2026-08-15 — A language-agnostic linter that keeps code, documentation, and configuration in sync and enforces strict formatting and validation rules.
...
* [angr](https://github.com/angr/angr) ⭐ 9,013 | 🐛 719 | 🌐 Python | 📅 2026-08-16 — Binary code analysis tool that also supports symbolic execution.
...
* [cwe\_checker](https://github.com/fkie-cad/cwe_checker) ⭐ 1,349 | 🐛 30 | 🌐 Rust | 📅 2026-07-24 — cwe\_checker finds vulnerable patterns in binary executables.
...
* [BinSkim](https://github.com/Microsoft/binskim) ⭐ 859 | 🐛 162 | 🌐 C# | 📅 2026-08-13 — A binary static analysis tool that provides security and correctness results for Windows portable executables.

* [rust-audit](https://github.com/Shnatsel/rust-audit) ⭐ 840 | 🐛 17 | 🌐 Rust | 📅 2026-07-24 — Audit Rust binaries for known bugs or security vulnerabilities. This works by embedding data about the dependency tree (Cargo.lock) in JSON format into a dedicated linker section of the compiled executable.

* [binbloom](https://github.com/quarkslab/binbloom) ⭐ 583 | 🐛 2 | 🌐 C | 📅 2024-06-06 — Analyzes a raw binary firmware and determines features like endianness or the loading address.  The tool is compatible with all architectures.
...
* [Nauz File Detector](https://github.com/horsicq/Nauz-File-Detector) ⭐ 581 | 🐛 2 | 🌐 C++ | 📅 2026-08-16 — Static Linker/Compiler/Tool detector for Windows, Linux and MacOS.
...
* [checkmake](https://github.com/mrtazz/checkmake) ⭐ 1,212 | 🐛 38 | 🌐 Go | 📅 2026-08-05 — Linter / Analyzer for Makefiles.
...
* [cfn-lint](https://github.com/awslabs/cfn-python-lint) ⭐ 2,638 | 🐛 77 | 🌐 Python | 📅 2026-08-15 — AWS Labs CloudFormation linter.
...
* [Grype](https://github.com/anchore/grype) ⭐ 12,745 | 🐛 402 | 🌐 Go | 📅 2026-08-14 — Vulnerability scanner for container images and filesystems. Developed by Anchore, it scans container images, directories, and archives for known vulnerabilities. Supports multiple image formats, SBOM integration, and VEX (Vulnerability Exploitability eXchange) for accurate vulnerability assessment. Works with various vulnerability databases and provides detailed reporting.

* [Haskell Dockerfile Linter](https://github.com/lukasmartinelli/hadolint) ⭐ 12,355 | 🐛 200 | 🌐 Haskell | 📅 2026-08-14 — A smarter Dockerfile linter that helps you build best practice Docker images.

* [clair](https://github.com/coreos/clair) ⭐ 11,046 | 🐛 59 | 🌐 Go | 📅 2026-08-11 — Vulnerability Static Analysis for Containers.

* [Dockle](https://github.com/goodwithtech/dockle) ⭐ 3,287 | 🐛 53 | 🌐 Go | 📅 2026-08-10 — Container Image Linter for Security helping build the Best-Practice Docker Image. Scans Docker images for security vulnerabilities and CIS Benchmark compliance. Checks for secrets, credential exposure, and security best practices. Provides multiple severity levels (FATAL, WARN, INFO) and supports various output formats for CI/CD integration.
...
* [kube-linter](https://github.com/stackrox/kube-linter) ⭐ 3,498 | 🐛 89 | 🌐 Go | 📅 2026-08-12 — KubeLinter is a static analysis tool that checks Kubernetes YAML files  and Helm charts to ensure the applications represented in them adhere to best practices.
...
- [KubeLinter](https://github.com/stackrox/kube-linter) ⭐ 3,498 | 🐛 89 | 🌐 Go | 📅 2026-08-12 — KubeLinter is a static analysis tool that checks Kubernetes YAML files and Helm charts to ensure the applications represented in them adhere to best practices.
...
* [statix](https://github.com/nerdypepper/statix) ⭐ 936 | 🐛 46 | 🌐 Rust | 📅 2026-07-26 — Lints and suggestions for the Nix programming language. "statix check" highlights antipatterns in Nix code. "statix fix" can fix several such occurrences.

* [deadnix](https://github.com/astro/deadnix) ⭐ 772 | 🐛 5 | 🌐 Rust | 📅 2026-07-26 — Scan Nix files for dead code (unused variable bindings)
...
* [protolint](https://github.com/yoheimuta/protolint) ⭐ 696 | 🐛 62 | 🌐 Go | 📅 2026-08-14 — Pluggable linter and fixer to enforce Protocol Buffer style and conventions.
...
* [Gitleaks](https://github.com/zricethezav/gitleaks) ⭐ 28,748 | 🐛 463 | 🌐 Go | 📅 2026-07-29 — A SAST tool for detecting hardcoded secrets like passwords, api keys, and tokens in git repos.

* [Grype](https://github.com/anchore/grype) ⭐ 12,745 | 🐛 402 | 🌐 Go | 📅 2026-08-14 — Vulnerability scanner for container images and filesystems. Developed by Anchore, it scans container images, directories, and archives for known vulnerabilities. Supports multiple image formats, SBOM integration, and VEX (Vulnerability Exploitability eXchange) for accurate vulnerability assessment. Works with various vulnerability databases and provides detailed reporting.

* [detect-secrets](https://github.com/Yelp/detect-secrets) ⭐ 4,620 | 🐛 176 | 🌐 Python | 📅 2026-04-02 — An enterprise friendly way of detecting and preventing secrets in code.
...
* [codespell](https://github.com/codespell-project/codespell) ⭐ 2,416 | 🐛 262 | 🌐 Python | 📅 2026-08-15 — Check code for common misspellings.
...
* [go-tools](https://github.com/dominikh/go-tools) ⭐ 6,850 | 🐛 575 | 🌐 Go | 📅 2026-06-30 — A collection of tools and libraries for working with Go code, including linters and static analysis
