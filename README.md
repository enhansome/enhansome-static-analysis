...
[![CI](https://github.com/analysis-tools-dev/static-analysis/workflows/CI/badge.svg)](https://github.com/analysis-tools-dev/static-analysis/actions/workflows/ci.yml) ⭐ 14,767 | 🐛 12 | 🌐 Rust | 📅 2026-08-30
[![Links](https://github.com/analysis-tools-dev/static-analysis/actions/workflows/links.yml/badge.svg)](https://github.com/analysis-tools-dev/static-analysis/actions/workflows/links.yml) ⭐ 14,767 | 🐛 12 | 🌐 Rust | 📅 2026-08-30
...
* [cpplint](https://github.com/cpplint/cpplint) ⭐ 1,849 | 🐛 84 | 🌐 Python | 📅 2026-09-02 — Automated C++ checker that follows Google's style guide.
...
* [Roslynator](https://github.com/JosefPihrt/Roslynator) ⭐ 3,477 | 🐛 212 | 🌐 C# | 📅 2026-09-02 — A collection of 190+ analyzers and 190+ refactorings for C#, powered by Roslyn.

* [ArchUnitNET](https://github.com/TNG/ArchUnitNET) ⭐ 1,355 | 🐛 31 | 🌐 C# | 📅 2026-09-07 — A C# architecture test library to specify and assert architecture rules in C# for automated testing.

* [Meziantou.Analyzer](https://github.com/meziantou/Meziantou.Analyzer) ⭐ 1,190 | 🐛 1 | 🌐 C# | 📅 2026-09-07 — A Roslyn analyzer to enforce some good practices in C# in terms of design, usage, security, performance, and style.
...
* [SonarDelphi](https://github.com/integrated-application-development/sonar-delphi) ⭐ 158 | 🐛 44 | 🌐 Java | 📅 2026-09-04 — Delphi static analyzer for the SonarQube code quality platform.
...
* [Reviewdog](https://github.com/haya14busa/reviewdog) ⭐ 9,569 | 🐛 141 | 🌐 Go | 📅 2026-09-06 — A tool for posting review comments from any linter in any code hosting service.

* [gofumpt](https://github.com/mvdan/gofumpt) ⭐ 4,074 | 🐛 13 | 🌐 Go | 📅 2026-09-06 — Enforce a stricter format than `gofmt`, while being backwards-compatible.  That is, `gofumpt` is happy with a subset of the formats that `gofmt` is happy with.
...
* [NullAway](https://github.com/uber/NullAway) ⭐ 4,104 | 🐛 158 | 🌐 Java | 📅 2026-09-07 — Type-based null-pointer checker with low build-time overhead; an [Error Prone](http://errorprone.info/) plugin.

* [Dataflow Framework](https://github.com/typetools/checker-framework) ⭐ 1,149 | 🐛 429 | 🌐 Java | 📅 2026-09-06 — An industrial-strength dataflow framework for Java. The Dataflow Framework is used in the Checker Framework, Google’s Error Prone, Uber’s NullAway, Meta’s Nullsafe, and in other contexts. It is distributed with the Checker Framework.

* [RefactorFirst](https://github.com/jimbethancourt/RefactorFirst) ⭐ 543 | 🐛 60 | 🌐 Java | 📅 2026-09-07 — Identifies and prioritizes God Classes and Highly Coupled classes in Java codebases you should refactor first.
...
* **jshint** [:information\_source:](https://github.com/analysis-tools-dev/static-analysis/issues/223) ⭐ 14,767 | 🐛 12 | 🌐 Rust | 📅 2026-08-30 :warning: — Detect errors and potential problems in JavaScript code and enforce your team's coding conventions.
...
* [JSLint](https://github.com/douglascrockford/JSLint) ⭐ 3,654 | 🐛 3 | 🌐 JavaScript | 📅 2026-09-04 [:information\_source:](https://github.com/analysis-tools-dev/static-analysis/issues/223) ⭐ 14,767 | 🐛 12 | 🌐 Rust | 📅 2026-08-30 — The JavaScript Code Quality Tool.
...
* [EasyCodingStandard](https://www.tomasvotruba.com/blog/2017/05/03/combine-power-of-php-code-sniffer-and-php-cs-fixer-in-3-lines) — Combine [PHP\_CodeSniffer](https://github.com/squizlabs/PHP_CodeSniffer) ⭐ 10,779 | 🐛 248 | 🌐 PHP | 📅 2024-04-01 and [PHP-CS-Fixer](https://github.com/FriendsOfPHP/PHP-CS-Fixer) ⭐ 13,547 | 🐛 82 | 🌐 PHP | 📅 2026-09-07.

* [larastan](https://github.com/larastan/larastan) ⭐ 6,500 | 🐛 112 | 🌐 PHP | 📅 2026-09-07 — Adds static analysis to Laravel improving developer productivity and code quality. It is a wrapper around PHPStan.

* [PHP Insights](https://github.com/nunomaduro/phpinsights) ⭐ 5,632 | 🐛 75 | 🌐 PHP | 📅 2026-08-04 — Instant PHP quality checks from your console. Analysis of code quality and coding style as well as overview of code architecture and its complexity.
...
* [deptrac](https://github.com/sensiolabs-de/deptrac) ⭐ 3,009 | 🐛 37 | 🌐 PHP | 📅 2026-08-14 — Enforce rules for dependencies between software layers.
...
* [pyright](https://github.com/Microsoft/pyright) ⭐ 15,624 | 🐛 341 | 🌐 Python | 📅 2026-09-04 — Static type checker for Python, created to address gaps in existing tools like mypy.
...
* [Steep](https://github.com/soutaro/steep) ⭐ 1,488 | 🐛 225 | 🌐 Ruby | 📅 2026-09-06 — Gradual Typing for Ruby.
...
* [kani](https://github.com/model-checking/kani) ⭐ 3,384 | 🐛 481 | 🌐 Rust | 📅 2026-09-07 — The Kani Rust Verifier is a bit-precise model checker for Rust.
...
* [cargo-expand](https://github.com/dtolnay/cargo-expand) ⭐ 3,128 | 🐛 10 | 🌐 Rust | 📅 2026-08-19 — Cargo subcommand to show result of macro expansion  and #\[derive] expansion applied to the current crate.  This is a wrapper around a more verbose compiler command.
...
* [cargo-audit](https://rustsec.org) — Audit Cargo.lock for crates with security vulnerabilities reported to the [RustSec Advisory Database](https://github.com/RustSec/advisory-db/) ⭐ 1,172 | 🐛 144 | 📅 2026-09-07.
...
* [rustfmt](https://github.com/rust-lang/rustfmt) ⭐ 6,961 | 🐛 942 | 🌐 Rust | 📅 2026-09-04 — A tool for formatting Rust code according to style guidelines.
...
* [scapegoat](https://github.com/sksamuel/scapegoat) ⭐ 556 | 🐛 47 | 🌐 Scala | 📅 2026-09-07 — Scala compiler plugin for static code analysis.
...
* [SwiftFormat](https://github.com/nicklockwood/SwiftFormat) ⭐ 8,922 | 🐛 288 | 🌐 Swift | 📅 2026-09-04 — A library and command-line formatting tool for reformatting Swift code.
...
* [TypeScript ESLint](https://github.com/typescript-eslint/typescript-eslint) ⭐ 16,390 | 🐛 265 | 🌐 TypeScript | 📅 2026-09-07 — TypeScript language extension for eslint.
...
* [Angular ESLint](https://github.com/angular-eslint/angular-eslint#readme) ⭐ 1,783 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-07 — Linter for Angular projects
...
* [svls](https://github.com/dalance/svls) ⭐ 585 | 🐛 26 | 🌐 Rust | 📅 2026-08-25 — A Language Server Protocol implementation for Verilog and SystemVerilog, including lint capabilities.

* [vscode-verilog-hdl-support](https://github.com/mshr-h/vscode-verilog-hdl-support) ⭐ 386 | 🐛 68 | 🌐 TypeScript | 📅 2026-09-06 — Verilog HDL/SystemVerilog/Bluespec SystemVerilog support for VS Code. Provides syntax highlighting and Linting support from Icarus Verilog, Vivado Logical Simulation, Modelsim and Verilator
...
* [trivy](https://github.com/aquasecurity/trivy) ⭐ 37,825 | 🐛 264 | 🌐 Go | 📅 2026-09-07 — A Simple and Comprehensive Vulnerability Scanner for Containers and other Artifacts, Suitable for CI. Trivy detects vulnerabilities of OS packages (Alpine, RHEL, CentOS, etc.) and application dependencies (Bundler, Composer, npm, yarn, etc.). Checks containers and filesystems.

* [ESLint](https://github.com/eslint/eslint) ⭐ 27,497 | 🐛 127 | 🌐 JavaScript | 📅 2026-09-07 — An extensible linter for JS, following the ECMAScript standard.

* [oxc](https://github.com/web-infra-dev/oxc) ⭐ 22,668 | 🐛 830 | 🌐 Rust | 📅 2026-09-07 — The Oxidation Compiler is creating a suite of high-performance tools for the JavaScript / TypeScript language re-written in Rust.
...
* [codeql](https://github.com/github/codeql) ⭐ 10,058 | 🐛 1,457 | 🌐 CodeQL | 📅 2026-09-07 — Deep code analysis - semantic queries and dataflow for several languages with VSCode plugin support.
...
* [Bearer](https://github.com/bearer/bearer) ⭐ 2,743 | 🐛 21 | 🌐 Go | 📅 2026-09-07 — Open-Source static code analysis tool to discover,  filter and prioritize security risks and vulnerabilities  leading to sensitive data exposures (PII, PHI, PD).  Highly configurable and easily extensible,  built for security and engineering teams.
...
* [lizard](https://github.com/terryyin/lizard) ⭐ 2,490 | 🐛 25 | 🌐 Python | 📅 2026-09-05 — Lizard is an extensible Cyclomatic Complexity Analyzer for many programming languages  including C/C++ (doesn't require all the header files or Java imports).  It also does copy-paste detection (code clone detection/code duplicate detection) and many other forms of static code analysis. Counts lines of code without comments, CCN (cyclomatic complexity number), token count of functions, parameter count of functions.
...
* [emerge](https://github.com/glato/emerge) ⭐ 1,144 | 🐛 19 | 🌐 Python | 📅 2026-08-07 — Emerge is a source code and dependency visualizer that can be used to gather insights about source code structure, metrics, dependencies and complexity of software projects. After scanning the source code of a project it provides you an interactive web interface to explore and analyze your project by using graph structures.
...
* [Putout](https://github.com/coderaiser/putout) ⭐ 796 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-07 — Pluggable and configurable code transformer with built-in eslint, babel plugins support for js, jsx typescript, flow, markdown, yaml and json.

* [Skylos](https://github.com/duriantaco/skylos) ⭐ 676 | 🐛 3 | 🌐 Python | 📅 2026-09-07 — Dead code detection, security scanning, secrets detection, and code quality analysis for Python, TypeScript, and Go. Framework-aware analysis with 98% recall. Includes CI/CD GitHub Action, VS Code extension, and MCP server for AI agent integration.
...
* [nestjs-doctor](https://github.com/RoloBits/nestjs-doctor) ⭐ 161 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-06 — Static analysis tool for NestJS applications. Detects anti-patterns across security, performance, correctness, and architecture with 30+ built-in rules. Outputs a 0-100 health score. Includes module graph visualization, endpoint dependency graphs, and database schema analysis. CLI and VS Code extension.
...
* [angr](https://github.com/angr/angr) ⭐ 9,070 | 🐛 717 | 🌐 Python | 📅 2026-09-07 — Binary code analysis tool that also supports symbolic execution.

* [bloaty](https://github.com/google/bloaty) ⭐ 5,539 | 🐛 73 | 🌐 C++ | 📅 2026-09-02 — Ever wondered what's making your binary big? Bloaty McBloatface will show you a size profile of the binary so you can understand what's taking up space inside. Bloaty performs a deep analysis of the binary. Using custom ELF, DWARF, and Mach-O parsers,  Bloaty aims to accurately attribute every byte of the binary to the symbol or compileunit that produced it.  It will even disassemble the binary looking for references to anonymous data. F
...
* [checkmake](https://github.com/mrtazz/checkmake) ⭐ 1,215 | 🐛 41 | 🌐 Go | 📅 2026-09-07 — Linter / Analyzer for Makefiles.
...
* [cfn-lint](https://github.com/awslabs/cfn-python-lint) ⭐ 2,638 | 🐛 86 | 🌐 Python | 📅 2026-09-05 — AWS Labs CloudFormation linter.
...
* [Grype](https://github.com/anchore/grype) ⭐ 12,850 | 🐛 405 | 🌐 Go | 📅 2026-09-04 — Vulnerability scanner for container images and filesystems. Developed by Anchore, it scans container images, directories, and archives for known vulnerabilities. Supports multiple image formats, SBOM integration, and VEX (Vulnerability Exploitability eXchange) for accurate vulnerability assessment. Works with various vulnerability databases and provides detailed reporting.

* [Haskell Dockerfile Linter](https://github.com/lukasmartinelli/hadolint) ⭐ 12,387 | 🐛 206 | 🌐 Haskell | 📅 2026-08-24 — A smarter Dockerfile linter that helps you build best practice Docker images.

* [clair](https://github.com/coreos/clair) ⭐ 11,056 | 🐛 60 | 🌐 Go | 📅 2026-09-02 — Vulnerability Static Analysis for Containers.
...
* [kubeconform](https://github.com/yannh/kubeconform) ⭐ 3,181 | 🐛 89 | 🌐 Go | 📅 2026-06-13 — A fast Kubernetes manifests validator with support for custom resources.
...
- [KubeLinter](https://github.com/stackrox/kube-linter) ⭐ 3,503 | 🐛 95 | 🌐 Go | 📅 2026-09-02 — KubeLinter is a static analysis tool that checks Kubernetes YAML files and Helm charts to ensure the applications represented in them adhere to best practices.
...
* [markdownlint](https://github.com/DavidAnson/markdownlint) ⭐ 6,326 | 🐛 84 | 🌐 JavaScript | 📅 2026-09-07 — Node.js -based style checker and lint tool for Markdown/CommonMark files.
...
* [Gitleaks](https://github.com/zricethezav/gitleaks) ⭐ 29,150 | 🐛 473 | 🌐 Go | 📅 2026-08-26 — A SAST tool for detecting hardcoded secrets like passwords, api keys, and tokens in git repos.
...
* [scorecard](https://github.com/ossf/scorecard) ⭐ 5,676 | 🐛 465 | 🌐 Go | 📅 2026-09-07 — Security Scorecards - Security health metrics for Open Source
...
* [slither](https://github.com/trailofbits/slither) ⭐ 6,356 | 🐛 477 | 🌐 Python | 📅 2026-09-02 — Static analysis framework that runs a suite of vulnerability detectors, prints visual information about contract details, and provides an API to easily write custom analyses.
...
* [proselint](https://github.com/amperser/proselint) ⭐ 4,573 | 🐛 236 | 🌐 JavaScript | 📅 2026-09-04 — A linter for English prose with a focus on writing style instead of grammar.

* [codespell](https://github.com/codespell-project/codespell) ⭐ 2,421 | 🐛 268 | 🌐 Python | 📅 2026-09-01 — Check code for common misspellings.
...
* [go-tools](https://github.com/dominikh/go-tools) ⭐ 6,887 | 🐛 573 | 🌐 Go | 📅 2026-08-24 — A collection of tools and libraries for working with Go code, including linters and static analysis
