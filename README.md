# Awesome static analysis with stars
...
[![Links](https://github.com/analysis-tools-dev/static-analysis/actions/workflows/links.yml/badge.svg)](https://github.com/analysis-tools-dev/static-analysis/actions/workflows/links.yml) ⭐ 14,735 | 🐛 26 | 🌐 Rust | 📅 2026-06-10
...
Also check out the sister project, [awesome-dynamic-analysis](https://github.com/mre/awesome-dynamic-analysis) ⭐ 1,100 | 🐛 5 | 🌐 Markdown | 📅 2026-07-20.
...
* [IKOS](https://github.com/nasa-sw-vnv/ikos) ⭐ 3,160 | 🐛 50 | 🌐 C++ | 📅 2026-05-31 — A sound static analyzer for C/C++ code based on LLVM.

* [cpplint](https://github.com/cpplint/cpplint) ⭐ 1,842 | 🐛 82 | 🌐 Python | 📅 2026-08-14 — Automated C++ checker that follows Google's style guide.

* [clazy](https://github.com/KDE/clazy) ⭐ 745 | 🐛 0 | 🌐 C++ | 📅 2026-08-03 — Qt-oriented static code analyzer based on the Clang framework. clazy is a compiler plugin which allows clang to understand Qt semantics. You get more than 50 Qt related compiler warnings, ranging from unneeded memory allocations to misusage of API, including fix-its for automatic refactoring.

* [CMetrics](https://github.com/MetricsGrimoire/CMetrics) ⭐ 80 | 🐛 1 | 🌐 Shell | 📅 2015-03-24 — Measures size and complexity for C files.

* [cqmetrics](https://github.com/dspinellis/cqmetrics) ⭐ 69 | 🐛 4 | 🌐 C++ | 📅 2022-06-14 — Quality metrics for C code.
...
* [Roslynator](https://github.com/JosefPihrt/Roslynator) ⭐ 3,474 | 🐛 208 | 🌐 C# | 📅 2026-08-14 — A collection of 190+ analyzers and 190+ refactorings for C#, powered by Roslyn.

* [ArchUnitNET](https://github.com/TNG/ArchUnitNET) ⭐ 1,346 | 🐛 34 | 🌐 C# | 📅 2026-08-15 — A C# architecture test library to specify and assert architecture rules in C# for automated testing.

* [Meziantou.Analyzer](https://github.com/meziantou/Meziantou.Analyzer) ⭐ 1,174 | 🐛 6 | 🌐 C# | 📅 2026-08-15 — A Roslyn analyzer to enforce some good practices in C# in terms of design, usage, security, performance, and style.

* [SonarAnalyzer.CSharp](https://github.com/SonarSource/sonar-dotnet) ⭐ 918 | 🐛 248 | 🌐 C# | 📅 2026-08-15 — These Roslyn analyzers allow you to produce Clean Code that is safe, reliable, and maintainable by helping you find and correct bugs, vulnerabilities, and code smells in your codebase.

* [Wintellect.Analyzers](https://github.com/Wintellect/Wintellect.Analyzers) ⭐ 89 | 🐛 2 | 🌐 C# | 📅 2016-11-25 — .NET Compiler Platform ("Roslyn") diagnostic analyzers and code fixes.
...
* [clj-kondo](https://github.com/borkdude/clj-kondo) ⭐ 1,847 | 🐛 118 | 🌐 Clojure | 📅 2026-08-04 — A linter for Clojure code that sparks joy. It informs you about potential errors while you are typing.
...
* [SonarDelphi](https://github.com/integrated-application-development/sonar-delphi) ⭐ 157 | 🐛 42 | 🌐 Java | 📅 2026-08-13 — Delphi static analyzer for the SonarQube code quality platform.

* [DelphiLint](https://github.com/integrated-application-development/delphilint) ⭐ 143 | 🐛 20 | 🌐 Pascal | 📅 2026-01-27 — A Delphi IDE package providing on-the-fly code analysis and linting, powered by SonarDelphi.
...
* [D-scanner](https://github.com/dlang-community/D-Scanner) ⭐ 256 | 🐛 130 | 🌐 D | 📅 2026-02-18 — D-Scanner is a tool for analyzing D source code.

<a name="elixir" />
<h2>Elixir</h2>

* [credo](https://github.com/rrrene/credo) ⭐ 5,206 | 🐛 37 | 🌐 Elixir | 📅 2026-07-26 — A static code analysis tool with a focus on code consistency and teaching.

* [dialyxir](https://github.com/jeremyjh/dialyxir) ⭐ 1,794 | 🐛 78 | 🌐 Elixir | 📅 2026-06-12 — Mix tasks to simplify use of Dialyzer in Elixir projects.

* [sobelow](https://github.com/nccgroup/sobelow) ⭐ 1,790 | 🐛 38 | 🌐 Elixir | 📅 2024-08-20 — Security-focused static analysis for the Phoenix Framework.
...
* [FSharpLint](https://github.com/fsprojects/FSharpLint) ⭐ 326 | 🐛 98 | 🌐 F# | 📅 2026-08-10 — Lint tool for F#.
...
* [Reviewdog](https://github.com/haya14busa/reviewdog) ⭐ 9,523 | 🐛 139 | 🌐 Go | 📅 2026-08-15 — A tool for posting review comments from any linter in any code hosting service.

* [gofumpt](https://github.com/mvdan/gofumpt) ⭐ 4,060 | 🐛 15 | 🌐 Go | 📅 2026-07-27 — Enforce a stricter format than `gofmt`, while being backwards-compatible.  That is, `gofumpt` is happy with a subset of the formats that `gofmt` is happy with.
...
* [golint](https://github.com/golang/lint) ⚠️ Archived — Prints out coding style mistakes in Go source code.

* [goreporter](https://github.com/360EntSecGroup-Skylar/goreporter) ⭐ 3,120 | 🐛 30 | 🌐 Go | 📅 2018-10-27 — Concurrently runs many linters and normalises their output to a report.

* [errcheck](https://github.com/kisielk/errcheck) ⭐ 2,525 | 🐛 14 | 🌐 Go | 📅 2026-05-12 — Check that error return values are used.

* [gokart](https://github.com/praetorian-inc/gokart) ⚠️ Archived — Golang security analysis with a focus on minimizing false positives. It is capable of tracing the source of variables and function arguments  to determine whether input sources are safe.

* [go-critic](https://github.com/go-critic/go-critic) ⭐ 2,065 | 🐛 152 | 🌐 Go | 📅 2026-06-26 — Go source code linter that maintains checks which are currently not implemented in other linters.

* [gocyclo](https://github.com/fzipp/gocyclo) ⭐ 1,593 | 🐛 11 | 🌐 Go | 📅 2025-12-27 — Calculate cyclomatic complexities of functions in Go source code.

* [misspell](https://github.com/client9/misspell) ⚠️ Archived — Finds commonly misspelled English words.

* [structslop](https://github.com/orijtech/structslop) ⭐ 831 | 🐛 11 | 🌐 Go | 📅 2024-02-08 — Static analyzer for Go that recommends struct field rearrangements to provide for maximum space/allocation efficiency

* [prealloc](https://github.com/alexkohler/prealloc) ⭐ 666 | 🐛 3 | 🌐 Go | 📅 2026-02-26 — Finds slice declarations that could potentially be preallocated.

* [unparam](https://github.com/mvdan/unparam) ⭐ 570 | 🐛 8 | 🌐 Go | 📅 2026-08-13 — Find unused function parameters.

* [goroutine-inspect](https://github.com/linuxerwang/goroutine-inspect) ⭐ 478 | 🐛 1 | 🌐 Go | 📅 2021-12-06 — An interactive tool to analyze Golang goroutine dump.

* [ineffassign](https://github.com/gordonklaus/ineffassign) ⭐ 469 | 🐛 10 | 🌐 Go | 📅 2025-08-27 — Detect ineffectual assignments in Go code.

* [dupl](https://github.com/mibk/dupl) ⭐ 368 | 🐛 6 | 🌐 Go | 📅 2026-03-05 — Reports potentially duplicated code.

* [wsl](https://github.com/bombsimon/wsl) ⭐ 359 | 🐛 4 | 🌐 Go | 📅 2026-08-13 — Enforces empty lines at the right places.

* [bodyclose](https://github.com/timakin/bodyclose) ⭐ 323 | 🐛 30 | 🌐 Go | 📅 2026-07-23 — Checks whether HTTP response body is closed.

* [goconst](https://github.com/jgautheron/goconst) ⭐ 320 | 🐛 1 | 🌐 Go | 📅 2026-07-29 — Finds repeated strings that could be replaced by a constant.

* [nargs](https://github.com/alexkohler/nargs) ⭐ 86 | 🐛 0 | 🌐 Go | 📅 2025-05-15 — Finds unused arguments in function declarations.

* [dogsled](https://github.com/alexkohler/dogsled) ⭐ 76 | 🐛 1 | 🌐 Go | 📅 2024-03-29 — Finds assignments/declarations with too many blank identifiers.

* [goast](https://github.com/m-mizutani/goast) ⭐ 75 | 🐛 0 | 🌐 Go | 📅 2026-07-10 — Go AST (Abstract Syntax Tree) based static analysis tool with Rego.

* [lll](https://github.com/walle/lll) ⭐ 70 | 🐛 7 | 🌐 Go | 📅 2022-06-04 — Report long lines.

* [deadcode](https://github.com/tsenart/deadcode) ⭐ 54 | 🐛 8 | 🌐 Go | 📅 2018-10-28 — Finds unused code.

* [flen](https://github.com/lafolle/flen) ⭐ 50 | 🐛 4 | 🌐 Go | 📅 2018-03-11 — Get info on length of functions in a Go package.
...
* [HLint](https://github.com/ndmitchell/hlint) ⭐ 1,605 | 🐛 314 | 🌐 Haskell | 📅 2026-07-27 — HLint is a tool for suggesting possible improvements to Haskell code.

* [Weeder](https://github.com/ocharles/weeder) ⭐ 188 | 🐛 40 | 🌐 Haskell | 📅 2026-06-23 — A tool for detecting dead exports or package imports in Haskell code.
...
* [google-java-format](https://github.com/google/google-java-format) ⭐ 6,174 | 🐛 175 | 🌐 Java | 📅 2026-08-13 — Reformats Java source code to comply with Google Java Style

* [NullAway](https://github.com/uber/NullAway) ⭐ 4,090 | 🐛 146 | 🌐 Java | 📅 2026-08-15 — Type-based null-pointer checker with low build-time overhead; an [Error Prone](http://errorprone.info/) plugin.

* [Dataflow Framework](https://github.com/typetools/checker-framework) ⭐ 1,146 | 🐛 447 | 🌐 Java | 📅 2026-08-14 — An industrial-strength dataflow framework for Java. The Dataflow Framework is used in the Checker Framework, Google’s Error Prone, Uber’s NullAway, Meta’s Nullsafe, and in other contexts. It is distributed with the Checker Framework.

* [RefactorFirst](https://github.com/jimbethancourt/RefactorFirst) ⭐ 542 | 🐛 57 | 🌐 Java | 📅 2026-07-13 — Identifies and prioritizes God Classes and Highly Coupled classes in Java codebases you should refactor first.

* [ck](https://github.com/mauricioaniche/ck) ⭐ 455 | 🐛 33 | 🌐 Java | 📅 2026-04-29 — Calculates Chidamber and Kemerer object-oriented metrics by processing the source Java files.

* [forbidden-apis](https://github.com/policeman-tools/forbidden-apis) ⭐ 372 | 🐛 31 | 🌐 Java | 📅 2026-07-03 — Detects and forbids invocations of specific method/class/field (like reading from a text stream without a charset). Maven/Gradle/Ant compatible.

* [Violations Lib](https://github.com/tomasbjerre/violations-lib) ⭐ 160 | 🐛 10 | 🌐 Java | 📅 2026-03-28 — Java library for parsing report files from static code analysis. Used by a bunch of Jenkins, Maven and Gradle plugins.

* [JLiSA](https://github.com/lisa-analyzer/jlisa) ⭐ 31 | 🐛 28 | 🌐 Java | 📅 2026-08-14 — An abstract interpretation-based static analyzer for Java build upon the [LiSA](https://github.com/lisa-analyzer/lisa) ⭐ 83 | 🐛 34 | 🌐 Java | 📅 2026-08-14 framekwork.
...
* [jshint](https://jshint.com/about) [:information\_source:](https://github.com/analysis-tools-dev/static-analysis/issues/223) ⭐ 14,735 | 🐛 26 | 🌐 Rust | 📅 2026-06-10 — Detect errors and potential problems in JavaScript code and enforce your team's coding conventions.

* [xo](https://github.com/xojs/xo) ⭐ 7,993 | 🐛 3 | 🌐 TypeScript | 📅 2026-07-29 — Opinionated but configurable ESLint wrapper with lots of goodies included. Enforces strict and readable code.

* [JSLint](https://github.com/douglascrockford/JSLint) ⭐ 3,657 | 🐛 3 | 🌐 JavaScript | 📅 2026-08-02 [:information\_source:](https://github.com/analysis-tools-dev/static-analysis/issues/223) ⭐ 14,735 | 🐛 26 | 🌐 Rust | 📅 2026-06-10 — The JavaScript Code Quality Tool.
...
* [escomplex](https://github.com/jared-stilwell/escomplex) ⭐ 273 | 🐛 21 | 🌐 JavaScript | 📅 2023-12-12 — Software complexity analysis of JavaScript-family abstract syntax trees.
...
* [JET](https://github.com/aviatesk/JET.jl) ⭐ 878 | 🐛 84 | 🌐 Julia | 📅 2026-08-08 — Static type inference system to detect bugs and type instabilities.
...
* [luacheck](https://github.com/lunarmodules/luacheck) ⭐ 456 | 🐛 43 | 🌐 Lua | 📅 2026-07-31 — A tool for linting and static analysis of Lua code.

* [lualint](https://github.com/philips/lualint) ⭐ 86 | 🐛 4 | 🌐 Lua | 📅 2023-06-30 — lualint performs luac-based static analysis of global variable usage in Lua source code.
...
* **MISS\_HIT** :warning: — MISS\_HIT is a free, open-source code quality toolset for MATLAB, Simulink, and Octave. It includes MH Style (style checker and formatter), MH Metrics (complexity metrics), MH Lint (static analysis), MH Trace (requirements traceability), and MH Copyright (copyright management). Designed to work standalone without requiring MATLAB/Octave installation.
...
* [VeriFast](https://github.com/verifast/verifast) ⭐ 502 | 🐛 120 | 🌐 Rust | 📅 2026-05-10 — A tool for modular formal verification of correctness properties of single-threaded and multithreaded  C and Java programs annotated with preconditions and postconditions written in separation logic.  To express rich specifications, the programmer can define inductive datatypes,  primitive recursive pure functions over these datatypes, and abstract separation logic predicates.

* [Sys](https://github.com/PLSysSec/sys) ⭐ 239 | 🐛 13 | 🌐 LLVM | 📅 2022-03-14 — A static/symbolic Tool for finding bugs in (browser) code. It uses the LLVM AST to find bugs like uninitialized memory access.

<a name="php" />
<h2>PHP</h2>

* [churn-php](https://github.com/bmitch/churn-php) ⭐ 1,376 | 🐛 4 | 🌐 PHP | 📅 2025-12-31 — Helps discover good candidates for refactoring.

* [composer-dependency-analyser](https://github.com/shipmonk-rnd/composer-dependency-analyser) ⭐ 626 | 🐛 19 | 🌐 PHP | 📅 2026-08-11 — Fast detection of composer dependency issues.
...
* [PHP-Parser](https://github.com/nikic/PHP-Parser) ⭐ 17,452 | 🐛 72 | 🌐 PHP | 📅 2026-07-11 — A PHP parser written in PHP.

* [EasyCodingStandard](https://www.tomasvotruba.com/blog/2017/05/03/combine-power-of-php-code-sniffer-and-php-cs-fixer-in-3-lines) — Combine [PHP\_CodeSniffer](https://github.com/squizlabs/PHP_CodeSniffer) ⭐ 10,774 | 🐛 248 | 🌐 PHP | 📅 2024-04-01 and [PHP-CS-Fixer](https://github.com/FriendsOfPHP/PHP-CS-Fixer) ⭐ 13,548 | 🐛 92 | 🌐 PHP | 📅 2026-08-15.

* [larastan](https://github.com/larastan/larastan) ⭐ 6,484 | 🐛 144 | 🌐 PHP | 📅 2026-08-11 — Adds static analysis to Laravel improving developer productivity and code quality. It is a wrapper around PHPStan.

* [PHP Insights](https://github.com/nunomaduro/phpinsights) ⭐ 5,629 | 🐛 73 | 🌐 PHP | 📅 2026-08-04 — Instant PHP quality checks from your console. Analysis of code quality and coding style as well as overview of code architecture and its complexity.

* [phan](https://github.com/phan/phan/wiki) ⭐ 5,623 | 🐛 794 | 🌐 PHP | 📅 2026-08-09 — A modern static analyzer from etsy.

* [GrumPHP](https://github.com/phpro/grumphp) ⭐ 4,308 | 🐛 6 | 🌐 PHP | 📅 2026-08-11 — Checks code on every commit.

* [deptrac](https://github.com/sensiolabs-de/deptrac) ⭐ 2,991 | 🐛 37 | 🌐 PHP | 📅 2026-08-14 — Enforce rules for dependencies between software layers.

* [phpqa - jakzal](https://github.com/jakzal/phpqa) ⭐ 1,319 | 🐛 1 | 🌐 Dockerfile | 📅 2026-08-14 — Many tools for PHP static analysis in one container.

* [PHP Architecture Tester](https://github.com/carlosas/phpat) ⭐ 1,274 | 🐛 17 | 🌐 PHP | 📅 2026-08-10 — Easy to use architecture testing tool for PHP.

* [PHPArkitect](https://github.com/phparkitect/arkitect) ⭐ 924 | 🐛 38 | 🌐 PHP | 📅 2026-08-13 — PHPArkitect helps you to keep your PHP codebase coherent and solid, by permitting to add some architectural constraint check to your workflow. You can express the constraint that you want to enforce, in simple and readable PHP code.

* [phpmnd](https://github.com/povils/phpmnd) ⭐ 586 | 🐛 21 | 🌐 PHP | 📅 2026-02-25 — Helps to detect magic numbers.

* [dephpend](https://github.com/mihaeu/dephpend) ⭐ 532 | 🐛 5 | 🌐 PHP | 📅 2026-01-28 — Dependency analysis tool.

* [PHP Semantic Versioning Checker](https://github.com/tomzx/php-semver-checker) ⭐ 436 | 🐛 39 | 🌐 PHP | 📅 2026-02-05 — Suggests a next version according to semantic versioning.

* [deprecation-detector](https://github.com/sensiolabs-de/deprecation-detector) ⚠️ Archived — Finds usages of deprecated (Symfony) code.

* [Parse](https://github.com/psecio/parse) ⭐ 380 | 🐛 18 | 🌐 PHP | 📅 2018-08-07 — A Static Security Scanner.

* [Progpilot](https://github.com/designsecurity/progpilot) ⭐ 365 | 🐛 4 | 🌐 PHP | 📅 2025-08-17 — A static analysis tool for security purposes.

* [parallel-lint](https://github.com/php-parallel-lint/PHP-Parallel-Lint) ⭐ 356 | 🐛 30 | 🌐 PHP | 📅 2026-07-26 — This tool checks syntax of PHP files faster than serial check with a fancier output.

* [phpqa - jmolivas](https://github.com/jmolivas/phpqa) ⭐ 325 | 🐛 4 | 🌐 PHP | 📅 2017-12-07 — PHPQA all-in-one Analyzer CLI tool.

* [Tuli](https://github.com/ircmaxell/Tuli) ⭐ 169 | 🐛 7 | 🌐 PHP | 📅 2015-10-23 — A static analysis engine.

* [PHP Assumptions](https://github.com/rskuipers/php-assumptions) ⭐ 164 | 🐛 9 | 🌐 PHP | 📅 2025-03-22 — Checks for weak assumptions.

* [Reflection](https://github.com/phpDocumentor/Reflection) ⭐ 125 | 🐛 8 | 🌐 PHP | 📅 2026-08-10 — Reflection library to do Static Analysis for PHP Projects

* [twig-lint](https://github.com/asm89/twig-lint) ⭐ 118 | 🐛 14 | 🌐 PHP | 📅 2021-11-19 — twig-lint is a lint tool for your twig files.

* [DesignPatternDetector](https://github.com/Halleck45/DesignPatternDetector) ⭐ 116 | 🐛 6 | 🌐 PHP | 📅 2024-04-18 — Detection of design patterns in PHP code.

* [php-speller](https://github.com/mekras/php-speller) ⭐ 68 | 🐛 6 | 🌐 PHP | 📅 2024-07-20 — PHP spell check library.
...
* [zarn](https://github.com/htrgouvea/zarn) ⭐ 59 | 🐛 3 | 🌐 Perl | 📅 2026-08-10 — A lightweight static security analysis tool for modern Perl Apps

<a name="python" />
<h2>Python</h2>

* [pyright](https://github.com/Microsoft/pyright) ⭐ 15,587 | 🐛 321 | 🌐 Python | 📅 2026-08-14 — Static type checker for Python, created to address gaps in existing tools like mypy.

* [mypy](http://www.mypy-lang.org) — A static type checker that aims to combine the benefits of duck typing and static typing, frequently used with [MonkeyType](https://github.com/Instagram/MonkeyType) ⭐ 5,000 | 🐛 78 | 🌐 Python | 📅 2026-02-11.

* [vulture](https://github.com/jendrikseipp/vulture) ⭐ 4,766 | 🐛 66 | 🌐 Python | 📅 2026-04-30 — Find unused classes, functions and variables in Python code.

* [flake8](https://github.com/PyCQA/flake8) ⭐ 3,813 | 🐛 24 | 🌐 Python | 📅 2026-07-14 — A wrapper around `pyflakes`, `pycodestyle` and `mccabe`.

* [refurb](https://github.com/dosisod/refurb) ⭐ 2,534 | 🐛 31 | 🌐 Python | 📅 2026-04-03 — A tool for refurbishing and modernizing Python codebases. Refurb is heavily inspired by clippy, the built-in linter for Rust.

* [prospector](https://github.com/PyCQA/prospector) ⭐ 2,085 | 🐛 34 | 🌐 Python | 📅 2026-08-14 — A wrapper around `pylint`, `pep8`, `mccabe` and others.

* **xenon** :warning: — Monitor code complexity using [`radon`](https://github.com/rubik/radon) ⭐ 2,005 | 🐛 52 | 🌐 Python | 📅 2024-10-20.

* [pip-audit](https://github.com/pypa/pip-audit) ⭐ 1,345 | 🐛 70 | 🌐 Python | 📅 2026-08-12 — Tool for scanning Python packages for known vulnerabilities. Developed by the Python Packaging Authority (PyPA) and supported by Trail of Bits and Google. Scans Python environments and requirements files to identify vulnerable packages and suggests remediation. Supports GitHub Actions, pre-commit hooks, and multiple vulnerability service integrations.

* [wily](https://github.com/tonybaloney/wily) ⭐ 1,319 | 🐛 44 | 🌐 Python | 📅 2026-08-09 — A command-line tool for archiving, exploring and graphing the complexity of Python source code.

* [autoflake](https://github.com/PyCQA/autoflake) ⭐ 953 | 🐛 46 | 🌐 Python | 📅 2026-07-30 — Autoflake removes unused imports and unused variables from Python code.

* [bellybutton](https://github.com/hchasestevens/bellybutton) ⭐ 279 | 🐛 11 | 🌐 Python | 📅 2023-07-27 — A linting engine supporting custom project-specific rules.

* [pyroma](https://github.com/regebro/pyroma) ⭐ 234 | 🐛 1 | 🌐 Python | 📅 2026-06-14 — Rate how well a Python project complies with the best practices of the Python packaging ecosystem, and list issues that could be improved.

* [linty fresh](https://github.com/lyft/linty_fresh) ⭐ 185 | 🐛 9 | 🌐 Python | 📅 2023-06-23 — Parse lint errors and report them to Github as comments on a pull request.

* [Dlint](https://github.com/dlint-py/dlint) ⭐ 179 | 🐛 23 | 🌐 Python | 📅 2026-01-07 — A tool for ensuring Python code is secure.

* [Dodgy](https://github.com/landscapeio/dodgy) ⭐ 130 | 🐛 11 | 🌐 Python | 📅 2021-08-29 — Dodgy is a very basic tool to run against your codebase to search for "dodgy" looking values. It is a series of simple regular expressions designed to detect things such as accidental SCM diff checkins, or passwords or secret keys hard coded into files.

* [Pyra](https://github.com/spangea/Pyra) ⭐ 31 | 🐛 0 | 🌐 Python | 📅 2026-07-14 — Pyra is a high-level linter static analyzer for data science applications written in Python, that helps developers identify potential issues in their data science code written in Python, as an extension of [Lyra](https://github.com/caterinaurban/Lyra) ⭐ 31 | 🐛 2 | 🌐 Python | 📅 2025-08-18.
...
* [lintr](https://github.com/jimhester/lintr) ⭐ 1,292 | 🐛 302 | 🌐 R | 📅 2026-08-13 — Static Code Analysis for R.

* [R Language Server](https://github.com/REditorSupport/languageserver/) ⭐ 672 | 🐛 129 | 🌐 R | 📅 2026-08-15 — Provides code completion, refactoring, folding, diagnostics (with lintr), and more for R.

* [flowR](https://github.com/flowr-analysis/flowr) ⭐ 103 | 🐛 269 | 🌐 TypeScript | 📅 2026-08-14 — A [program slicer](https://github.com/flowr-analysis/flowr/wiki/Terminology#program-slice) ⭐ 103 | 🐛 269 | 🌐 TypeScript | 📅 2026-08-14 and [dataflow analyzer](https://en.wikipedia.org/wiki/Data-flow_analysis) for the [R](https://www.r-project.org/) programming language. Its slicer allows you to reduce a complicated program just to the parts related for a specific task (e.g., the generation of a single or collection of plots, a significance test, ...). The dataflow analysis provides you with a detailed view on the semantics of the R code which can greatly improve other analyses. To use *flowR*, check out the [Visual Studio Code extension](https://marketplace.visualstudio.com/items?itemName=code-inspect.vscode-flowr), the [RStudio Addin](https://github.com/flowr-analysis/rstudio-addin-flowr) ⭐ 5 | 🐛 17 | 🌐 R | 📅 2026-07-10, the [Docker image](https://hub.docker.com/r/eagleoutice/flowr), or the [R package](https://github.com/flowr-analysis/flowr-r-adapter) ⭐ 4 | 🐛 10 | 🌐 R | 📅 2026-08-01.

* [CodeDepends](https://github.com/duncantl/CodeDepends) ⭐ 93 | 🐛 24 | 🌐 R | 📅 2025-12-19 — Static Code Analysis for R.

* [cyclocomp](https://github.com/MangoTheCat/cyclocomp) ⭐ 48 | 🐛 11 | 🌐 R | 📅 2023-05-17 — Quantifies the cyclomatic complexity of R functions / expressions.
...
* [Regal](https://github.com/styrainc/regal) ⭐ 398 | 🐛 138 | 🌐 Go | 📅 2026-08-11 — Regal is a linter for the policy language Rego. Regal aims to catch bugs and mistakes in policy code, while at the same time helping people learn the language, best practices and idiomatic constructs.

<a name="ruby" />
<h2>Ruby</h2>

* [Bullet](https://github.com/flyerhzm/bullet) ⭐ 7,334 | 🐛 8 | 🌐 Ruby | 📅 2026-08-02 — Help to kill N+1 queries and unused eager loading.

* [reek](https://github.com/troessner/reek) ⭐ 4,130 | 🐛 55 | 🌐 Ruby | 📅 2026-08-14 — Code smell detector for Ruby.

* [rubycritic](https://github.com/whitesmith/rubycritic) ⭐ 3,499 | 🐛 36 | 🌐 Ruby | 📅 2026-06-24 — A Ruby code quality reporter.

* [Standard Ruby](https://github.com/testdouble/standard) ⭐ 2,919 | 🐛 44 | 🌐 Ruby | 📅 2026-08-10 — Ruby Style Guide, with linter & automatic code fixer

* [bundler-audit](https://github.com/rubysec/bundler-audit) ⭐ 2,758 | 🐛 50 | 🌐 Ruby | 📅 2026-08-14 — Audit Gemfile.lock for gems with security vulnerabilities reported in [Ruby Advisory Database](https://github.com/rubysec/ruby-advisory-db) ⭐ 1,070 | 🐛 10 | 🌐 Ruby | 📅 2026-08-14.

* [Active Record Doctor](https://github.com/gregnavis/active_record_doctor) ⭐ 1,916 | 🐛 31 | 🌐 Ruby | 📅 2026-07-09 — Identify database issues before they hit production.

* [Fasterer](https://github.com/DamirSvrtan/fasterer) ⭐ 1,822 | 🐛 10 | 🌐 Ruby | 📅 2024-06-14 — Common Ruby idioms checker.

* [Steep](https://github.com/soutaro/steep) ⭐ 1,488 | 🐛 229 | 🌐 Ruby | 📅 2026-08-13 — Gradual Typing for Ruby.

* [DatabaseConsistency](https://github.com/djezzzl/database_consistency) ⭐ 1,191 | 🐛 4 | 🌐 Ruby | 📅 2026-08-05 — The tool to avoid various issues due to inconsistencies and inefficiencies between a database schema and application models.

* [rufo](https://github.com/ruby-formatter/rufo) ⭐ 939 | 🐛 29 | 🌐 Ruby | 📅 2026-05-28 — An opinionated ruby formatter, intended to be used via the command line as a text-editor plugin, to autoformat files on save or on demand.

* [dawnscanner](https://github.com/thesp0nge/dawnscanner) ⭐ 749 | 🐛 24 | 🌐 Ruby | 📅 2024-03-02 — A static analysis security scanner for ruby written web applications. It supports Sinatra, Padrino and Ruby on Rails frameworks.

* [ERB Lint](https://github.com/Shopify/erb-lint) ⭐ 746 | 🐛 94 | 🌐 Ruby | 📅 2026-04-20 — Lint your ERB or HTML files

* [Rubrowser](https://github.com/blazeeboy/rubrowser) ⭐ 645 | 🐛 2 | 🌐 JavaScript | 📅 2023-08-19 — Ruby classes interactive dependency graph generator.

* [Skunk](https://github.com/fastruby/skunk) ⭐ 547 | 🐛 10 | 🌐 Ruby | 📅 2026-08-10 — A SkunkScore Calculator for Ruby Code -- Find the most complicated code without test coverage!

* [pelusa](https://github.com/codegram/pelusa) ⭐ 436 | 🐛 0 | 🌐 Ruby | 📅 2015-01-07 — Static analysis Lint-type tool to improve your OO Ruby code.

* [htmlbeautifier](https://github.com/threedaymonk/htmlbeautifier) ⭐ 374 | 🐛 18 | 🌐 Ruby | 📅 2024-02-13 — A normaliser/beautifier for HTML that also understands embedded Ruby. Ideal for tidying up Rails templates.

* [Roodi](https://github.com/roodi/roodi) ⭐ 278 | 🐛 2 | 🌐 Ruby | 📅 2021-02-11 — Roodi stands for Ruby Object Oriented Design Inferometer. It parses your Ruby code and warns you about design issues you have based on the checks that it has configured.

* [ERB::Formatter](https://github.com/nebulab/erb-formatter) ⭐ 196 | 🐛 32 | 🌐 Ruby | 📅 2025-06-19 — Format ERB files with speed and precision.

* [Fukuzatsu](https://github.com/CoralineAda/fukuzatsu) ⭐ 32 | 🐛 3 | 🌐 Ruby | 📅 2018-12-18 — A tool for measuring code complexity in Ruby class files. Its analysis generates scores based on cyclomatic complexity algorithms with no added "opinions".
...
* [kani](https://github.com/model-checking/kani) ⭐ 3,315 | 🐛 494 | 🌐 Rust | 📅 2026-08-14 — The Kani Rust Verifier is a bit-precise model checker for Rust.
...
* [cargo-expand](https://github.com/dtolnay/cargo-expand) ⭐ 3,120 | 🐛 10 | 🌐 Rust | 📅 2026-07-18 — Cargo subcommand to show result of macro expansion  and #\[derive] expansion applied to the current crate.  This is a wrapper around a more verbose compiler command.

* [cargo udeps](https://github.com/est31/cargo-udeps) ⭐ 2,127 | 🐛 43 | 🌐 Rust | 📅 2026-04-29 — Find unused dependencies in Cargo.toml. It either prints out a "unused crates" line listing the crates,  or it prints out a line saying that no crates were unused.

* [cargo-geiger](https://github.com/geiger-rs/cargo-geiger) ⭐ 1,644 | 🐛 58 | 🌐 Rust | 📅 2026-06-19 — A cargo plugin for analysing the usage of unsafe Rust code Provides statistical output to aid security auditing

* [cargo-audit](https://rustsec.org) — Audit Cargo.lock for crates with security vulnerabilities reported to the [RustSec Advisory Database](https://github.com/RustSec/advisory-db/) ⭐ 1,152 | 🐛 135 | 📅 2026-08-12.

* [cargo-show-asm](https://github.com/pacak/cargo-show-asm) ⭐ 971 | 🐛 26 | 🌐 Rust | 📅 2026-08-10 — cargo subcommand showing the assembly, LLVM-IR and MIR generated for Rust code

* [cargo-call-stack](https://github.com/japaric/cargo-call-stack) ⭐ 661 | 🐛 40 | 🌐 Rust | 📅 2024-10-28 — Whole program static stack analysis The tool produces the full call graph of a program as a dot file.

* [cargo-spellcheck](https://github.com/drahnr/cargo-spellcheck) ⭐ 362 | 🐛 57 | 🌐 Rust | 📅 2026-05-18 — Checks all your documentation for spelling and grammar mistakes  with hunspell (ready) and languagetool (preview)

* [cargo-breaking](https://github.com/iomentum/cargo-breaking) ⚠️ Archived — cargo-breaking compares a crate's public API between two different branches, shows what changed, and suggests the next version according to semver.
...
* [rustfmt](https://github.com/rust-lang/rustfmt) ⭐ 6,934 | 🐛 935 | 🌐 Rust | 📅 2026-08-14 — A tool for formatting Rust code according to style guidelines.

* [RustViz](https://github.com/rustviz/rustviz) ⭐ 2,847 | 🐛 39 | 🌐 Rust | 📅 2026-05-10 — RustViz is a tool that generates visualizations  from simple Rust programs to assist users in better  understanding the Rust Lifetime and Borrowing mechanism. It generates SVG files with graphical indicators that integrate  with mdbook to render visualizations of data-flow in Rust programs.
...
* [rustfix](https://github.com/rust-lang/rustfix) ⚠️ Archived — Read and apply the suggestions made by rustc (and third-party lints, like those offered by clippy).

* [rust-audit](https://github.com/Shnatsel/rust-audit) ⭐ 840 | 🐛 17 | 🌐 Rust | 📅 2026-07-24 — Audit Rust binaries for known bugs or security vulnerabilities. This works by embedding data about the dependency tree (Cargo.lock) in JSON format into a dedicated linker section of the compiled executable.

* [lockbud](https://github.com/BurtonQin/lockbud) ⭐ 589 | 🐛 28 | 🌐 Rust | 📅 2026-07-21 — Statically detects Rust deadlocks bugs. It currently detects two common kinds of deadlock bugs: doublelock and locks in conflicting order. It will print bugs in JSON format together with the source code location and an explanation of each bug.
...
* [sqlint](https://github.com/purcell/sqlint) ⭐ 440 | 🐛 0 | 🌐 Ruby | 📅 2026-06-19 — Simple SQL linter.

* [sleek](https://github.com/nrempel/sleek) ⭐ 280 | 🐛 21 | 🌐 TypeScript | 📅 2025-11-18 — Sleek is a CLI tool for formatting SQL.  It helps you maintain a consistent style across your SQL code, enhancing readability and productivity. The heavy lifting is done by the sqlformat crate.
...
* [pgspot](https://github.com/timescale/pgspot) ⭐ 147 | 🐛 9 | 🌐 Python | 📅 2026-08-15 — Spot vulnerabilities in postgres extension scripts. Finds unsafe search\_path usage and unsafe object creation in PostgreSQL extension scripts or any other PostgreSQL SQL code.
...
* [scapegoat](https://github.com/sksamuel/scapegoat) ⭐ 556 | 🐛 47 | 🌐 Scala | 📅 2026-08-08 — Scala compiler plugin for static code analysis.
...
* [shellharden](https://github.com/anordal/shellharden) ⭐ 4,796 | 🐛 10 | 🌐 Rust | 📅 2026-07-09 — A syntax highlighter and a tool to semi-automate the rewriting of scripts to ShellCheck conformance, mainly focused on quoting.

* [bashate](https://github.com/openstack/bashate) ⭐ 397 | 🐛 0 | 🌐 Python | 📅 2024-11-26 — Code style enforcement for bash programs. The output format aims to follow pycodestyle (pep8) default output format.

* [kmdr](https://github.com/ediardo/kmdr-cli) ⭐ 21 | 🐛 0 | 📅 2022-02-27 — CLI tool for learning commands from your terminal. kmdr delivers a break down of commands with every attribute explained.
...
* [SwiftFormat](https://github.com/nicklockwood/SwiftFormat) ⭐ 8,912 | 🐛 297 | 🌐 Swift | 📅 2026-08-15 — A library and command-line formatting tool for reformatting Swift code.
...
* [tclchecker](https://github.com/ActiveState/tdk/blob/master/docs/3.0/TDK_3.0_Checker.txt) ⭐ 85 | 🐛 5 | 🌐 Tcl | 📅 2024-05-17 — A static syntax analysis module (as part of [TDK](https://github.com/ActiveState/tdk) ⭐ 85 | 🐛 5 | 🌐 Tcl | 📅 2024-05-17).

<a name="typescript" />
<h2>TypeScript</h2>

* [TypeScript ESLint](https://github.com/typescript-eslint/typescript-eslint) ⭐ 16,358 | 🐛 279 | 🌐 TypeScript | 📅 2026-08-13 — TypeScript language extension for eslint.

* **tslint** :warning: — TSLint has been deprecated as of 2019. Please see [this issue](https://github.com/palantir/tslint/issues/4534) ⚠️ Archived for more details. `typescript-eslint` is now your best option for linting TypeScript.
  TSLint is an extensible static analysis tool that checks TypeScript code for readability, maintainability,  and functionality errors. It is widely supported across modern editors & build systems and can be customized  with your own lint rules, configurations, and formatters.

* [Angular ESLint](https://github.com/angular-eslint/angular-eslint#readme) ⭐ 1,782 | 🐛 46 | 🌐 TypeScript | 📅 2026-08-14 — Linter for Angular projects
...
* [svls](https://github.com/dalance/svls) ⭐ 583 | 🐛 26 | 🌐 Rust | 📅 2026-07-28 — A Language Server Protocol implementation for Verilog and SystemVerilog, including lint capabilities.

* [vscode-verilog-hdl-support](https://github.com/mshr-h/vscode-verilog-hdl-support) ⭐ 383 | 🐛 68 | 🌐 TypeScript | 📅 2026-08-14 — Verilog HDL/SystemVerilog/Bluespec SystemVerilog support for VS Code. Provides syntax highlighting and Linting support from Icarus Verilog, Vivado Logical Simulation, Modelsim and Verilator
...
* [wasm-language-tools](https://github.com/g-plane/wasm-language-tools) ⭐ 92 | 🐛 1 | 🌐 Rust | 📅 2026-08-15 — WebAssembly Language Tools aims to provide and improve the editing experience of WebAssembly Text Format. It also provides an out-of-the-box formatter (a.k.a. pretty printer) for WebAssembly Text Format.

## Multiple languages

* [trivy](https://github.com/aquasecurity/trivy) ⭐ 37,406 | 🐛 237 | 🌐 Go | 📅 2026-08-14 — A Simple and Comprehensive Vulnerability Scanner for Containers and other Artifacts, Suitable for CI. Trivy detects vulnerabilities of OS packages (Alpine, RHEL, CentOS, etc.) and application dependencies (Bundler, Composer, npm, yarn, etc.). Checks containers and filesystems.

* [ESLint](https://github.com/eslint/eslint) ⭐ 27,456 | 🐛 129 | 🌐 JavaScript | 📅 2026-08-13 — An extensible linter for JS, following the ECMAScript standard.

* [oxc](https://github.com/web-infra-dev/oxc) ⭐ 22,323 | 🐛 755 | 🌐 Rust | 📅 2026-08-15 — The Oxidation Compiler is creating a suite of high-performance tools for the JavaScript / TypeScript language re-written in Rust.

* [ale](https://github.com/w0rp/ale) ⭐ 14,013 | 🐛 595 | 🌐 Vim Script | 📅 2026-08-09 — Asynchronous Lint Engine for Vim and NeoVim with support for many languages.

* [codeql](https://github.com/github/codeql) ⭐ 9,942 | 🐛 1,440 | 🌐 CodeQL | 📅 2026-08-14 — Deep code analysis - semantic queries and dataflow for several languages with VSCode plugin support.

* [ThreatMapper](https://github.com/deepfence/ThreatMapper) ⭐ 5,310 | 🐛 144 | 🌐 TypeScript | 📅 2026-06-01 — Vulnerability Scanner and Risk Evaluation for containers, serverless and hosts at runtime. ThreatMapper generates runtime BOMs from dependencies and operating system packages, matches against multiple threat feeds, scans for unprotected secrets, and scores issues based on severity and risk-of-exploit.

* [ApplicationInspector](https://github.com/microsoft/ApplicationInspector) ⭐ 4,397 | 🐛 29 | 🌐 C# | 📅 2026-08-13 — Creates reports of over 400 rule patterns for feature detection (e.g. the use of cryptography or version control in apps).

* [ClassGraph](https://github.com/classgraph/classgraph) ⭐ 3,005 | 🐛 0 | 🌐 Java | 📅 2026-08-15 — A classpath and module path scanner for querying or visualizing class metadata or class relatedness.

* [Bearer](https://github.com/bearer/bearer) ⭐ 2,719 | 🐛 16 | 🌐 Go | 📅 2026-08-03 — Open-Source static code analysis tool to discover,  filter and prioritize security risks and vulnerabilities  leading to sensitive data exposures (PII, PHI, PD).  Highly configurable and easily extensible,  built for security and engineering teams.

* [Pronto](https://github.com/prontolabs/pronto) ⭐ 2,672 | 🐛 15 | 🌐 Ruby | 📅 2026-05-04 — Quick automated code review of your changes. Supports more than 40 runners for various languages, including Clang, Elixir, JavaScript, PHP, Ruby and more.

* [weggli](https://github.com/googleprojectzero/weggli) ⭐ 2,491 | 🐛 46 | 🌐 Rust | 📅 2024-07-12 — A fast and robust semantic search tool for C and C++ codebases. It is designed to help security researchers identify interesting functionality in large codebases.

* [lizard](https://github.com/terryyin/lizard) ⭐ 2,448 | 🐛 51 | 🌐 Python | 📅 2026-08-13 — Lizard is an extensible Cyclomatic Complexity Analyzer for many programming languages  including C/C++ (doesn't require all the header files or Java imports).  It also does copy-paste detection (code clone detection/code duplicate detection) and many other forms of static code analysis. Counts lines of code without comments, CCN (cyclomatic complexity number), token count of functions, parameter count of functions.
...
* [TscanCode](https://github.com/Tencent/TscanCode) ⭐ 2,114 | 🐛 57 | 🌐 C++ | 📅 2023-12-25 — A fast and accurate static analysis solution for C/C++, C#, Lua codes provided by Tencent. Using GPLv3 license.

* [dotnet-format](https://github.com/dotnet/format) ⭐ 1,945 | 🐛 195 | 📅 2026-08-10 — A code formatter for .NET. Preferences will be read from an `.editorconfig` file, if present, otherwise a default set of preferences will be used. At this time dotnet-format is able to format C# and Visual Basic projects with a subset of supported `.editorconfig` options.

* [Roslyn Analyzers](https://github.com/dotnet/roslyn-analyzers) ⭐ 1,672 | 🐛 1,064 | 📅 2026-08-10 — Roslyn-based implementation of FxCop analyzers.

* [Undebt](https://github.com/Yelp/undebt) ⚠️ Archived — Language-independent tool for massive, automatic, programmable refactoring based on simple pattern definitions.

* [DevSkim](https://github.com/microsoft/devskim) ⭐ 1,002 | 🐛 75 | 🌐 C# | 📅 2026-08-14 — Regex-based static analysis tool for Visual Studio, VS Code, and Sublime Text - C/C++, C#, PHP, ASP, Python, Ruby, Java, and others.

* [WALA](https://github.com/wala/WALA) ⭐ 866 | 🐛 152 | 🌐 Java | 📅 2026-08-14 — Static analysis capabilities for Java bytecode and related languages and for JavaScript.

* [Putout](https://github.com/coderaiser/putout) ⭐ 797 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-14 — Pluggable and configurable code transformer with built-in eslint, babel plugins support for js, jsx typescript, flow, markdown, yaml and json.

* [Skylos](https://github.com/duriantaco/skylos) ⭐ 537 | 🐛 8 | 🌐 Python | 📅 2026-08-15 — Dead code detection, security scanning, secrets detection, and code quality analysis for Python, TypeScript, and Go. Framework-aware analysis with 98% recall. Includes CI/CD GitHub Action, VS Code extension, and MCP server for AI agent integration.
...
* [todocheck](https://github.com/preslavmihaylov/todocheck) ⭐ 439 | 🐛 15 | 🌐 Go | 📅 2026-06-13 — Linter for integrating annotated TODOs with your issue trackers

* [callGraph](https://github.com/koknat/callGraph) ⭐ 339 | 🐛 6 | 🌐 Perl | 📅 2024-11-20 — Statically generates a call graph image and displays it on screen.
...
* [Rev-dep](https://github.com/jayu/rev-dep) ⭐ 252 | 🐛 3 | 🌐 Go | 📅 2026-08-07 — Dependency analysis and optimization toolkit for modern JavaScript and TypeScript projects. Trace imports, identify circular dependencies, find unused code, clean node modules.

* [diesel-guard](https://github.com/ayarotsky/diesel-guard) ⭐ 120 | 🐛 6 | 🌐 Rust | 📅 2026-08-10 — Linter for dangerous Postgres migration patterns in Diesel and SQLx. Prevents downtime caused by unsafe schema changes.

* [relint](https://github.com/codingjoe/relint) ⭐ 66 | 🐛 0 | 🌐 Python | 📅 2026-08-11 — A static file linter that allows you to write custom rules using regular expressions (RegEx).

* [OpenStaticAnalyzer](https://github.com/sed-inf-u-szeged/OpenStaticAnalyzer) ⭐ 53 | 🐛 2 | 🌐 C++ | 📅 2022-11-09 — OpenStaticAnalyzer is a source code analyzer tool, which can perform deep static analysis of the source code of complex systems.

* [BlockWatch](https://github.com/mennanov/blockwatch) ⭐ 29 | 🐛 25 | 🌐 Rust | 📅 2026-08-04 — A language-agnostic linter that keeps code, documentation, and configuration in sync and enforces strict formatting and validation rules.

* [PVS-Studio](https://pvs-studio.com) :copyright: — A ([conditionally free](https://pvs-studio.com/en/order/open-source-license) for FOSS and individual developers) static analysis of C, C++, C# and Java code. For advertising purposes [you can propose a large FOSS project for analysis by PVS employees](https://github.com/viva64/pvs-studio-check-list) ⭐ 29 | 🐛 0 | 📅 2023-12-08. Supports CWE mapping, OWASP ASVS, MISRA, AUTOSAR and SEI CERT coding standards.
...
* [packj](https://github.com/ossillate-inc/packj) ⭐ 691 | 🐛 13 | 🌐 Python | 📅 2026-04-12 — Packj (pronounced package) is a command line (CLI) tool to vet open-source software packages for "risky" attributes that make them vulnerable to supply chain attacks. This is the tool behind our large-scale security analysis platform Packj.dev that continuously vets packages and provides free reports.
...
* [angr](https://github.com/angr/angr) ⭐ 9,010 | 🐛 712 | 🌐 Python | 📅 2026-08-15 — Binary code analysis tool that also supports symbolic execution.

* [bloaty](https://github.com/google/bloaty) ⭐ 5,532 | 🐛 71 | 🌐 C++ | 📅 2026-05-31 — Ever wondered what's making your binary big? Bloaty McBloatface will show you a size profile of the binary so you can understand what's taking up space inside. Bloaty performs a deep analysis of the binary. Using custom ELF, DWARF, and Mach-O parsers,  Bloaty aims to accurately attribute every byte of the binary to the symbol or compileunit that produced it.  It will even disassemble the binary looking for references to anonymous data. F

* [Twiggy](https://github.com/rustwasm/twiggy) ⚠️ Archived — Analyzes a binary's call graph to profile code size. The goal is to slim down wasm binary size.

* [cwe\_checker](https://github.com/fkie-cad/cwe_checker) ⭐ 1,348 | 🐛 30 | 🌐 Rust | 📅 2026-07-24 — cwe\_checker finds vulnerable patterns in binary executables.

* [Manalyze](https://github.com/JusticeRage/Manalyze) ⭐ 1,131 | 🐛 6 | 🌐 YARA | 📅 2026-08-12 — A static analyzer, which checks portable executables for malicious content.

* [BinSkim](https://github.com/Microsoft/binskim) ⭐ 858 | 🐛 162 | 🌐 C# | 📅 2026-08-13 — A binary static analysis tool that provides security and correctness results for Windows portable executables.

* [rust-audit](https://github.com/Shnatsel/rust-audit) ⭐ 840 | 🐛 17 | 🌐 Rust | 📅 2026-07-24 — Audit Rust binaries for known bugs or security vulnerabilities. This works by embedding data about the dependency tree (Cargo.lock) in JSON format into a dedicated linker section of the compiled executable.

* [binbloom](https://github.com/quarkslab/binbloom) ⭐ 584 | 🐛 2 | 🌐 C | 📅 2024-06-06 — Analyzes a raw binary firmware and determines features like endianness or the loading address.  The tool is compatible with all architectures.
...
* [Nauz File Detector](https://github.com/horsicq/Nauz-File-Detector) ⭐ 581 | 🐛 2 | 🌐 C++ | 📅 2026-08-14 — Static Linker/Compiler/Tool detector for Windows, Linux and MacOS.

* [VMware chap](https://github.com/vmware/chap) ⭐ 392 | 🐛 8 | 🌐 C++ | 📅 2025-06-01 — chap analyzes un-instrumented ELF core files for leaks, memory growth, and corruption.  It is sufficiently reliable that it can be used in automation to catch leaks before  they are committed. As an interactive tool, it helps explain memory growth,  can identify some forms of corruption, and supplements a debugger  by giving the status of various memory locations.

* [Jakstab](https://github.com/jkinder/jakstab) ⭐ 165 | 🐛 3 | 🌐 Java | 📅 2019-12-10 — Jakstab is an Abstract Interpretation-based, integrated disassembly and static analysis framework for designing analyses on executables and recovering reliable control flow graphs.
...
* [checkmake](https://github.com/mrtazz/checkmake) ⭐ 1,211 | 🐛 37 | 🌐 Go | 📅 2026-08-05 — Linter / Analyzer for Makefiles.
...
* [CSScomb](https://github.com/csscomb/csscomb.js) ⭐ 3,330 | 🐛 109 | 🌐 JavaScript | 📅 2023-01-03 — A coding style formatter for CSS. Supports own configurations to make style sheets beautiful and consistent.

* [Specificity Graph](https://github.com/pocketjoso/specificity-graph) ⭐ 702 | 🐛 3 | 🌐 JavaScript | 📅 2016-04-16 — CSS Specificity Graph Generator.
...
* [gixy](https://github.com/yandex/gixy) ⭐ 8,564 | 🐛 60 | 🌐 Python | 📅 2024-07-28 — A tool to analyze Nginx configuration. The main goal is to prevent misconfiguration and automate flaw detection.

<a name="configmanagement" />
<h2>Configuration Management</h2>

* [tfsec](https://github.com/tfsec/tfsec) ⭐ 7,027 | 🐛 18 | 🌐 Go | 📅 2026-03-25 — Terraform static analysis tool that prevents potential security issues by checking cloud misconfigurations at build time and directly integrates with the HCL parser for better results. Checks for violations of AWS, Azure and GCP security best practice recommendations.

* [cfn-lint](https://github.com/awslabs/cfn-python-lint) ⭐ 2,639 | 🐛 77 | 🌐 Python | 📅 2026-08-14 — AWS Labs CloudFormation linter.

* [AWS CloudFormation Guard](https://github.com/aws-cloudformation/cloudformation-guard) ⭐ 1,385 | 🐛 52 | 🌐 Rust | 📅 2026-08-10 — Check local CloudFormation templates against policy-as-code rules  and generate rules from existing templates.

* [cfn\_nag](https://github.com/stelligent/cfn_nag) ⭐ 1,309 | 🐛 84 | 🌐 Ruby | 📅 2024-08-01 — A linter for AWS CloudFormation templates.

* [metadata-json-lint](https://github.com/voxpupuli/metadata-json-lint) ⭐ 31 | 🐛 10 | 🌐 Ruby | 📅 2026-08-13 — Tool to check the validity of Puppet metadata.json files.

* [terrascan](https://github.com/cesar-rodriguez/terrascan) ⭐ 3 | 🐛 0 | 📅 2025-11-20 — Collection of security and best practice tests for static code analysis of Terraform templates.

* [tflint](https://github.com/wata727/tflint) ⭐ 0 | 🐛 0 | 📅 2026-06-02 — A Terraform linter for detecting errors that can not be detected by `terraform plan`.
...
* [Grype](https://github.com/anchore/grype) ⭐ 12,739 | 🐛 400 | 🌐 Go | 📅 2026-08-14 — Vulnerability scanner for container images and filesystems. Developed by Anchore, it scans container images, directories, and archives for known vulnerabilities. Supports multiple image formats, SBOM integration, and VEX (Vulnerability Exploitability eXchange) for accurate vulnerability assessment. Works with various vulnerability databases and provides detailed reporting.

* [Haskell Dockerfile Linter](https://github.com/lukasmartinelli/hadolint) ⭐ 12,356 | 🐛 200 | 🌐 Haskell | 📅 2026-08-14 — A smarter Dockerfile linter that helps you build best practice Docker images.

* [clair](https://github.com/coreos/clair) ⭐ 11,047 | 🐛 59 | 🌐 Go | 📅 2026-08-11 — Vulnerability Static Analysis for Containers.

* [Dockle](https://github.com/goodwithtech/dockle) ⭐ 3,286 | 🐛 53 | 🌐 Go | 📅 2026-08-10 — Container Image Linter for Security helping build the Best-Practice Docker Image. Scans Docker images for security vulnerabilities and CIS Benchmark compliance. Checks for secrets, credential exposure, and security best practices. Provides multiple severity levels (FATAL, WARN, INFO) and supports various output formats for CI/CD integration.
...
* [deno\_lint](https://github.com/denoland/deno_lint) ⭐ 1,585 | 🐛 167 | 🌐 Rust | 📅 2026-07-23 — Official linter for Deno.
...
* [oelint-adv](https://github.com/priv-kweihmann/oelint-adv) ⭐ 86 | 🐛 5 | 🌐 Python | 📅 2026-08-11 — Linter for bitbake recipes used in open-embedded and YOCTO
...
* [gherkin-lint](https://github.com/vsiakka/gherkin-lint) ⭐ 200 | 🐛 78 | 🌐 JavaScript | 📅 2024-08-19 — A linter for the Gherkin-Syntax written in Javascript.

<a name="html" />
<h2>HTML</h2>

* **grunt-bootlint** :warning: — A Grunt wrapper for [Bootlint](https://github.com/twbs/bootlint) ⚠️ Archived, the HTML linter for Bootstrap projects.

* **gulp-bootlint** :warning: — A gulp wrapper for [Bootlint](https://github.com/twbs/bootlint) ⚠️ Archived, the HTML linter for Bootstrap projects.
...
* [kube-linter](https://github.com/stackrox/kube-linter) ⭐ 3,495 | 🐛 89 | 🌐 Go | 📅 2026-08-12 — KubeLinter is a static analysis tool that checks Kubernetes YAML files  and Helm charts to ensure the applications represented in them adhere to best practices.

* [kubeconform](https://github.com/yannh/kubeconform) ⭐ 3,148 | 🐛 88 | 🌐 Go | 📅 2026-06-13 — A fast Kubernetes manifests validator with support for custom resources.

* [chart-testing](https://github.com/helm/chart-testing) ⭐ 1,639 | 🐛 6 | 🌐 Go | 📅 2026-08-13 — ct is the tool for testing Helm charts.  It is meant to be used for linting and testing pull requests.  It automatically detects charts changed against the target branch.

* [clusterlint](https://github.com/digitalocean/clusterlint) ⭐ 597 | 🐛 11 | 🌐 Go | 📅 2026-07-13 — Clusterlint queries live Kubernetes clusters for resources, executes common and  platform specific checks against these resources and provides actionable feedback to cluster operators.  It is a non invasive tool that is run externally. Clusterlint does not alter the resource configurations.

* [kube-lint](https://github.com/viglesiasce/kube-lint) ⭐ 156 | 🐛 5 | 🌐 Go | 📅 2023-05-11 — A linter for Kubernetes resources with a customizable rule set. You define a list of rules that you would like to validate against your  resources and kube-lint will evaluate those rules against them.

* [klint](https://github.com/uswitch/klint) ⚠️ Archived — A tool that listens to changes in Kubernetes resources and runs linting rules against them. Identify and debug erroneous objects and nudge objects in line with the policies as both change over time. Klint helps us encode checks and proactively alert teams when they need to take action.
...
- [KubeLinter](https://github.com/stackrox/kube-linter) ⭐ 3,495 | 🐛 89 | 🌐 Go | 📅 2026-08-12 — KubeLinter is a static analysis tool that checks Kubernetes YAML files and Helm charts to ensure the applications represented in them adhere to best practices.
...
* [markdownlint](https://github.com/DavidAnson/markdownlint) ⭐ 6,278 | 🐛 81 | 🌐 JavaScript | 📅 2026-08-14 — Node.js -based style checker and lint tool for Markdown/CommonMark files.

* [mdl](https://github.com/mivok/markdownlint) ⭐ 2,069 | 🐛 107 | 🌐 Ruby | 📅 2026-08-09 — A tool to check Markdown files and flag style issues.

* [mdsf](https://github.com/hougesen/mdsf) ⭐ 109 | 🐛 33 | 🌐 Rust | 📅 2026-08-14 — Format markdown code blocks using your favorite code formatters.
...
* [FlowDroid](https://github.com/secure-software-engineering/FlowDroid) ⭐ 1,257 | 🐛 246 | 🌐 Java | 📅 2026-08-10 — Static taint analysis tool for Android applications.
...
* [statix](https://github.com/nerdypepper/statix) ⭐ 937 | 🐛 46 | 🌐 Rust | 📅 2026-07-26 — Lints and suggestions for the Nix programming language. "statix check" highlights antipatterns in Nix code. "statix fix" can fix several such occurrences.

* [deadnix](https://github.com/astro/deadnix) ⭐ 773 | 🐛 5 | 🌐 Rust | 📅 2026-07-26 — Scan Nix files for dead code (unused variable bindings)

<a name="nodejs" />
<h2>Node.js</h2>

* [lockfile-lint](https://github.com/lirantal/lockfile-lint) ⭐ 866 | 🐛 6 | 🌐 JavaScript | 📅 2026-08-13 — Lint an npm or yarn lockfile to analyze and detect security issues
...
* [rpmlint](https://github.com/rpm-software-management/rpmlint) ⭐ 162 | 🐛 89 | 🌐 Python | 📅 2026-08-11 — Tool for checking common errors in rpm packages.

<a name="prometheus" />
<h2>Prometheus</h2>

* [promformat](https://github.com/facetoe/promformat) ⭐ 38 | 🐛 0 | 🌐 Python | 📅 2026-02-19 — Promformat is a PromQL formatter written in Python.

* [promval](https://github.com/facetoe/promval) ⭐ 4 | 🐛 1 | 🌐 Python | 📅 2023-06-13 — PromQL validator written in Python. It can be used to validate that PromQL expressions are written as expected.
...
* [protolint](https://github.com/yoheimuta/protolint) ⭐ 696 | 🐛 60 | 🌐 Go | 📅 2026-08-14 — Pluggable linter and fixer to enforce Protocol Buffer style and conventions.
...
* [Gitleaks](https://github.com/zricethezav/gitleaks) ⭐ 28,727 | 🐛 462 | 🌐 Go | 📅 2026-07-29 — A SAST tool for detecting hardcoded secrets like passwords, api keys, and tokens in git repos.

* [Grype](https://github.com/anchore/grype) ⭐ 12,739 | 🐛 400 | 🌐 Go | 📅 2026-08-14 — Vulnerability scanner for container images and filesystems. Developed by Anchore, it scans container images, directories, and archives for known vulnerabilities. Supports multiple image formats, SBOM integration, and VEX (Vulnerability Exploitability eXchange) for accurate vulnerability assessment. Works with various vulnerability databases and provides detailed reporting.

* [detect-secrets](https://github.com/Yelp/detect-secrets) ⭐ 4,620 | 🐛 174 | 🌐 Python | 📅 2026-04-02 — An enterprise friendly way of detecting and preventing secrets in code.
...
* [Tsunami Security Scanner](https://github.com/google/tsunami-security-scanner) ⭐ 8,602 | 🐛 13 | 🌐 Java | 📅 2026-06-23 — A general purpose network security scanner with an extensible plugin system for  detecting high severity RCE-like vulnerabilities with high confidence. Custom detectors for finding vulnerabilities (e.g. open APIs) can be added.

* [tfsec](https://github.com/tfsec/tfsec) ⭐ 7,027 | 🐛 18 | 🌐 Go | 📅 2026-03-25 — Terraform static analysis tool that prevents potential security issues by checking cloud misconfigurations at build time and directly integrates with the HCL parser for better results. Checks for violations of AWS, Azure and GCP security best practice recommendations.

* [scorecard](https://github.com/ossf/scorecard) ⭐ 5,631 | 🐛 439 | 🌐 Go | 📅 2026-08-15 — Security Scorecards - Security health metrics for Open Source
...
* [slither](https://github.com/trailofbits/slither) ⭐ 6,345 | 🐛 470 | 🌐 Python | 📅 2026-08-12 — Static analysis framework that runs a suite of vulnerability detectors, prints visual information about contract details, and provides an API to easily write custom analyses.

* [mythril](https://github.com/ConsenSys/mythril) ⭐ 4,259 | 🐛 129 | 🌐 Python | 📅 2026-04-27 — A symbolic execution framework with batteries included, can be used to find and exploit vulnerabilities in smart contracts automatically.
...
* [LibVCS4j](https://github.com/uni-bremen-agst/libvcs4j) ⭐ 23 | 🐛 8 | 🌐 Java | 📅 2025-12-19 — A Java library that allows existing tools to analyse the evolution of software systems by providing a common API for different version control systems and issue trackers.

<a name="template" />
<h2>Template-Languages</h2>

* [haml-lint](https://github.com/sds/haml-lint) ⭐ 339 | 🐛 1 | 🌐 Ruby | 📅 2026-08-07 — Tool for writing clean and consistent HAML.

* [ember-template-lint](https://github.com/ember-template-lint/ember-template-lint) ⭐ 265 | 🐛 174 | 🌐 JavaScript | 📅 2025-12-01 — Linter for Ember or Handlebars templates.

* [slim-lint](https://github.com/sds/slim-lint) ⭐ 235 | 🐛 21 | 🌐 Ruby | 📅 2026-08-12 — Configurable tool for analyzing Slim templates.
...
* [dennis](https://github.com/willkg/dennis) ⭐ 51 | 🐛 20 | 🌐 Python | 📅 2026-08-01 — A set of utilities for working with PO files to ease development and improve quality.
...
* [proselint](https://github.com/amperser/proselint) ⭐ 4,563 | 🐛 236 | 🌐 JavaScript | 📅 2026-08-14 — A linter for English prose with a focus on writing style instead of grammar.

* [codespell](https://github.com/codespell-project/codespell) ⭐ 2,415 | 🐛 263 | 🌐 Python | 📅 2026-08-10 — Check code for common misspellings.

* [misspell-fixer](https://github.com/vlajos/misspell-fixer) ⭐ 195 | 🐛 3 | 🌐 sed | 📅 2025-09-19 — Quick tool for fixing common misspellings, typos in source code.
...
* [go-tools](https://github.com/dominikh/go-tools) ⭐ 6,849 | 🐛 575 | 🌐 Go | 📅 2026-06-30 — A collection of tools and libraries for working with Go code, including linters and static analysis
...
* [linters](https://github.com/mcandre/linters) ⭐ 350 | 🐛 59 | 📅 2026-03-17 — An introduction to static code analysis
