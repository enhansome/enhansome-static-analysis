...
[![CI](https://github.com/analysis-tools-dev/static-analysis/workflows/CI/badge.svg)](https://github.com/analysis-tools-dev/static-analysis/actions/workflows/ci.yml) ⭐ 14,780 | 🐛 12 | 🌐 Rust | 📅 2026-09-14
[![Links](https://github.com/analysis-tools-dev/static-analysis/actions/workflows/links.yml/badge.svg)](https://github.com/analysis-tools-dev/static-analysis/actions/workflows/links.yml) ⭐ 14,780 | 🐛 12 | 🌐 Rust | 📅 2026-09-14
...
* [cpplint](https://github.com/cpplint/cpplint) ⭐ 1,851 | 🐛 85 | 🌐 Python | 📅 2026-09-07 — Automated C++ checker that follows Google's style guide.
...
* [ArchUnitNET](https://github.com/TNG/ArchUnitNET) ⭐ 1,360 | 🐛 36 | 🌐 C# | 📅 2026-09-15 — A C# architecture test library to specify and assert architecture rules in C# for automated testing.

* [Meziantou.Analyzer](https://github.com/meziantou/Meziantou.Analyzer) ⭐ 1,195 | 🐛 2 | 🌐 C# | 📅 2026-09-15 — A Roslyn analyzer to enforce some good practices in C# in terms of design, usage, security, performance, and style.

* [SonarAnalyzer.CSharp](https://github.com/SonarSource/sonar-dotnet) ⭐ 918 | 🐛 249 | 🌐 C# | 📅 2026-09-15 — These Roslyn analyzers allow you to produce Clean Code that is safe, reliable, and maintainable by helping you find and correct bugs, vulnerabilities, and code smells in your codebase.
...
* [SonarDelphi](https://github.com/integrated-application-development/sonar-delphi) ⭐ 159 | 🐛 41 | 🌐 Java | 📅 2026-09-11 — Delphi static analyzer for the SonarQube code quality platform.
...
* [credo](https://github.com/rrrene/credo) ⭐ 5,221 | 🐛 40 | 🌐 Elixir | 📅 2026-08-26 — A static code analysis tool with a focus on code consistency and teaching.
...
* [Reviewdog](https://github.com/haya14busa/reviewdog) ⭐ 9,588 | 🐛 131 | 🌐 Go | 📅 2026-09-15 — A tool for posting review comments from any linter in any code hosting service.

* [gofumpt](https://github.com/mvdan/gofumpt) ⭐ 4,084 | 🐛 13 | 🌐 Go | 📅 2026-09-07 — Enforce a stricter format than `gofmt`, while being backwards-compatible.  That is, `gofumpt` is happy with a subset of the formats that `gofmt` is happy with.
...
* [HLint](https://github.com/ndmitchell/hlint) ⭐ 1,611 | 🐛 313 | 🌐 Haskell | 📅 2026-09-14 — HLint is a tool for suggesting possible improvements to Haskell code.

* [Weeder](https://github.com/ocharles/weeder) ⭐ 188 | 🐛 39 | 🌐 Haskell | 📅 2026-09-15 — A tool for detecting dead exports or package imports in Haskell code.
...
* [google-java-format](https://github.com/google/google-java-format) ⭐ 6,192 | 🐛 180 | 🌐 Java | 📅 2026-09-10 — Reformats Java source code to comply with Google Java Style

* [NullAway](https://github.com/uber/NullAway) ⭐ 4,104 | 🐛 161 | 🌐 Java | 📅 2026-09-15 — Type-based null-pointer checker with low build-time overhead; an [Error Prone](http://errorprone.info/) plugin.

* [Dataflow Framework](https://github.com/typetools/checker-framework) ⭐ 1,149 | 🐛 425 | 🌐 Java | 📅 2026-09-15 — An industrial-strength dataflow framework for Java. The Dataflow Framework is used in the Checker Framework, Google’s Error Prone, Uber’s NullAway, Meta’s Nullsafe, and in other contexts. It is distributed with the Checker Framework.

* [RefactorFirst](https://github.com/jimbethancourt/RefactorFirst) ⭐ 545 | 🐛 58 | 🌐 Java | 📅 2026-09-15 — Identifies and prioritizes God Classes and Highly Coupled classes in Java codebases you should refactor first.
...
* **jshint** [:information\_source:](https://github.com/analysis-tools-dev/static-analysis/issues/223) ⭐ 14,780 | 🐛 12 | 🌐 Rust | 📅 2026-09-14 :warning: — Detect errors and potential problems in JavaScript code and enforce your team's coding conventions.

* [xo](https://github.com/xojs/xo) ⭐ 7,989 | 🐛 4 | 🌐 TypeScript | 📅 2026-07-29 — Opinionated but configurable ESLint wrapper with lots of goodies included. Enforces strict and readable code.

* [JSLint](https://github.com/douglascrockford/JSLint) ⭐ 3,653 | 🐛 4 | 🌐 JavaScript | 📅 2026-09-13 [:information\_source:](https://github.com/analysis-tools-dev/static-analysis/issues/223) ⭐ 14,780 | 🐛 12 | 🌐 Rust | 📅 2026-09-14 — The JavaScript Code Quality Tool.
...
* [JET](https://github.com/aviatesk/JET.jl) ⭐ 882 | 🐛 87 | 🌐 Julia | 📅 2026-09-14 — Static type inference system to detect bugs and type instabilities.
...
* [PHP-Parser](https://github.com/nikic/PHP-Parser) ⭐ 17,466 | 🐛 69 | 🌐 PHP | 📅 2026-09-14 — A PHP parser written in PHP.

* [EasyCodingStandard](https://www.tomasvotruba.com/blog/2017/05/03/combine-power-of-php-code-sniffer-and-php-cs-fixer-in-3-lines) — Combine [PHP\_CodeSniffer](https://github.com/squizlabs/PHP_CodeSniffer) ⭐ 10,777 | 🐛 248 | 🌐 PHP | 📅 2024-04-01 and [PHP-CS-Fixer](https://github.com/FriendsOfPHP/PHP-CS-Fixer) ⭐ 13,550 | 🐛 87 | 🌐 PHP | 📅 2026-09-14.

* [larastan](https://github.com/larastan/larastan) ⭐ 6,501 | 🐛 90 | 🌐 PHP | 📅 2026-09-14 — Adds static analysis to Laravel improving developer productivity and code quality. It is a wrapper around PHPStan.
...
* [deptrac](https://github.com/sensiolabs-de/deptrac) ⭐ 3,016 | 🐛 37 | 🌐 PHP | 📅 2026-09-15 — Enforce rules for dependencies between software layers.
...
* [PHP Architecture Tester](https://github.com/carlosas/phpat) ⭐ 1,278 | 🐛 16 | 🌐 PHP | 📅 2026-09-15 — Easy to use architecture testing tool for PHP.

* [PHPArkitect](https://github.com/phparkitect/arkitect) ⭐ 930 | 🐛 38 | 🌐 PHP | 📅 2026-09-15 — PHPArkitect helps you to keep your PHP codebase coherent and solid, by permitting to add some architectural constraint check to your workflow. You can express the constraint that you want to enforce, in simple and readable PHP code.
...
* [zarn](https://github.com/htrgouvea/zarn) ⭐ 60 | 🐛 3 | 🌐 Perl | 📅 2026-09-14 — A lightweight static security analysis tool for modern Perl Apps
...
* [pyright](https://github.com/Microsoft/pyright) ⭐ 15,644 | 🐛 337 | 🌐 Python | 📅 2026-09-15 — Static type checker for Python, created to address gaps in existing tools like mypy.
...
* [vulture](https://github.com/jendrikseipp/vulture) ⭐ 4,810 | 🐛 71 | 🌐 Python | 📅 2026-04-30 — Find unused classes, functions and variables in Python code.
...
* [prospector](https://github.com/PyCQA/prospector) ⭐ 2,084 | 🐛 32 | 🌐 Python | 📅 2026-09-14 — A wrapper around `pylint`, `pep8`, `mccabe` and others.
...
* [Standard Ruby](https://github.com/testdouble/standard) ⭐ 2,922 | 🐛 45 | 🌐 Ruby | 📅 2026-09-14 — Ruby Style Guide, with linter & automatic code fixer

* [bundler-audit](https://github.com/rubysec/bundler-audit) ⭐ 2,757 | 🐛 48 | 🌐 Ruby | 📅 2026-09-12 — Audit Gemfile.lock for gems with security vulnerabilities reported in [Ruby Advisory Database](https://github.com/rubysec/ruby-advisory-db) ⭐ 1,072 | 🐛 3 | 🌐 Ruby | 📅 2026-09-13.
...
* [Steep](https://github.com/soutaro/steep) ⭐ 1,490 | 🐛 223 | 🌐 Ruby | 📅 2026-09-15 — Gradual Typing for Ruby.

* [DatabaseConsistency](https://github.com/djezzzl/database_consistency) ⭐ 1,192 | 🐛 4 | 🌐 Ruby | 📅 2026-09-15 — The tool to avoid various issues due to inconsistencies and inefficiencies between a database schema and application models.
...
* [kani](https://github.com/model-checking/kani) ⭐ 3,412 | 🐛 491 | 🌐 Rust | 📅 2026-09-14 — The Kani Rust Verifier is a bit-precise model checker for Rust.
...
* [cargo udeps](https://github.com/est31/cargo-udeps) ⭐ 2,135 | 🐛 44 | 🌐 Rust | 📅 2026-04-29 — Find unused dependencies in Cargo.toml. It either prints out a "unused crates" line listing the crates,  or it prints out a line saying that no crates were unused.
...
* [rustfmt](https://github.com/rust-lang/rustfmt) ⭐ 6,963 | 🐛 947 | 🌐 Rust | 📅 2026-09-10 — A tool for formatting Rust code according to style guidelines.
...
* [rust-audit](https://github.com/Shnatsel/rust-audit) ⭐ 853 | 🐛 17 | 🌐 Rust | 📅 2026-09-13 — Audit Rust binaries for known bugs or security vulnerabilities. This works by embedding data about the dependency tree (Cargo.lock) in JSON format into a dedicated linker section of the compiled executable.
...
* [scythe](https://github.com/Goldziher/scythe) ⭐ 69 | 🐛 2 | 🌐 Rust | 📅 2026-09-15 — Polyglot SQL compiler and linter that generates type-safe code from SQL with schema-aware linting.
...
* [SwiftFormat](https://github.com/nicklockwood/SwiftFormat) ⭐ 8,928 | 🐛 292 | 🌐 Swift | 📅 2026-09-09 — A library and command-line formatting tool for reformatting Swift code.
...
* [TypeScript ESLint](https://github.com/typescript-eslint/typescript-eslint) ⭐ 16,391 | 🐛 242 | 🌐 TypeScript | 📅 2026-09-15 — TypeScript language extension for eslint.
...
* [Angular ESLint](https://github.com/angular-eslint/angular-eslint#readme) ⭐ 1,783 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-14 — Linter for Angular projects
...
* [vscode-verilog-hdl-support](https://github.com/mshr-h/vscode-verilog-hdl-support) ⭐ 387 | 🐛 68 | 🌐 TypeScript | 📅 2026-09-14 — Verilog HDL/SystemVerilog/Bluespec SystemVerilog support for VS Code. Provides syntax highlighting and Linting support from Icarus Verilog, Vivado Logical Simulation, Modelsim and Verilator
...
* [wasm-language-tools](https://github.com/g-plane/wasm-language-tools) ⭐ 94 | 🐛 2 | 🌐 Rust | 📅 2026-09-15 — WebAssembly Language Tools aims to provide and improve the editing experience of WebAssembly Text Format. It also provides an out-of-the-box formatter (a.k.a. pretty printer) for WebAssembly Text Format.

## Multiple languages

* [trivy](https://github.com/aquasecurity/trivy) ⭐ 37,924 | 🐛 269 | 🌐 Go | 📅 2026-09-15 — A Simple and Comprehensive Vulnerability Scanner for Containers and other Artifacts, Suitable for CI. Trivy detects vulnerabilities of OS packages (Alpine, RHEL, CentOS, etc.) and application dependencies (Bundler, Composer, npm, yarn, etc.). Checks containers and filesystems.

* [ESLint](https://github.com/eslint/eslint) ⭐ 27,505 | 🐛 127 | 🌐 JavaScript | 📅 2026-09-14 — An extensible linter for JS, following the ECMAScript standard.

* [oxc](https://github.com/web-infra-dev/oxc) ⭐ 22,747 | 🐛 900 | 🌐 Rust | 📅 2026-09-15 — The Oxidation Compiler is creating a suite of high-performance tools for the JavaScript / TypeScript language re-written in Rust.
...
* [codeql](https://github.com/github/codeql) ⭐ 10,091 | 🐛 1,454 | 🌐 CodeQL | 📅 2026-09-15 — Deep code analysis - semantic queries and dataflow for several languages with VSCode plugin support.
...
* [ApplicationInspector](https://github.com/microsoft/ApplicationInspector) ⭐ 4,395 | 🐛 27 | 🌐 C# | 📅 2026-09-14 — Creates reports of over 400 rule patterns for feature detection (e.g. the use of cryptography or version control in apps).

* [sem](https://github.com/Ataraxy-Labs/sem) ⭐ 3,349 | 🐛 3 | 🌐 Rust | 📅 2026-09-13 — Semantic version control CLI that provides entity-level diffs, blame, and impact analysis on top of git. Uses tree-sitter to parse 26 languages and builds a cross-file dependency graph with structural hashing. Commands include sem diff, sem blame, sem graph, and sem impact for blast-radius analysis of code changes.
...
* [lizard](https://github.com/terryyin/lizard) ⭐ 2,505 | 🐛 25 | 🌐 Python | 📅 2026-09-09 — Lizard is an extensible Cyclomatic Complexity Analyzer for many programming languages  including C/C++ (doesn't require all the header files or Java imports).  It also does copy-paste detection (code clone detection/code duplicate detection) and many other forms of static code analysis. Counts lines of code without comments, CCN (cyclomatic complexity number), token count of functions, parameter count of functions.
...
* [Roslyn Analyzers](https://github.com/dotnet/roslyn-analyzers) ⭐ 1,671 | 🐛 1,058 | 📅 2026-09-14 — Roslyn-based implementation of FxCop analyzers.

* [weave](https://github.com/Ataraxy-Labs/weave) ⭐ 1,282 | 🐛 5 | 🌐 Rust | 📅 2026-09-13 — Entity-level semantic merge driver for git. Resolves false conflicts that line-based merge produces when independent changes touch the same file. Parses functions and classes via tree-sitter, matches by name, and merges at the entity level. Benchmarked at 100% clean merges vs git's 48% on a 31-scenario suite.
...
* [DevSkim](https://github.com/microsoft/devskim) ⭐ 1,005 | 🐛 79 | 🌐 C# | 📅 2026-09-14 — Regex-based static analysis tool for Visual Studio, VS Code, and Sublime Text - C/C++, C#, PHP, ASP, Python, Ruby, Java, and others.
...
* [Skylos](https://github.com/duriantaco/skylos) ⭐ 797 | 🐛 2 | 🌐 Python | 📅 2026-09-15 — Dead code detection, security scanning, secrets detection, and code quality analysis for Python, TypeScript, and Go. Framework-aware analysis with 98% recall. Includes CI/CD GitHub Action, VS Code extension, and MCP server for AI agent integration.

* [Putout](https://github.com/coderaiser/putout) ⭐ 795 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-15 — Pluggable and configurable code transformer with built-in eslint, babel plugins support for js, jsx typescript, flow, markdown, yaml and json.
...
* [nestjs-doctor](https://github.com/RoloBits/nestjs-doctor) ⭐ 163 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-14 — Static analysis tool for NestJS applications. Detects anti-patterns across security, performance, correctness, and architecture with 30+ built-in rules. Outputs a 0-100 health score. Includes module graph visualization, endpoint dependency graphs, and database schema analysis. CLI and VS Code extension.
...
* [relint](https://github.com/codingjoe/relint) ⭐ 66 | 🐛 0 | 🌐 Python | 📅 2026-09-15 — A static file linter that allows you to write custom rules using regular expressions (RegEx).
...
* [angr](https://github.com/angr/angr) ⭐ 9,089 | 🐛 732 | 🌐 Python | 📅 2026-09-15 — Binary code analysis tool that also supports symbolic execution.
...
* [BinSkim](https://github.com/Microsoft/binskim) ⭐ 860 | 🐛 148 | 🌐 C# | 📅 2026-09-15 — A binary static analysis tool that provides security and correctness results for Windows portable executables.

* [rust-audit](https://github.com/Shnatsel/rust-audit) ⭐ 853 | 🐛 17 | 🌐 Rust | 📅 2026-09-13 — Audit Rust binaries for known bugs or security vulnerabilities. This works by embedding data about the dependency tree (Cargo.lock) in JSON format into a dedicated linker section of the compiled executable.

* [Nauz File Detector](https://github.com/horsicq/Nauz-File-Detector) ⭐ 581 | 🐛 2 | 🌐 C++ | 📅 2026-09-14 — Static Linker/Compiler/Tool detector for Windows, Linux and MacOS.
...
* [cfn-lint](https://github.com/awslabs/cfn-python-lint) ⭐ 2,636 | 🐛 84 | 🌐 Python | 📅 2026-09-15 — AWS Labs CloudFormation linter.

* [AWS CloudFormation Guard](https://github.com/aws-cloudformation/cloudformation-guard) ⭐ 1,388 | 🐛 57 | 🌐 Rust | 📅 2026-09-14 — Check local CloudFormation templates against policy-as-code rules  and generate rules from existing templates.
...
* [Grype](https://github.com/anchore/grype) ⭐ 12,886 | 🐛 405 | 🌐 Go | 📅 2026-09-14 — Vulnerability scanner for container images and filesystems. Developed by Anchore, it scans container images, directories, and archives for known vulnerabilities. Supports multiple image formats, SBOM integration, and VEX (Vulnerability Exploitability eXchange) for accurate vulnerability assessment. Works with various vulnerability databases and provides detailed reporting.

* [Haskell Dockerfile Linter](https://github.com/lukasmartinelli/hadolint) ⭐ 12,404 | 🐛 207 | 🌐 Haskell | 📅 2026-08-24 — A smarter Dockerfile linter that helps you build best practice Docker images.
...
* [kube-linter](https://github.com/stackrox/kube-linter) ⭐ 3,507 | 🐛 90 | 🌐 Go | 📅 2026-09-15 — KubeLinter is a static analysis tool that checks Kubernetes YAML files  and Helm charts to ensure the applications represented in them adhere to best practices.
...
* [chart-testing](https://github.com/helm/chart-testing) ⭐ 1,639 | 🐛 3 | 🌐 Go | 📅 2026-09-15 — ct is the tool for testing Helm charts.  It is meant to be used for linting and testing pull requests.  It automatically detects charts changed against the target branch.
...
- [KubeLinter](https://github.com/stackrox/kube-linter) ⭐ 3,507 | 🐛 90 | 🌐 Go | 📅 2026-09-15 — KubeLinter is a static analysis tool that checks Kubernetes YAML files and Helm charts to ensure the applications represented in them adhere to best practices.
...
* [markdownlint](https://github.com/DavidAnson/markdownlint) ⭐ 6,342 | 🐛 80 | 🌐 JavaScript | 📅 2026-09-15 — Node.js -based style checker and lint tool for Markdown/CommonMark files.
...
* [FlowDroid](https://github.com/secure-software-engineering/FlowDroid) ⭐ 1,265 | 🐛 244 | 🌐 Java | 📅 2026-09-08 — Static taint analysis tool for Android applications.
...
* [rpmlint](https://github.com/rpm-software-management/rpmlint) ⭐ 165 | 🐛 87 | 🌐 Python | 📅 2026-09-15 — Tool for checking common errors in rpm packages.
...
* [Gitleaks](https://github.com/zricethezav/gitleaks) ⭐ 29,319 | 🐛 480 | 🌐 Go | 📅 2026-09-09 — A SAST tool for detecting hardcoded secrets like passwords, api keys, and tokens in git repos.
...
* [scorecard](https://github.com/ossf/scorecard) ⭐ 5,691 | 🐛 456 | 🌐 Go | 📅 2026-09-14 — Security Scorecards - Security health metrics for Open Source
...
* [slither](https://github.com/trailofbits/slither) ⭐ 6,362 | 🐛 478 | 🌐 Python | 📅 2026-09-09 — Static analysis framework that runs a suite of vulnerability detectors, prints visual information about contract details, and provides an API to easily write custom analyses.
...
* [codespell](https://github.com/codespell-project/codespell) ⭐ 2,425 | 🐛 270 | 🌐 Python | 📅 2026-09-15 — Check code for common misspellings.
...
* [go-tools](https://github.com/dominikh/go-tools) ⭐ 6,895 | 🐛 577 | 🌐 Go | 📅 2026-08-24 — A collection of tools and libraries for working with Go code, including linters and static analysis
