...
[![CI](https://github.com/analysis-tools-dev/static-analysis/workflows/CI/badge.svg)](https://github.com/analysis-tools-dev/static-analysis/actions/workflows/ci.yml) ⭐ 14,778 | 🐛 10 | 🌐 Rust | 📅 2026-09-09
[![Links](https://github.com/analysis-tools-dev/static-analysis/actions/workflows/links.yml/badge.svg)](https://github.com/analysis-tools-dev/static-analysis/actions/workflows/links.yml) ⭐ 14,778 | 🐛 10 | 🌐 Rust | 📅 2026-09-09
...
* [ArchUnitNET](https://github.com/TNG/ArchUnitNET) ⭐ 1,359 | 🐛 35 | 🌐 C# | 📅 2026-09-11 — A C# architecture test library to specify and assert architecture rules in C# for automated testing.

* [Meziantou.Analyzer](https://github.com/meziantou/Meziantou.Analyzer) ⭐ 1,191 | 🐛 3 | 🌐 C# | 📅 2026-09-11 — A Roslyn analyzer to enforce some good practices in C# in terms of design, usage, security, performance, and style.

* [SonarAnalyzer.CSharp](https://github.com/SonarSource/sonar-dotnet) ⭐ 918 | 🐛 249 | 🌐 C# | 📅 2026-09-11 — These Roslyn analyzers allow you to produce Clean Code that is safe, reliable, and maintainable by helping you find and correct bugs, vulnerabilities, and code smells in your codebase.
...
* [clj-kondo](https://github.com/borkdude/clj-kondo) ⭐ 1,853 | 🐛 156 | 🌐 Clojure | 📅 2026-09-10 — A linter for Clojure code that sparks joy. It informs you about potential errors while you are typing.
...
* [SonarDelphi](https://github.com/integrated-application-development/sonar-delphi) ⭐ 158 | 🐛 40 | 🌐 Java | 📅 2026-09-11 — Delphi static analyzer for the SonarQube code quality platform.
...
* [Reviewdog](https://github.com/haya14busa/reviewdog) ⭐ 9,579 | 🐛 141 | 🌐 Go | 📅 2026-09-11 — A tool for posting review comments from any linter in any code hosting service.
...
* [google-java-format](https://github.com/google/google-java-format) ⭐ 6,189 | 🐛 178 | 🌐 Java | 📅 2026-09-10 — Reformats Java source code to comply with Google Java Style

* [NullAway](https://github.com/uber/NullAway) ⭐ 4,105 | 🐛 159 | 🌐 Java | 📅 2026-09-10 — Type-based null-pointer checker with low build-time overhead; an [Error Prone](http://errorprone.info/) plugin.

* [Dataflow Framework](https://github.com/typetools/checker-framework) ⭐ 1,149 | 🐛 440 | 🌐 Java | 📅 2026-09-11 — An industrial-strength dataflow framework for Java. The Dataflow Framework is used in the Checker Framework, Google’s Error Prone, Uber’s NullAway, Meta’s Nullsafe, and in other contexts. It is distributed with the Checker Framework.
...
* [Violations Lib](https://github.com/tomasbjerre/violations-lib) ⭐ 161 | 🐛 12 | 🌐 Java | 📅 2026-03-28 — Java library for parsing report files from static code analysis. Used by a bunch of Jenkins, Maven and Gradle plugins.
...
* **jshint** [:information\_source:](https://github.com/analysis-tools-dev/static-analysis/issues/223) ⭐ 14,778 | 🐛 10 | 🌐 Rust | 📅 2026-09-09 :warning: — Detect errors and potential problems in JavaScript code and enforce your team's coding conventions.
...
* [JSLint](https://github.com/douglascrockford/JSLint) ⭐ 3,654 | 🐛 3 | 🌐 JavaScript | 📅 2026-09-04 [:information\_source:](https://github.com/analysis-tools-dev/static-analysis/issues/223) ⭐ 14,778 | 🐛 10 | 🌐 Rust | 📅 2026-09-09 — The JavaScript Code Quality Tool.
...
* [JET](https://github.com/aviatesk/JET.jl) ⭐ 882 | 🐛 86 | 🌐 Julia | 📅 2026-09-11 — Static type inference system to detect bugs and type instabilities.
...
* [phan](https://github.com/phan/phan/wiki) ⭐ 5,624 | 🐛 794 | 🌐 PHP | 📅 2026-09-05 — A modern static analyzer from etsy.

* [GrumPHP](https://github.com/phpro/grumphp) ⭐ 4,313 | 🐛 7 | 🌐 PHP | 📅 2026-09-08 — Checks code on every commit.

* [deptrac](https://github.com/sensiolabs-de/deptrac) ⭐ 3,013 | 🐛 37 | 🌐 PHP | 📅 2026-08-14 — Enforce rules for dependencies between software layers.
...
* [pyright](https://github.com/Microsoft/pyright) ⭐ 15,632 | 🐛 327 | 🌐 Python | 📅 2026-09-11 — Static type checker for Python, created to address gaps in existing tools like mypy.
...
* [vulture](https://github.com/jendrikseipp/vulture) ⭐ 4,807 | 🐛 71 | 🌐 Python | 📅 2026-04-30 — Find unused classes, functions and variables in Python code.
...
* [Regal](https://github.com/styrainc/regal) ⭐ 404 | 🐛 139 | 🌐 Go | 📅 2026-09-11 — Regal is a linter for the policy language Rego. Regal aims to catch bugs and mistakes in policy code, while at the same time helping people learn the language, best practices and idiomatic constructs.
...
* [bundler-audit](https://github.com/rubysec/bundler-audit) ⭐ 2,757 | 🐛 49 | 🌐 Ruby | 📅 2026-09-11 — Audit Gemfile.lock for gems with security vulnerabilities reported in [Ruby Advisory Database](https://github.com/rubysec/ruby-advisory-db) ⭐ 1,072 | 🐛 4 | 🌐 Ruby | 📅 2026-09-08.
...
* [Steep](https://github.com/soutaro/steep) ⭐ 1,489 | 🐛 223 | 🌐 Ruby | 📅 2026-09-11 — Gradual Typing for Ruby.

* [DatabaseConsistency](https://github.com/djezzzl/database_consistency) ⭐ 1,192 | 🐛 5 | 🌐 Ruby | 📅 2026-08-24 — The tool to avoid various issues due to inconsistencies and inefficiencies between a database schema and application models.
...
* [kani](https://github.com/model-checking/kani) ⭐ 3,405 | 🐛 486 | 🌐 Rust | 📅 2026-09-07 — The Kani Rust Verifier is a bit-precise model checker for Rust.
...
* [cargo-audit](https://rustsec.org) — Audit Cargo.lock for crates with security vulnerabilities reported to the [RustSec Advisory Database](https://github.com/RustSec/advisory-db/) ⭐ 1,174 | 🐛 144 | 📅 2026-09-09.

* [cargo-show-asm](https://github.com/pacak/cargo-show-asm) ⭐ 979 | 🐛 26 | 🌐 Rust | 📅 2026-09-10 — cargo subcommand showing the assembly, LLVM-IR and MIR generated for Rust code
...
* [rust-audit](https://github.com/Shnatsel/rust-audit) ⭐ 850 | 🐛 18 | 🌐 Rust | 📅 2026-09-02 — Audit Rust binaries for known bugs or security vulnerabilities. This works by embedding data about the dependency tree (Cargo.lock) in JSON format into a dedicated linker section of the compiled executable.
...
* [SwiftFormat](https://github.com/nicklockwood/SwiftFormat) ⭐ 8,925 | 🐛 292 | 🌐 Swift | 📅 2026-09-09 — A library and command-line formatting tool for reformatting Swift code.
...
* [TypeScript ESLint](https://github.com/typescript-eslint/typescript-eslint) ⭐ 16,387 | 🐛 276 | 🌐 TypeScript | 📅 2026-09-10 — TypeScript language extension for eslint.
...
* [Angular ESLint](https://github.com/angular-eslint/angular-eslint#readme) ⭐ 1,783 | 🐛 17 | 🌐 TypeScript | 📅 2026-09-11 — Linter for Angular projects
...
* [vscode-verilog-hdl-support](https://github.com/mshr-h/vscode-verilog-hdl-support) ⭐ 386 | 🐛 68 | 🌐 TypeScript | 📅 2026-09-10 — Verilog HDL/SystemVerilog/Bluespec SystemVerilog support for VS Code. Provides syntax highlighting and Linting support from Icarus Verilog, Vivado Logical Simulation, Modelsim and Verilator
...
* [wasm-language-tools](https://github.com/g-plane/wasm-language-tools) ⭐ 94 | 🐛 1 | 🌐 Rust | 📅 2026-09-11 — WebAssembly Language Tools aims to provide and improve the editing experience of WebAssembly Text Format. It also provides an out-of-the-box formatter (a.k.a. pretty printer) for WebAssembly Text Format.

## Multiple languages

* [trivy](https://github.com/aquasecurity/trivy) ⭐ 37,868 | 🐛 269 | 🌐 Go | 📅 2026-09-11 — A Simple and Comprehensive Vulnerability Scanner for Containers and other Artifacts, Suitable for CI. Trivy detects vulnerabilities of OS packages (Alpine, RHEL, CentOS, etc.) and application dependencies (Bundler, Composer, npm, yarn, etc.). Checks containers and filesystems.

* [ESLint](https://github.com/eslint/eslint) ⭐ 27,497 | 🐛 122 | 🌐 JavaScript | 📅 2026-09-11 — An extensible linter for JS, following the ECMAScript standard.

* [oxc](https://github.com/web-infra-dev/oxc) ⭐ 22,710 | 🐛 850 | 🌐 Rust | 📅 2026-09-11 — The Oxidation Compiler is creating a suite of high-performance tools for the JavaScript / TypeScript language re-written in Rust.
...
* [codeql](https://github.com/github/codeql) ⭐ 10,079 | 🐛 1,462 | 🌐 CodeQL | 📅 2026-09-11 — Deep code analysis - semantic queries and dataflow for several languages with VSCode plugin support.
...
* [ApplicationInspector](https://github.com/microsoft/ApplicationInspector) ⭐ 4,395 | 🐛 29 | 🌐 C# | 📅 2026-09-10 — Creates reports of over 400 rule patterns for feature detection (e.g. the use of cryptography or version control in apps).

* [sem](https://github.com/Ataraxy-Labs/sem) ⭐ 3,341 | 🐛 5 | 🌐 Rust | 📅 2026-09-10 — Semantic version control CLI that provides entity-level diffs, blame, and impact analysis on top of git. Uses tree-sitter to parse 26 languages and builds a cross-file dependency graph with structural hashing. Commands include sem diff, sem blame, sem graph, and sem impact for blast-radius analysis of code changes.

* [ClassGraph](https://github.com/classgraph/classgraph) ⭐ 3,008 | 🐛 2 | 🌐 Java | 📅 2026-09-08 — A classpath and module path scanner for querying or visualizing class metadata or class relatedness.
...
* [lizard](https://github.com/terryyin/lizard) ⭐ 2,498 | 🐛 25 | 🌐 Python | 📅 2026-09-09 — Lizard is an extensible Cyclomatic Complexity Analyzer for many programming languages  including C/C++ (doesn't require all the header files or Java imports).  It also does copy-paste detection (code clone detection/code duplicate detection) and many other forms of static code analysis. Counts lines of code without comments, CCN (cyclomatic complexity number), token count of functions, parameter count of functions.
...
* [weave](https://github.com/Ataraxy-Labs/weave) ⭐ 1,278 | 🐛 7 | 🌐 Rust | 📅 2026-09-10 — Entity-level semantic merge driver for git. Resolves false conflicts that line-based merge produces when independent changes touch the same file. Parses functions and classes via tree-sitter, matches by name, and merges at the entity level. Benchmarked at 100% clean merges vs git's 48% on a 31-scenario suite.

* [emerge](https://github.com/glato/emerge) ⭐ 1,147 | 🐛 19 | 🌐 Python | 📅 2026-08-07 — Emerge is a source code and dependency visualizer that can be used to gather insights about source code structure, metrics, dependencies and complexity of software projects. After scanning the source code of a project it provides you an interactive web interface to explore and analyze your project by using graph structures.

* [DevSkim](https://github.com/microsoft/devskim) ⭐ 1,005 | 🐛 79 | 🌐 C# | 📅 2026-09-11 — Regex-based static analysis tool for Visual Studio, VS Code, and Sublime Text - C/C++, C#, PHP, ASP, Python, Ruby, Java, and others.

* [WALA](https://github.com/wala/WALA) ⭐ 869 | 🐛 152 | 🌐 Java | 📅 2026-09-10 — Static analysis capabilities for Java bytecode and related languages and for JavaScript.
...
* [Rev-dep](https://github.com/jayu/rev-dep) ⭐ 256 | 🐛 1 | 🌐 Go | 📅 2026-08-07 — Dependency analysis and optimization toolkit for modern JavaScript and TypeScript projects. Trace imports, identify circular dependencies, find unused code, clean node modules.
...
* [nestjs-doctor](https://github.com/RoloBits/nestjs-doctor) ⭐ 162 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-09 — Static analysis tool for NestJS applications. Detects anti-patterns across security, performance, correctness, and architecture with 30+ built-in rules. Outputs a 0-100 health score. Includes module graph visualization, endpoint dependency graphs, and database schema analysis. CLI and VS Code extension.
...
* [BlockWatch](https://github.com/mennanov/blockwatch) ⭐ 29 | 🐛 5 | 🌐 Rust | 📅 2026-09-10 — A language-agnostic linter that keeps code, documentation, and configuration in sync and enforces strict formatting and validation rules.
...
* [packj](https://github.com/ossillate-inc/packj) ⭐ 691 | 🐛 13 | 🌐 Python | 📅 2026-09-09 — Packj (pronounced package) is a command line (CLI) tool to vet open-source software packages for "risky" attributes that make them vulnerable to supply chain attacks. This is the tool behind our large-scale security analysis platform Packj.dev that continuously vets packages and provides free reports.
...
* [angr](https://github.com/angr/angr) ⭐ 9,083 | 🐛 743 | 🌐 Python | 📅 2026-09-11 — Binary code analysis tool that also supports symbolic execution.

* [bloaty](https://github.com/google/bloaty) ⭐ 5,540 | 🐛 72 | 🌐 C++ | 📅 2026-09-10 — Ever wondered what's making your binary big? Bloaty McBloatface will show you a size profile of the binary so you can understand what's taking up space inside. Bloaty performs a deep analysis of the binary. Using custom ELF, DWARF, and Mach-O parsers,  Bloaty aims to accurately attribute every byte of the binary to the symbol or compileunit that produced it.  It will even disassemble the binary looking for references to anonymous data. F
...
* [Nauz File Detector](https://github.com/horsicq/Nauz-File-Detector) ⭐ 581 | 🐛 2 | 🌐 C++ | 📅 2026-09-10 — Static Linker/Compiler/Tool detector for Windows, Linux and MacOS.
...
* [checkmake](https://github.com/mrtazz/checkmake) ⭐ 1,213 | 🐛 41 | 🌐 Go | 📅 2026-09-09 — Linter / Analyzer for Makefiles.
...
* [cfn-lint](https://github.com/awslabs/cfn-python-lint) ⭐ 2,639 | 🐛 80 | 🌐 Python | 📅 2026-09-11 — AWS Labs CloudFormation linter.

* [AWS CloudFormation Guard](https://github.com/aws-cloudformation/cloudformation-guard) ⭐ 1,387 | 🐛 49 | 🌐 Rust | 📅 2026-09-11 — Check local CloudFormation templates against policy-as-code rules  and generate rules from existing templates.
...
* [Grype](https://github.com/anchore/grype) ⭐ 12,874 | 🐛 405 | 🌐 Go | 📅 2026-09-11 — Vulnerability scanner for container images and filesystems. Developed by Anchore, it scans container images, directories, and archives for known vulnerabilities. Supports multiple image formats, SBOM integration, and VEX (Vulnerability Exploitability eXchange) for accurate vulnerability assessment. Works with various vulnerability databases and provides detailed reporting.

* [Haskell Dockerfile Linter](https://github.com/lukasmartinelli/hadolint) ⭐ 12,398 | 🐛 207 | 🌐 Haskell | 📅 2026-08-24 — A smarter Dockerfile linter that helps you build best practice Docker images.
...
* [kube-linter](https://github.com/stackrox/kube-linter) ⭐ 3,504 | 🐛 95 | 🌐 Go | 📅 2026-09-11 — KubeLinter is a static analysis tool that checks Kubernetes YAML files  and Helm charts to ensure the applications represented in them adhere to best practices.
...
- [KubeLinter](https://github.com/stackrox/kube-linter) ⭐ 3,504 | 🐛 95 | 🌐 Go | 📅 2026-09-11 — KubeLinter is a static analysis tool that checks Kubernetes YAML files and Helm charts to ensure the applications represented in them adhere to best practices.
...
* [markdownlint](https://github.com/DavidAnson/markdownlint) ⭐ 6,335 | 🐛 82 | 🌐 JavaScript | 📅 2026-09-11 — Node.js -based style checker and lint tool for Markdown/CommonMark files.
...
* [rpmlint](https://github.com/rpm-software-management/rpmlint) ⭐ 163 | 🐛 90 | 🌐 Python | 📅 2026-09-11 — Tool for checking common errors in rpm packages.
...
* [protolint](https://github.com/yoheimuta/protolint) ⭐ 699 | 🐛 63 | 🌐 Go | 📅 2026-08-14 — Pluggable linter and fixer to enforce Protocol Buffer style and conventions.
...
* [Gitleaks](https://github.com/zricethezav/gitleaks) ⭐ 29,233 | 🐛 474 | 🌐 Go | 📅 2026-09-09 — A SAST tool for detecting hardcoded secrets like passwords, api keys, and tokens in git repos.

* [Grype](https://github.com/anchore/grype) ⭐ 12,874 | 🐛 405 | 🌐 Go | 📅 2026-09-11 — Vulnerability scanner for container images and filesystems. Developed by Anchore, it scans container images, directories, and archives for known vulnerabilities. Supports multiple image formats, SBOM integration, and VEX (Vulnerability Exploitability eXchange) for accurate vulnerability assessment. Works with various vulnerability databases and provides detailed reporting.

* [detect-secrets](https://github.com/Yelp/detect-secrets) ⭐ 4,633 | 🐛 178 | 🌐 Python | 📅 2026-04-02 — An enterprise friendly way of detecting and preventing secrets in code.
...
* [scorecard](https://github.com/ossf/scorecard) ⭐ 5,685 | 🐛 453 | 🌐 Go | 📅 2026-09-10 — Security Scorecards - Security health metrics for Open Source
...
* [codespell](https://github.com/codespell-project/codespell) ⭐ 2,424 | 🐛 275 | 🌐 Python | 📅 2026-09-08 — Check code for common misspellings.
...
* [go-tools](https://github.com/dominikh/go-tools) ⭐ 6,890 | 🐛 575 | 🌐 Go | 📅 2026-08-24 — A collection of tools and libraries for working with Go code, including linters and static analysis
