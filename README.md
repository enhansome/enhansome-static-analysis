...
[![CI](https://github.com/analysis-tools-dev/static-analysis/workflows/CI/badge.svg)](https://github.com/analysis-tools-dev/static-analysis/actions/workflows/ci.yml) ⭐ 14,780 | 🐛 10 | 🌐 Rust | 📅 2026-09-14
[![Links](https://github.com/analysis-tools-dev/static-analysis/actions/workflows/links.yml/badge.svg)](https://github.com/analysis-tools-dev/static-analysis/actions/workflows/links.yml) ⭐ 14,780 | 🐛 10 | 🌐 Rust | 📅 2026-09-14
...
Also check out the sister project, [awesome-dynamic-analysis](https://github.com/mre/awesome-dynamic-analysis) ⭐ 1,105 | 🐛 5 | 🌐 Markdown | 📅 2026-07-20.
...
* [cpplint](https://github.com/cpplint/cpplint) ⭐ 1,850 | 🐛 85 | 🌐 Python | 📅 2026-09-07 — Automated C++ checker that follows Google's style guide.
...
* [Roslynator](https://github.com/JosefPihrt/Roslynator) ⭐ 3,479 | 🐛 213 | 🌐 C# | 📅 2026-09-13 — A collection of 190+ analyzers and 190+ refactorings for C#, powered by Roslyn.

* [ArchUnitNET](https://github.com/TNG/ArchUnitNET) ⭐ 1,360 | 🐛 36 | 🌐 C# | 📅 2026-09-14 — A C# architecture test library to specify and assert architecture rules in C# for automated testing.

* [Meziantou.Analyzer](https://github.com/meziantou/Meziantou.Analyzer) ⭐ 1,194 | 🐛 1 | 🌐 C# | 📅 2026-09-13 — A Roslyn analyzer to enforce some good practices in C# in terms of design, usage, security, performance, and style.
...
* [credo](https://github.com/rrrene/credo) ⭐ 5,219 | 🐛 40 | 🌐 Elixir | 📅 2026-08-26 — A static code analysis tool with a focus on code consistency and teaching.
...
* [Reviewdog](https://github.com/haya14busa/reviewdog) ⭐ 9,588 | 🐛 134 | 🌐 Go | 📅 2026-09-14 — A tool for posting review comments from any linter in any code hosting service.

* [gofumpt](https://github.com/mvdan/gofumpt) ⭐ 4,082 | 🐛 13 | 🌐 Go | 📅 2026-09-07 — Enforce a stricter format than `gofmt`, while being backwards-compatible.  That is, `gofumpt` is happy with a subset of the formats that `gofmt` is happy with.
...
* [google-java-format](https://github.com/google/google-java-format) ⭐ 6,190 | 🐛 180 | 🌐 Java | 📅 2026-09-10 — Reformats Java source code to comply with Google Java Style

* [NullAway](https://github.com/uber/NullAway) ⭐ 4,104 | 🐛 161 | 🌐 Java | 📅 2026-09-10 — Type-based null-pointer checker with low build-time overhead; an [Error Prone](http://errorprone.info/) plugin.

* [Dataflow Framework](https://github.com/typetools/checker-framework) ⭐ 1,149 | 🐛 429 | 🌐 Java | 📅 2026-09-13 — An industrial-strength dataflow framework for Java. The Dataflow Framework is used in the Checker Framework, Google’s Error Prone, Uber’s NullAway, Meta’s Nullsafe, and in other contexts. It is distributed with the Checker Framework.

* [RefactorFirst](https://github.com/jimbethancourt/RefactorFirst) ⭐ 544 | 🐛 57 | 🌐 Java | 📅 2026-09-10 — Identifies and prioritizes God Classes and Highly Coupled classes in Java codebases you should refactor first.
...
* [Violations Lib](https://github.com/tomasbjerre/violations-lib) ⭐ 161 | 🐛 10 | 🌐 Java | 📅 2026-09-14 — Java library for parsing report files from static code analysis. Used by a bunch of Jenkins, Maven and Gradle plugins.

* [JLiSA](https://github.com/lisa-analyzer/jlisa) ⭐ 32 | 🐛 22 | 🌐 Java | 📅 2026-09-14 — An abstract interpretation-based static analyzer for Java build upon the [LiSA](https://github.com/lisa-analyzer/lisa) ⭐ 85 | 🐛 34 | 🌐 Java | 📅 2026-09-09 framekwork.
...
* **jshint** [:information\_source:](https://github.com/analysis-tools-dev/static-analysis/issues/223) ⭐ 14,780 | 🐛 10 | 🌐 Rust | 📅 2026-09-14 :warning: — Detect errors and potential problems in JavaScript code and enforce your team's coding conventions.

* [xo](https://github.com/xojs/xo) ⭐ 7,990 | 🐛 4 | 🌐 TypeScript | 📅 2026-07-29 — Opinionated but configurable ESLint wrapper with lots of goodies included. Enforces strict and readable code.

* [JSLint](https://github.com/douglascrockford/JSLint) ⭐ 3,653 | 🐛 4 | 🌐 JavaScript | 📅 2026-09-13 [:information\_source:](https://github.com/analysis-tools-dev/static-analysis/issues/223) ⭐ 14,780 | 🐛 10 | 🌐 Rust | 📅 2026-09-14 — The JavaScript Code Quality Tool.
...
* [PHP-Parser](https://github.com/nikic/PHP-Parser) ⭐ 17,467 | 🐛 70 | 🌐 PHP | 📅 2026-09-13 — A PHP parser written in PHP.

* [EasyCodingStandard](https://www.tomasvotruba.com/blog/2017/05/03/combine-power-of-php-code-sniffer-and-php-cs-fixer-in-3-lines) — Combine [PHP\_CodeSniffer](https://github.com/squizlabs/PHP_CodeSniffer) ⭐ 10,777 | 🐛 248 | 🌐 PHP | 📅 2024-04-01 and [PHP-CS-Fixer](https://github.com/FriendsOfPHP/PHP-CS-Fixer) ⭐ 13,550 | 🐛 88 | 🌐 PHP | 📅 2026-09-14.

* [larastan](https://github.com/larastan/larastan) ⭐ 6,500 | 🐛 90 | 🌐 PHP | 📅 2026-09-14 — Adds static analysis to Laravel improving developer productivity and code quality. It is a wrapper around PHPStan.
...
* [deptrac](https://github.com/sensiolabs-de/deptrac) ⭐ 3,016 | 🐛 37 | 🌐 PHP | 📅 2026-08-14 — Enforce rules for dependencies between software layers.

* [phpqa - jakzal](https://github.com/jakzal/phpqa) ⭐ 1,323 | 🐛 1 | 🌐 Dockerfile | 📅 2026-09-14 — Many tools for PHP static analysis in one container.

* [PHP Architecture Tester](https://github.com/carlosas/phpat) ⭐ 1,276 | 🐛 17 | 🌐 PHP | 📅 2026-09-14 — Easy to use architecture testing tool for PHP.
...
* [Reflection](https://github.com/phpDocumentor/Reflection) ⭐ 125 | 🐛 8 | 🌐 PHP | 📅 2026-09-14 — Reflection library to do Static Analysis for PHP Projects
...
* [zarn](https://github.com/htrgouvea/zarn) ⭐ 59 | 🐛 3 | 🌐 Perl | 📅 2026-09-14 — A lightweight static security analysis tool for modern Perl Apps
...
* [pyright](https://github.com/Microsoft/pyright) ⭐ 15,641 | 🐛 335 | 🌐 Python | 📅 2026-09-11 — Static type checker for Python, created to address gaps in existing tools like mypy.

* [mypy](http://www.mypy-lang.org) — A static type checker that aims to combine the benefits of duck typing and static typing, frequently used with [MonkeyType](https://github.com/Instagram/MonkeyType) ⭐ 5,002 | 🐛 78 | 🌐 Python | 📅 2026-02-11.
...
* [Bullet](https://github.com/flyerhzm/bullet) ⭐ 7,340 | 🐛 7 | 🌐 Ruby | 📅 2026-08-29 — Help to kill N+1 queries and unused eager loading.

* [reek](https://github.com/troessner/reek) ⭐ 4,128 | 🐛 55 | 🌐 Ruby | 📅 2026-08-28 — Code smell detector for Ruby.

* [rubycritic](https://github.com/whitesmith/rubycritic) ⭐ 3,502 | 🐛 36 | 🌐 Ruby | 📅 2026-06-24 — A Ruby code quality reporter.
...
* [bundler-audit](https://github.com/rubysec/bundler-audit) ⭐ 2,757 | 🐛 48 | 🌐 Ruby | 📅 2026-09-12 — Audit Gemfile.lock for gems with security vulnerabilities reported in [Ruby Advisory Database](https://github.com/rubysec/ruby-advisory-db) ⭐ 1,072 | 🐛 2 | 🌐 Ruby | 📅 2026-09-13.
...
* [Steep](https://github.com/soutaro/steep) ⭐ 1,490 | 🐛 223 | 🌐 Ruby | 📅 2026-09-14 — Gradual Typing for Ruby.
...
* [kani](https://github.com/model-checking/kani) ⭐ 3,411 | 🐛 488 | 🌐 Rust | 📅 2026-09-14 — The Kani Rust Verifier is a bit-precise model checker for Rust.
...
* [cargo udeps](https://github.com/est31/cargo-udeps) ⭐ 2,133 | 🐛 44 | 🌐 Rust | 📅 2026-04-29 — Find unused dependencies in Cargo.toml. It either prints out a "unused crates" line listing the crates,  or it prints out a line saying that no crates were unused.

* [cargo-geiger](https://github.com/geiger-rs/cargo-geiger) ⭐ 1,646 | 🐛 53 | 🌐 Rust | 📅 2026-09-14 — A cargo plugin for analysing the usage of unsafe Rust code Provides statistical output to aid security auditing

* [cargo-audit](https://rustsec.org) — Audit Cargo.lock for crates with security vulnerabilities reported to the [RustSec Advisory Database](https://github.com/RustSec/advisory-db/) ⭐ 1,177 | 🐛 147 | 📅 2026-09-14.

* [cargo-show-asm](https://github.com/pacak/cargo-show-asm) ⭐ 981 | 🐛 26 | 🌐 Rust | 📅 2026-09-11 — cargo subcommand showing the assembly, LLVM-IR and MIR generated for Rust code
...
* [rustfmt](https://github.com/rust-lang/rustfmt) ⭐ 6,963 | 🐛 944 | 🌐 Rust | 📅 2026-09-10 — A tool for formatting Rust code according to style guidelines.
...
* [rust-audit](https://github.com/Shnatsel/rust-audit) ⭐ 852 | 🐛 17 | 🌐 Rust | 📅 2026-09-13 — Audit Rust binaries for known bugs or security vulnerabilities. This works by embedding data about the dependency tree (Cargo.lock) in JSON format into a dedicated linker section of the compiled executable.

* [lockbud](https://github.com/BurtonQin/lockbud) ⭐ 591 | 🐛 28 | 🌐 Rust | 📅 2026-07-21 — Statically detects Rust deadlocks bugs. It currently detects two common kinds of deadlock bugs: doublelock and locks in conflicting order. It will print bugs in JSON format together with the source code location and an explanation of each bug.
...
* [scythe](https://github.com/Goldziher/scythe) ⭐ 69 | 🐛 2 | 🌐 Rust | 📅 2026-09-10 — Polyglot SQL compiler and linter that generates type-safe code from SQL with schema-aware linting.
...
* [SwiftFormat](https://github.com/nicklockwood/SwiftFormat) ⭐ 8,929 | 🐛 292 | 🌐 Swift | 📅 2026-09-09 — A library and command-line formatting tool for reformatting Swift code.
...
* [TypeScript ESLint](https://github.com/typescript-eslint/typescript-eslint) ⭐ 16,390 | 🐛 282 | 🌐 TypeScript | 📅 2026-09-11 — TypeScript language extension for eslint.
...
* [Angular ESLint](https://github.com/angular-eslint/angular-eslint#readme) ⭐ 1,783 | 🐛 13 | 🌐 TypeScript | 📅 2026-09-14 — Linter for Angular projects
...
* [wasm-language-tools](https://github.com/g-plane/wasm-language-tools) ⭐ 94 | 🐛 1 | 🌐 Rust | 📅 2026-09-14 — WebAssembly Language Tools aims to provide and improve the editing experience of WebAssembly Text Format. It also provides an out-of-the-box formatter (a.k.a. pretty printer) for WebAssembly Text Format.

## Multiple languages

* [trivy](https://github.com/aquasecurity/trivy) ⭐ 37,910 | 🐛 269 | 🌐 Go | 📅 2026-09-14 — A Simple and Comprehensive Vulnerability Scanner for Containers and other Artifacts, Suitable for CI. Trivy detects vulnerabilities of OS packages (Alpine, RHEL, CentOS, etc.) and application dependencies (Bundler, Composer, npm, yarn, etc.). Checks containers and filesystems.

* [ESLint](https://github.com/eslint/eslint) ⭐ 27,504 | 🐛 126 | 🌐 JavaScript | 📅 2026-09-14 — An extensible linter for JS, following the ECMAScript standard.

* [oxc](https://github.com/web-infra-dev/oxc) ⭐ 22,736 | 🐛 892 | 🌐 Rust | 📅 2026-09-14 — The Oxidation Compiler is creating a suite of high-performance tools for the JavaScript / TypeScript language re-written in Rust.
...
* [codeql](https://github.com/github/codeql) ⭐ 10,086 | 🐛 1,458 | 🌐 CodeQL | 📅 2026-09-14 — Deep code analysis - semantic queries and dataflow for several languages with VSCode plugin support.
...
* [sem](https://github.com/Ataraxy-Labs/sem) ⭐ 3,347 | 🐛 2 | 🌐 Rust | 📅 2026-09-13 — Semantic version control CLI that provides entity-level diffs, blame, and impact analysis on top of git. Uses tree-sitter to parse 26 languages and builds a cross-file dependency graph with structural hashing. Commands include sem diff, sem blame, sem graph, and sem impact for blast-radius analysis of code changes.

* [ClassGraph](https://github.com/classgraph/classgraph) ⭐ 3,011 | 🐛 2 | 🌐 Java | 📅 2026-09-08 — A classpath and module path scanner for querying or visualizing class metadata or class relatedness.

* [Bearer](https://github.com/bearer/bearer) ⭐ 2,744 | 🐛 25 | 🌐 Go | 📅 2026-09-14 — Open-Source static code analysis tool to discover,  filter and prioritize security risks and vulnerabilities  leading to sensitive data exposures (PII, PHI, PD).  Highly configurable and easily extensible,  built for security and engineering teams.
...
* [lizard](https://github.com/terryyin/lizard) ⭐ 2,502 | 🐛 25 | 🌐 Python | 📅 2026-09-09 — Lizard is an extensible Cyclomatic Complexity Analyzer for many programming languages  including C/C++ (doesn't require all the header files or Java imports).  It also does copy-paste detection (code clone detection/code duplicate detection) and many other forms of static code analysis. Counts lines of code without comments, CCN (cyclomatic complexity number), token count of functions, parameter count of functions.
...
* [dotnet-format](https://github.com/dotnet/format) ⭐ 1,944 | 🐛 198 | 📅 2026-09-14 — A code formatter for .NET. Preferences will be read from an `.editorconfig` file, if present, otherwise a default set of preferences will be used. At this time dotnet-format is able to format C# and Visual Basic projects with a subset of supported `.editorconfig` options.

* [Roslyn Analyzers](https://github.com/dotnet/roslyn-analyzers) ⭐ 1,670 | 🐛 1,058 | 📅 2026-09-14 — Roslyn-based implementation of FxCop analyzers.

* [weave](https://github.com/Ataraxy-Labs/weave) ⭐ 1,280 | 🐛 5 | 🌐 Rust | 📅 2026-09-13 — Entity-level semantic merge driver for git. Resolves false conflicts that line-based merge produces when independent changes touch the same file. Parses functions and classes via tree-sitter, matches by name, and merges at the entity level. Benchmarked at 100% clean merges vs git's 48% on a 31-scenario suite.
...
* [nestjs-doctor](https://github.com/RoloBits/nestjs-doctor) ⭐ 163 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-13 — Static analysis tool for NestJS applications. Detects anti-patterns across security, performance, correctness, and architecture with 30+ built-in rules. Outputs a 0-100 health score. Includes module graph visualization, endpoint dependency graphs, and database schema analysis. CLI and VS Code extension.
...
* [angr](https://github.com/angr/angr) ⭐ 9,088 | 🐛 734 | 🌐 Python | 📅 2026-09-14 — Binary code analysis tool that also supports symbolic execution.

* [bloaty](https://github.com/google/bloaty) ⭐ 5,542 | 🐛 72 | 🌐 C++ | 📅 2026-09-10 — Ever wondered what's making your binary big? Bloaty McBloatface will show you a size profile of the binary so you can understand what's taking up space inside. Bloaty performs a deep analysis of the binary. Using custom ELF, DWARF, and Mach-O parsers,  Bloaty aims to accurately attribute every byte of the binary to the symbol or compileunit that produced it.  It will even disassemble the binary looking for references to anonymous data. F
...
* [checkmake](https://github.com/mrtazz/checkmake) ⭐ 1,213 | 🐛 43 | 🌐 Go | 📅 2026-09-14 — Linter / Analyzer for Makefiles.
...
* [cfn-lint](https://github.com/awslabs/cfn-python-lint) ⭐ 2,636 | 🐛 84 | 🌐 Python | 📅 2026-09-12 — AWS Labs CloudFormation linter.
...
* [Grype](https://github.com/anchore/grype) ⭐ 12,878 | 🐛 409 | 🌐 Go | 📅 2026-09-11 — Vulnerability scanner for container images and filesystems. Developed by Anchore, it scans container images, directories, and archives for known vulnerabilities. Supports multiple image formats, SBOM integration, and VEX (Vulnerability Exploitability eXchange) for accurate vulnerability assessment. Works with various vulnerability databases and provides detailed reporting.

* [Haskell Dockerfile Linter](https://github.com/lukasmartinelli/hadolint) ⭐ 12,400 | 🐛 208 | 🌐 Haskell | 📅 2026-08-24 — A smarter Dockerfile linter that helps you build best practice Docker images.
...
* [krane](https://github.com/appvia/krane) ⭐ 745 | 🐛 36 | 🌐 Ruby | 📅 2026-09-14 — Krane is a simple Kubernetes RBAC static analysis tool.
...
* [oelint-adv](https://github.com/priv-kweihmann/oelint-adv) ⭐ 86 | 🐛 5 | 🌐 Python | 📅 2026-09-14 — Linter for bitbake recipes used in open-embedded and YOCTO
...
* [kube-linter](https://github.com/stackrox/kube-linter) ⭐ 3,506 | 🐛 93 | 🌐 Go | 📅 2026-09-14 — KubeLinter is a static analysis tool that checks Kubernetes YAML files  and Helm charts to ensure the applications represented in them adhere to best practices.

* [kubeconform](https://github.com/yannh/kubeconform) ⭐ 3,185 | 🐛 89 | 🌐 Go | 📅 2026-06-13 — A fast Kubernetes manifests validator with support for custom resources.
...
- [KubeLinter](https://github.com/stackrox/kube-linter) ⭐ 3,506 | 🐛 93 | 🌐 Go | 📅 2026-09-14 — KubeLinter is a static analysis tool that checks Kubernetes YAML files and Helm charts to ensure the applications represented in them adhere to best practices.
...
* [markdownlint](https://github.com/DavidAnson/markdownlint) ⭐ 6,342 | 🐛 79 | 🌐 JavaScript | 📅 2026-09-14 — Node.js -based style checker and lint tool for Markdown/CommonMark files.

* [mdl](https://github.com/mivok/markdownlint) ⭐ 2,076 | 🐛 109 | 🌐 Ruby | 📅 2026-09-07 — A tool to check Markdown files and flag style issues.
...
* [Gitleaks](https://github.com/zricethezav/gitleaks) ⭐ 29,298 | 🐛 474 | 🌐 Go | 📅 2026-09-09 — A SAST tool for detecting hardcoded secrets like passwords, api keys, and tokens in git repos.
...
* [Tsunami Security Scanner](https://github.com/google/tsunami-security-scanner) ⭐ 8,616 | 🐛 14 | 🌐 Java | 📅 2026-06-23 — A general purpose network security scanner with an extensible plugin system for  detecting high severity RCE-like vulnerabilities with high confidence. Custom detectors for finding vulnerabilities (e.g. open APIs) can be added.

* [tfsec](https://github.com/tfsec/tfsec) ⭐ 7,036 | 🐛 18 | 🌐 Go | 📅 2026-03-25 — Terraform static analysis tool that prevents potential security issues by checking cloud misconfigurations at build time and directly integrates with the HCL parser for better results. Checks for violations of AWS, Azure and GCP security best practice recommendations.

* [scorecard](https://github.com/ossf/scorecard) ⭐ 5,689 | 🐛 453 | 🌐 Go | 📅 2026-09-14 — Security Scorecards - Security health metrics for Open Source
...
* [codespell](https://github.com/codespell-project/codespell) ⭐ 2,425 | 🐛 276 | 🌐 Python | 📅 2026-09-08 — Check code for common misspellings.
...
* [go-tools](https://github.com/dominikh/go-tools) ⭐ 6,894 | 🐛 576 | 🌐 Go | 📅 2026-08-24 — A collection of tools and libraries for working with Go code, including linters and static analysis
